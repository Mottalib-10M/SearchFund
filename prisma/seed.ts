...
async function main() {
  ...
  // ─── SEARCHERS ─────────────────────────────────────────────────────
  const searcherData = [
    { email: "alex.thompson@example.com", name: "Alex Thompson", country: "UK", city: "London", mbaSchool: "INSEAD", searchType: "TRADITIONAL" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Business Services", "Technology"], targetCountries: ["UK", "FR", "DE"], targetEbitdaMin: 500, targetEbitdaMax: 2000, headline: "INSEAD MBA seeking B2B services acquisition in Western Europe", thesis: "Alex spent eight years at McKinsey in London before completing his MBA at INSEAD in 2023. During his time in consulting, he led engagements for mid-market B2B services companies across the UK, France, and Germany, developing a deep understanding of the operational levers that drive value in professional services. He launched his partnered search fund in early 2024 alongside a fellow INSEAD classmate, raising capital from 14 institutional and individual investors across Europe. Their thesis centres on asset-light B2B services businesses with €500K–€2M EBITDA, strong recurring revenue, and an owner looking to retire within 12–18 months. Alex is particularly drawn to companies where technology adoption (CRM, ERP, workflow automation) can unlock margin expansion without major capital expenditure. He is fluent in English and French and conversational in German.", slug: "alex-thompson" },
    { email: "sophie.bernard@example.com", name: "Sophie Bernard", country: "FR", city: "Paris", mbaSchool: "HEC Paris", searchType: "SELF_FUNDED" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Healthcare", "Education"], targetCountries: ["FR", "BE", "CH"], targetEbitdaMin: 300, targetEbitdaMax: 1500, headline: "HEC graduate focused on healthcare services in Francophone Europe", thesis: "Sophie is a solo self-funded searcher based in Paris who launched her search in January 2025 after graduating from HEC Paris. Before her MBA, she spent six years at Bain & Company, where she specialized in healthcare strategy engagements across France and Switzerland. Her search thesis focuses on healthcare services businesses — clinics, home care providers, rehabilitation centres, and medical equipment distributors — in Francophone Europe (France, Belgium, and Switzerland). She targets companies with EBITDA between €300K and €1.5M, ideally with a strong local reputation, a loyal patient base, and clear operational improvement opportunities. Sophie is passionate about improving access to quality healthcare and believes the search fund model aligns well with the values-driven nature of healthcare businesses. She is fluent in French and English and holds a Master's in Public Health from Sciences Po in addition to her HEC MBA.", slug: "sophie-bernard" },
    { email: "max.mueller@example.com", name: "Maximilian Müller", country: "DE", city: "Frankfurt", mbaSchool: "WHU Otto Beisheim", searchType: "TRADITIONAL" as const, searchStatus: "RAISING_CAPITAL" as const, targetSectors: ["Manufacturing", "Business Services"], targetCountries: ["DE", "AT", "CH"], targetEbitdaMin: 750, targetEbitdaMax: 3000, headline: "WHU alum raising capital for DACH manufacturing acquisition", thesis: "Maximilian is a WHU Otto Beisheim graduate who is currently raising capital for a partnered traditional search fund focused on the DACH region (Germany, Austria, Switzerland). Before business school, he worked for seven years in industrial operations at Siemens, where he managed production lines and supply chain processes for automotive components. His search thesis targets established Mittelstand companies — particularly precision manufacturing, industrial services, and B2B distribution businesses — with EBITDA between €750K and €3M. Max is seeking companies with strong niche positioning, loyal customer relationships, and export capabilities that can be further developed under new ownership. He launched his fundraising process in mid-2025 alongside a partner from his WHU cohort, and has received commitments from several German family offices and institutional investors. He is fluent in German and English.", slug: "maximilian-mueller" },
    { email: "elena.santos@example.com", name: "Elena Santos", country: "ES", city: "Barcelona", mbaSchool: "IESE Business School", searchType: "ACCELERATOR" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["E-commerce", "Retail", "Food & Beverage"], targetCountries: ["ES", "PT"], targetEbitdaMin: 200, targetEbitdaMax: 1000, headline: "IESE MBA, Search Fund Accelerator — Iberian focus", thesis: "Backed by the IESE SF Accelerator. Targeting consumer and retail businesses in Spain and Portugal.", slug: "elena-santos", isPublic: false },
    { email: "james.oconnor@example.com", name: "James O'Connor", country: "IE", city: "Dublin", mbaSchool: "London Business School", searchType: "SELF_FUNDED" as const, searchStatus: "LOI_SIGNED" as const, targetSectors: ["SaaS", "Technology"], targetCountries: ["IE", "UK"], targetEbitdaMin: 400, targetEbitdaMax: 1500, headline: "LBS alum — LOI signed on Irish SaaS company", thesis: "Targeting profitable, bootstrapped SaaS and tech-enabled services in Ireland and the UK.", slug: "james-oconnor", isPublic: false },
    { email: "anna.lindqvist@example.com", name: "Anna Lindqvist", country: "SE", city: "Stockholm", mbaSchool: "Stockholm School of Economics", searchType: "TRADITIONAL" as const, searchStatus: "PREPARING" as const, targetSectors: ["Business Services", "Education", "Healthcare"], targetCountries: ["SE", "NO", "DK", "FI"], targetEbitdaMin: 500, targetEbitdaMax: 2000, headline: "SSE graduate preparing for Nordic search fund", thesis: "Anna is preparing to launch a solo traditional search fund in the Nordics in late 2026. She graduated from the Stockholm School of Economics in 2025 and previously spent five years at EQT Partners in Stockholm, where she worked on mid-market buyouts in the healthcare and business services sectors. Her thesis focuses on service businesses across Sweden, Norway, Denmark, and Finland — particularly staffing, facility management, and vocational training — with EBITDA between €500K and €2M. Anna is drawn to the Nordic market because of its stable regulatory environment, high trust culture, and the large number of baby-boomer-owned SMEs approaching succession. She is currently building her investor network and refining her search criteria, with plans to begin fundraising in early 2026. She speaks Swedish, Norwegian, and English fluently, and has working knowledge of Danish.", slug: "anna-lindqvist" },
    { email: "thomas.devries@example.com", name: "Thomas de Vries", country: "NL", city: "Rotterdam", mbaSchool: "RSM Erasmus", searchType: "INDEPENDENT_SPONSOR" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Logistics", "Business Services"], targetCountries: ["NL", "BE", "DE"], targetEbitdaMin: 750, targetEbitdaMax: 2500, headline: "Independent sponsor — logistics & business services in Benelux", thesis: "Experienced operator targeting logistics and business process outsourcing companies in the Benelux region.", slug: "thomas-devries", isPublic: false },
    { email: "clara.fischer@example.com", name: "Clara Fischer", country: "DE", city: "Berlin", mbaSchool: "ESMT Berlin", searchType: "SELF_FUNDED" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Technology", "Media"], targetCountries: ["DE", "AT"], targetEbitdaMin: 300, targetEbitdaMax: 1200, headline: "ESMT alum seeking tech-enabled businesses in DACH", thesis: "Focused on digital agencies, tech-enabled media companies, and content businesses in Germany and Austria.", slug: "clara-fischer", isPublic: false },
    { email: "marco.bianchi@example.com", name: "Marco Bianchi", country: "IT", city: "Rome", mbaSchool: "Bocconi", searchType: "TRADITIONAL" as const, searchStatus: "ACQUIRED" as const, targetSectors: ["Food & Beverage", "Manufacturing"], targetCountries: ["IT"], targetEbitdaMin: 500, targetEbitdaMax: 2000, headline: "Bocconi MBA — acquired a food manufacturing company", thesis: "Marco launched a partnered traditional search fund in 2022 after completing his MBA at Bocconi. Together with his search partner, he spent 14 months searching before successfully acquiring a specialty food manufacturer in Tuscany in late 2023. The company produces artisanal pasta and sauces for the Italian HoReCa market, with €1.4M EBITDA at the time of acquisition. Before Bocconi, Marco worked in investment banking at Mediobanca for four years, covering Italian mid-market M&A transactions. Since acquiring the business, he has been serving as CEO-operator, focusing on expanding the company's distribution network into northern Italy and launching a direct-to-consumer e-commerce channel. Under his leadership, EBITDA has grown 25% in the first full year of operations. Marco is fluent in Italian and English and is based in Tuscany full-time since the acquisition.", slug: "marco-bianchi" },
    { email: "sarah.mitchell@example.com", name: "Sarah Mitchell", country: "UK", city: "Edinburgh", mbaSchool: "University of Edinburgh", searchType: "SELF_FUNDED" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Financial Services", "Business Services"], targetCountries: ["UK"], targetEbitdaMin: 400, targetEbitdaMax: 1500, headline: "Self-funded searcher — financial services in Scotland/UK", thesis: "Targeting IFAs, accounting practices, and niche financial services firms across the UK.", slug: "sarah-mitchell", isPublic: false },
    ...
    { email: "katrin.jensen@example.com", name: "Katrin Jensen", country: "DK", city: "Copenhagen", mbaSchool: "CBS Copenhagen", searchType: "TRADITIONAL" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Energy", "Business Services"], targetCountries: ["DK", "SE", "NO"], targetEbitdaMin: 500, targetEbitdaMax: 1800, headline: "CBS MBA — energy services in Scandinavia", thesis: "Targeting energy services, maintenance, and facility management companies in Denmark and Scandinavia.", slug: "katrin-jensen", isPublic: false },
    { email: "rui.ferreira@example.com", name: "Rui Ferreira", country: "PT", city: "Lisbon", mbaSchool: "Nova SBE", searchType: "SELF_FUNDED" as const, searchStatus: "PREPARING" as const, targetSectors: ["Technology", "Business Services"], targetCountries: ["PT", "ES"], targetEbitdaMin: 150, targetEbitdaMax: 750, headline: "Nova SBE grad preparing Iberian search", thesis: "Planning to acquire a tech-enabled services company in Portugal or Spain.", slug: "rui-ferreira", isPublic: false },
    { email: "felix.huber@example.com", name: "Felix Huber", country: "CH", city: "Zurich", mbaSchool: "University of St. Gallen", searchType: "INDEPENDENT_SPONSOR" as const, searchStatus: "ACTIVELY_SEARCHING" as const, targetSectors: ["Manufacturing", "Healthcare"], targetCountries: ["CH", "DE", "AT"], targetEbitdaMin: 1000, targetEbitdaMax: 3000, headline: "St. Gallen alum — Swiss-German medtech & manufacturing", thesis: "Felix operates as a solo independent sponsor, sourcing deals and raising capital on a deal-by-deal basis rather than through a traditional search fund structure. He launched his search in mid-2024 after graduating from the University of St. Gallen and spending nine years in the medical device industry — first at Stryker in Zurich, then at a Swiss medtech startup where he served as VP of Operations. His thesis focuses on precision manufacturing and medical device companies in the Swiss-German corridor (Switzerland, southern Germany, and Austria) with EBITDA between €1M and €3M. Felix looks for companies with ISO 13485 certification, a strong regulatory track record, and products that serve ageing-population healthcare needs. His independent sponsor model allows him to be flexible on deal size and structure, and he has built relationships with several family offices and institutional investors who co-invest alongside him. He speaks German, French, and English fluently.", slug: "felix-huber" },
    { email: "emma.wilson@example.com", name: "Emma Wilson", country: "UK", city: "Manchester", mbaSchool: "Manchester Business School", searchType: "SELF_FUNDED" as const, searchStatus: "OPERATING" as const, targetSectors: ["Education", "Healthcare"], targetCountries: ["UK"], targetEbitdaMin: 300, targetEbitdaMax: 1000, headline: "Acquired and operating an education services company", thesis: "Acquired a vocational training provider in 2024. Currently scaling operations across Northern England.", slug: "emma-wilson", isPublic: false },
  ];

  const searcherUsers = [];
  for (const s of searcherData) {
    const isPublic = (s as Record<string, unknown>).isPublic !== false;
  ...
  // ─── LISTINGS ──────────────────────────────────────────────────────
  const listingData = [
    { sellerId: sellers[0].id, title: "Established IT Consulting Firm — Lyon", slug: "it-consulting-firm-lyon", sector: "Technology", country: "FR", region: "Auvergne-Rhône-Alpes", revenue: 9500, ebitda: 1900, ebitdaMargin: 20.0, askingPrice: 9500, askingMultiple: 5.0, employeeCount: 55, yearFounded: 2005, summary: "Profitable IT consulting firm serving mid-market enterprises in the Rhône-Alpes region. €9.5M revenue with strong client retention and recurring contracts.", description: "This IT consulting firm has built a loyal client base of 80+ mid-market companies over nearly 20 years. Services include ERP implementation, cloud migration, cybersecurity audits, and managed IT services. 70% of revenue is recurring through multi-year service contracts. The company operates from modern offices in Lyon's tech district with a skilled team of 55 consultants.", highlights: ["70% recurring revenue", "80+ enterprise clients", "20-year track record", "€1.9M EBITDA at 20% margins"], reasonForSale: "Retirement", sellerFinancing: true, timeline: "6-12 months", status: "ACTIVE" as const, daysAgo: 5 },
    { sellerId: sellers[1].id, title: "Precision Engineering Company — Bavaria", slug: "precision-engineering-bavaria", sector: "Manufacturing", country: "DE", region: "Bavaria", revenue: 12000, ebitda: 2400, ebitdaMargin: 20.0, askingPrice: 12000, askingMultiple: 5.0, employeeCount: 75, yearFounded: 1987, summary: "Family-owned precision engineering company specializing in automotive and aerospace components. €12M revenue. ISO 9001 and AS9100 certified.", description: "A second-generation Bavarian manufacturer producing high-precision metal components for automotive OEMs and aerospace Tier 1 suppliers. The company operates a 5,000m² facility with modern CNC machinery. ISO 9001:2015 and AS9100D certified. Strong order book and diversified client base across Germany, Austria, and Switzerland.", highlights: ["ISO 9001 & AS9100 certified", "€12M revenue", "Diversified OEM client base", "Modern CNC facility", "Strong export capabilities"], reasonForSale: "Succession", sellerFinancing: false, timeline: "12-18 months", status: "ACTIVE" as const, daysAgo: 12 },
    { sellerId: sellers[2].id, title: "Private Healthcare Clinic Network — Madrid", slug: "healthcare-clinic-network-madrid", sector: "Healthcare", country: "ES", region: "Community of Madrid", revenue: 9500, ebitda: 1900, ebitdaMargin: 20.0, askingPrice: 8550, askingMultiple: 4.5, employeeCount: 60, yearFounded: 2010, summary: "Network of 5 private clinics in Madrid offering physiotherapy, rehabilitation, and sports medicine. €9.5M revenue, growing 15% annually.", description: "A network of five premium physiotherapy and sports medicine clinics strategically located across Madrid. The clinics serve a mix of private patients, corporate wellness programs, and sports teams. Strong brand recognition and 4.8-star Google ratings across all locations. Revenue has grown 15% annually over the past 3 years with expanding margins.", highlights: ["5 clinic locations", "15% annual growth", "4.8-star ratings", "Corporate wellness contracts", "€1.9M EBITDA"], reasonForSale: "New venture", sellerFinancing: true, timeline: "6-9 months", status: "ACTIVE" as const, daysAgo: 3 },
    { sellerId: sellers[3].id, title: "Last-Mile Logistics Platform — Amsterdam", slug: "last-mile-logistics-amsterdam", sector: "Logistics", country: "NL", region: "North Holland", revenue: 8500, ebitda: 1300, ebitdaMargin: 15.3, askingPrice: 7800, askingMultiple: 6.0, employeeCount: 45, yearFounded: 2017, summary: "Tech-enabled last-mile delivery platform serving e-commerce retailers in the Netherlands and Belgium. €8.5M revenue. Proprietary route optimization software.", description: "An innovative logistics company combining proprietary route optimization technology with a fleet of electric delivery vehicles. Serving 500+ e-commerce merchants across the Netherlands and Belgium. The platform reduces delivery costs by 30% compared to traditional carriers while offering same-day delivery in major cities.", highlights: ["Proprietary tech platform", "500+ e-commerce clients", "Electric fleet", "30% cost advantage", "Same-day delivery capability"], reasonForSale: "Founders pursuing new venture", sellerFinancing: false, timeline: "3-6 months", status: "ACTIVE" as const, daysAgo: 8 },
    { sellerId: sellers[4].id, title: "Specialty Food Distributor — Northern Italy", slug: "food-distributor-northern-italy", sector: "Food & Beverage", country: "IT", region: "Lombardy", revenue: 14000, ebitda: 2100, ebitdaMargin: 15.0, askingPrice: 10500, askingMultiple: 5.0, employeeCount: 70, yearFounded: 1975, summary: "Third-generation specialty food distributor supplying premium Italian products to restaurants, hotels, and retailers across northern Italy. €14M revenue.", description: "A well-established food distribution company with exclusive distribution agreements for 30+ premium Italian food brands. The company serves over 2,500 HoReCa clients and 800 retail locations across Lombardy, Piedmont, and Veneto. Modern warehouse and cold chain logistics ensure product quality. The brand is synonymous with quality in the northern Italian food service industry.", highlights: ["€14M revenue", "30+ exclusive brand agreements", "3,300+ active clients", "Cold chain logistics", "Third-generation business"], reasonForSale: "Retirement", sellerFinancing: true, timeline: "12 months", status: "ACTIVE" as const, daysAgo: 15 },
    { sellerId: sellers[0].id, title: "Cybersecurity Consultancy — Paris", slug: "cybersecurity-consultancy-paris", sector: "Technology", country: "FR", region: "Île-de-France", revenue: 8500, ebitda: 2100, ebitdaMargin: 24.7, askingPrice: 12600, askingMultiple: 6.0, employeeCount: 42, yearFounded: 2015, summary: "Fast-growing cybersecurity consultancy specializing in compliance (GDPR, NIS2) and penetration testing for mid-market European companies. €8.5M revenue.", description: "A Paris-based cybersecurity firm that has grown 25% annually since 2020. The company provides GDPR compliance audits, NIS2 implementation, penetration testing, and incident response services. Clients include banks, healthcare providers, and SaaS companies. With the EU's expanding cybersecurity regulations, the addressable market is growing rapidly.", highlights: ["25% annual growth", "GDPR & NIS2 expertise", "Blue-chip client base", "€2.1M EBITDA at 25% margins", "Regulatory tailwinds"], reasonForSale: "Retirement", sellerFinancing: false, timeline: "6-12 months", status: "ACTIVE" as const, daysAgo: 20 },
    { sellerId: sellers[1].id, title: "Industrial Cleaning Services — Rhineland", slug: "industrial-cleaning-rhineland", sector: "Business Services", country: "DE", region: "North Rhine-Westphalia", revenue: 11000, ebitda: 1650, ebitdaMargin: 15.0, askingPrice: 6600, askingMultiple: 4.0, employeeCount: 180, yearFounded: 1998, summary: "Contract-based industrial cleaning company serving manufacturing plants and commercial facilities across the Rhine-Ruhr metropolitan area. €11M revenue.", description: "One of the leading industrial cleaning companies in the Rhine-Ruhr region, serving 150+ manufacturing plants, offices, and commercial facilities. The company has long-term contracts (average 4+ years) and a workforce of 180 trained cleaning professionals. ISO 14001 certified for environmental management.", highlights: ["€11M revenue", "150+ contracted facilities", "4+ year average contract length", "ISO 14001 certified", "Stable recurring revenue"], reasonForSale: "Owner retiring", sellerFinancing: true, timeline: "6-12 months", status: "ACTIVE" as const, daysAgo: 25 },
    { sellerId: sellers[2].id, title: "Online Pharmacy Platform — Spain", slug: "online-pharmacy-spain", sector: "Healthcare", country: "ES", region: "Catalonia", revenue: 9000, ebitda: 1350, ebitdaMargin: 15.0, askingPrice: 6750, askingMultiple: 5.0, employeeCount: 35, yearFounded: 2018, summary: "Licensed online pharmacy platform with growing subscription base for chronic medication management. €9M revenue, shipping across Spain.", description: "A fully licensed online pharmacy serving patients across Spain. The platform specializes in chronic medication management with a growing subscription model (40% of revenue). The company has built a modern logistics center in Barcelona and maintains high customer satisfaction (NPS 72). E-pharmacy regulations in Spain are favorable for continued growth.", highlights: ["Licensed online pharmacy", "40% subscription revenue", "NPS 72", "€9M revenue growing 20% YoY", "Modern logistics center"], reasonForSale: "Founder relocating", sellerFinancing: false, timeline: "3-6 months", status: "ACTIVE" as const, daysAgo: 10 },
    { sellerId: sellers[3].id, title: "B2B SaaS — HR Compliance Platform", slug: "hr-compliance-saas-netherlands", sector: "SaaS", country: "NL", region: "South Holland", revenue: 8000, ebitda: 2400, ebitdaMargin: 30.0, askingPrice: 16800, askingMultiple: 7.0, employeeCount: 28, yearFounded: 2019, summary: "B2B SaaS platform automating HR compliance for European companies. €8M ARR, 95% gross retention. Highly profitable.", description: "A profitable SaaS platform that automates HR compliance tasks (employment law tracking, document management, audit trails) for mid-market European companies. Currently serving 600+ clients across 12 countries. The platform has achieved product-market fit with 95% gross revenue retention and 115% net revenue retention. The founding team wants to pursue a new venture.", highlights: ["95% gross revenue retention", "115% net retention", "600+ B2B clients", "12 countries served", "€2.4M EBITDA on €8M ARR"], reasonForSale: "Founders pursuing new venture", sellerFinancing: false, timeline: "3-6 months", status: "UNDER_LOI" as const, daysAgo: 45 },
    { sellerId: sellers[4].id, title: "Premium Olive Oil Producer — Tuscany", slug: "olive-oil-producer-tuscany", sector: "Food & Beverage", country: "IT", region: "Tuscany", revenue: 8500, ebitda: 1700, ebitdaMargin: 20.0, askingPrice: 8500, askingMultiple: 5.0, employeeCount: 40, yearFounded: 1960, summary: "Award-winning extra virgin olive oil producer with DOP certification. €8.5M revenue. Exporting to 25 countries from a historic Tuscan estate.", description: "A family-owned olive oil estate producing award-winning DOP-certified extra virgin olive oil since 1960. The company manages 120 hectares of olive groves, a modern pressing facility, and a bottling line. Products are exported to 25 countries through specialty food distributors and direct-to-consumer channels (25% of revenue). Multiple gold medals at international olive oil competitions.", highlights: ["DOP certified", "120 hectares of olive groves", "25 export countries", "Multiple gold medals", "25% DTC revenue"], reasonForSale: "Succession — no family successor", sellerFinancing: true, timeline: "12-18 months", status: "ACTIVE" as const, daysAgo: 30 },
    { sellerId: sellers[0].id, title: "Digital Marketing Agency — Bordeaux", slug: "digital-marketing-agency-bordeaux", sector: "Business Services", country: "FR", region: "Nouvelle-Aquitaine", revenue: 8000, ebitda: 2000, ebitdaMargin: 25.0, askingPrice: 8000, askingMultiple: 4.0, employeeCount: 45, yearFounded: 2013, summary: "Full-service digital marketing agency specializing in wine, luxury, and premium brands. €8M revenue, 25% EBITDA margins.", description: "A leading digital marketing agency in Bordeaux specializing in wine estates, luxury hospitality, and premium food brands. Services include social media management, SEO/SEM, brand strategy, performance marketing, and e-commerce optimization. The agency has built a strong reputation in the wine and luxury industry with 120+ active clients including several Grand Cru estates and luxury hospitality groups.", highlights: ["Niche positioning in wine/luxury", "120+ active clients", "25% EBITDA margin", "Remote-friendly team of 45", "Long client relationships"], reasonForSale: "Retirement", sellerFinancing: true, timeline: "6 months", status: "ACTIVE" as const, daysAgo: 18 },
    { sellerId: sellers[1].id, title: "Vocational Training Center — Hamburg", slug: "vocational-training-hamburg", sector: "Education", country: "DE", region: "Hamburg", revenue: 10000, ebitda: 2000, ebitdaMargin: 20.0, askingPrice: 10000, askingMultiple: 5.0, employeeCount: 65, yearFounded: 2003, summary: "Accredited vocational training center offering IT, healthcare, and business administration programs. €10M revenue with 60% government-funded.", description: "A state-accredited vocational training center in Hamburg offering programs in IT administration, healthcare assistance, and business management across 3 campuses. 60% of revenue comes from government-funded programs (Bildungsgutschein), providing a stable revenue base. The center trains 1,500+ students annually and has a 85% job placement rate.", highlights: ["State-accredited programs", "60% government-funded revenue", "1,500+ students annually", "85% job placement rate", "3 campuses across Hamburg"], reasonForSale: "Succession", sellerFinancing: false, timeline: "12 months", status: "ACTIVE" as const, daysAgo: 35 },
    { sellerId: sellers[2].id, title: "Dental Equipment Distributor — Iberia", slug: "dental-equipment-iberia", sector: "Healthcare", country: "ES", region: "Andalusia", revenue: 12000, ebitda: 1800, ebitdaMargin: 15.0, askingPrice: 9000, askingMultiple: 5.0, employeeCount: 42, yearFounded: 2001, summary: "Authorized distributor of premium dental equipment and consumables across Spain and Portugal. €12M revenue. Exclusive agreements with 5 major brands.", description: "The leading independent dental equipment distributor in southern Spain and Portugal, with exclusive distribution agreements for 5 major international brands. The company serves 5,000+ dental practices and clinics. Revenue is split between equipment sales (60%) and recurring consumables/service contracts (40%). Well-established logistics network with next-day delivery across Iberia.", highlights: ["5 exclusive distribution agreements", "5,000+ dental practices served", "40% recurring revenue", "Next-day delivery network", "€12M revenue"], reasonForSale: "Owner focusing on other business", sellerFinancing: false, timeline: "6-9 months", status: "ACTIVE" as const, daysAgo: 7 },
    { sellerId: sellers[3].id, title: "E-commerce Fulfillment Center — Belgium", slug: "ecommerce-fulfillment-belgium", sector: "Logistics", country: "BE", region: "Flanders", revenue: 10000, ebitda: 1500, ebitdaMargin: 15.0, askingPrice: 7500, askingMultiple: 5.0, employeeCount: 65, yearFounded: 2016, summary: "3PL fulfillment center in Antwerp serving DTC brands across Benelux and Northern France. €10M revenue. Automated pick-and-pack systems.", description: "A modern third-party logistics center strategically located near Antwerp port, serving 120+ DTC e-commerce brands. The facility features automated pick-and-pack systems, real-time inventory management, and integrations with major e-commerce platforms (Shopify, WooCommerce, Magento). The company handles 1.2M+ orders annually and is expanding into cross-border European fulfillment.", highlights: ["1.2M+ annual orders", "120+ DTC brand clients", "Automated systems", "Strategic port location", "Platform integrations"], reasonForSale: "Strategic pivot", sellerFinancing: false, timeline: "6 months", status: "ACTIVE" as const, daysAgo: 14 },
    { sellerId: sellers[4].id, title: "Gelateria Chain — Milan", slug: "gelateria-chain-milan", sector: "Food & Beverage", country: "IT", region: "Lombardy", revenue: 2800, ebitda: 420, ebitdaMargin: 15.0, askingPrice: 2100, askingMultiple: 5.0, employeeCount: 75, yearFounded: 2008, summary: "Chain of 5 artisan gelaterias in prime Milan locations with strong brand and loyal following. Includes a production laboratory and wholesale line.", description: "Five beautifully designed gelaterias in prime Milan locations, known for artisan gelato made with locally-sourced ingredients. The brand has built a cult following with 50K+ Instagram followers. Revenue comes from retail (70%), wholesale supply to restaurants (20%), and online/delivery (10%). The central production lab can scale to support 10+ additional locations.", highlights: ["5 prime locations in Milan", "50K+ Instagram followers", "Production lab with scale capacity", "Wholesale + retail revenue", "Iconic brand"], reasonForSale: "Family reasons", sellerFinancing: true, timeline: "6-9 months", status: "ACTIVE" as const, daysAgo: 22 },
    { sellerId: sellers[0].id, title: "Staffing Agency — Toulouse", slug: "staffing-agency-toulouse", sector: "Business Services", country: "FR", region: "Occitanie", revenue: 14000, ebitda: 1400, ebitdaMargin: 10.0, askingPrice: 5600, askingMultiple: 4.0, employeeCount: 30, yearFounded: 2000, summary: "Established staffing agency specializing in aerospace and defense temporary placements in the Toulouse region. €14M revenue. Airbus supplier.", description: "A niche staffing agency focused on aerospace and defense sector temporary placements in the Toulouse region, home to Airbus headquarters. The company is an approved Airbus supplier and provides specialized technical staff (engineers, technicians, quality inspectors) to the aerospace cluster. 85% of revenue comes from repeat clients with multi-year framework agreements.", highlights: ["Airbus approved supplier", "85% repeat client revenue", "Aerospace specialization", "20+ year track record", "€14M revenue"], reasonForSale: "Retirement", sellerFinancing: true, timeline: "9-12 months", status: "ACTIVE" as const, daysAgo: 40 },
    { sellerId: sellers[1].id, title: "Building Automation Company — Switzerland", slug: "building-automation-switzerland", sector: "Energy", country: "CH", region: "Zurich", revenue: 10000, ebitda: 2000, ebitdaMargin: 20.0, askingPrice: 12000, askingMultiple: 6.0, employeeCount: 45, yearFounded: 2010, summary: "Building automation and energy management systems integrator. €10M revenue, growing fast with EU Green Deal driving demand for smart buildings.", description: "A Swiss building automation company specializing in smart HVAC, lighting, and energy management systems for commercial buildings. The company is a certified integrator for Siemens and Schneider Electric systems. With the EU Green Deal and Swiss energy regulations driving demand for building energy efficiency, the company has grown 20% annually for the past 3 years.", highlights: ["20% annual growth", "Siemens/Schneider certified partner", "EU Green Deal tailwinds", "€2M EBITDA", "Strong Swiss client base"], reasonForSale: "Owner pursuing other interests", sellerFinancing: false, timeline: "6-12 months", status: "ACTIVE" as const, daysAgo: 28 },
    { sellerId: sellers[2].id, title: "Veterinary Clinic Group — Portugal", slug: "veterinary-clinics-portugal", sector: "Healthcare", country: "PT", region: "Lisbon", revenue: 8500, ebitda: 1700, ebitdaMargin: 20.0, askingPrice: 8500, askingMultiple: 5.0, employeeCount: 55, yearFounded: 2012, summary: "Growing group of 7 veterinary clinics in greater Lisbon. €8.5M revenue. Pet ownership in Portugal growing 10% annually.", description: "A group of seven modern veterinary clinics in the Lisbon metropolitan area, offering general practice, surgery, dentistry, and emergency care. Pet ownership in Portugal is growing rapidly (10% annually), driving strong demand. The clinics have an excellent reputation with 4.9-star Google ratings and serve 20,000+ active pet patients.", highlights: ["7 clinics in Lisbon metro", "20,000+ active patients", "4.9-star ratings", "10% market growth", "€1.7M EBITDA"], reasonForSale: "Founder relocating", sellerFinancing: true, timeline: "6 months", status: "ACTIVE" as const, daysAgo: 6 },
    { sellerId: sellers[3].id, title: "Financial Advisory Boutique — Dublin", slug: "financial-advisory-dublin", sector: "Financial Services", country: "IE", region: "Dublin", revenue: 9000, ebitda: 2700, ebitdaMargin: 30.0, askingPrice: 13500, askingMultiple: 5.0, employeeCount: 30, yearFounded: 2007, summary: "Independent financial advisory firm serving SMEs and high-net-worth individuals in Ireland. €9M revenue with high recurring AUM fees.", description: "A well-established independent financial advisory firm in Dublin serving 800+ SME clients and 400+ high-net-worth individuals. Revenue is 65% recurring (AUM-based fees and retainers). The firm specializes in corporate pension planning, M&A advisory for SMEs, and wealth management. Strong regulatory compliance track record with Central Bank of Ireland.", highlights: ["65% recurring revenue", "€2.7M EBITDA at 30% margins", "800+ SME clients", "Central Bank regulated", "Strong compliance record"], reasonForSale: "Senior partner retiring", sellerFinancing: false, timeline: "9-12 months", status: "ACTIVE" as const, daysAgo: 32 },
    { sellerId: sellers[4].id, title: "E-commerce Fashion Brand — Milan", slug: "fashion-ecommerce-milan", sector: "E-commerce", country: "IT", region: "Lombardy", revenue: 11000, ebitda: 1650, ebitdaMargin: 15.0, askingPrice: 8250, askingMultiple: 5.0, employeeCount: 35, yearFounded: 2016, summary: "DTC sustainable fashion brand selling online across Europe. €11M revenue, 500K email subscribers and 35% repeat purchase rate.", description: "A digitally-native sustainable fashion brand selling directly to consumers across 15 European markets. The brand focuses on eco-friendly materials and ethical manufacturing. Strong customer loyalty with 500K email subscribers, 35% repeat purchase rate, and 280K Instagram followers. The brand has been featured in Vogue Italia, Elle, and the Financial Times.", highlights: ["500K email subscribers", "35% repeat purchase rate", "15 European markets", "Press coverage: Vogue, Elle, FT", "Sustainable positioning"], reasonForSale: "Founder moving to new project", sellerFinancing: false, timeline: "3-6 months", status: "SOLD" as const, daysAgo: 90 },
    { sellerId: sellers[0].id, title: "Managed IT Services — Lille", slug: "managed-it-services-lille", sector: "Technology", country: "FR", region: "Hauts-de-France", revenue: 8500, ebitda: 1700, ebitdaMargin: 20.0, askingPrice: 8500, askingMultiple: 5.0, employeeCount: 38, yearFounded: 2011, summary: "MSP serving 300+ SMEs in northern France. €8.5M revenue, 85% from recurring managed service contracts.", description: "A managed IT services provider serving 300+ small and medium businesses across the Hauts-de-France region. The company offers 24/7 monitoring, help desk support, cloud migration, and cybersecurity services. 85% of revenue comes from monthly recurring contracts with an average client tenure of 5+ years.", highlights: ["85% recurring revenue", "300+ SME clients", "5+ year average client tenure", "24/7 monitoring capability", "Cloud & cybersecurity services"], reasonForSale: "Retirement", sellerFinancing: true, timeline: "6-12 months", status: "ACTIVE" as const, daysAgo: 42 },
    { sellerId: sellers[1].id, title: "Specialty Chemicals Distributor — Poland", slug: "specialty-chemicals-poland", sector: "Manufacturing", country: "PL", region: "Silesia", revenue: 13000, ebitda: 1950, ebitdaMargin: 15.0, askingPrice: 9750, askingMultiple: 5.0, employeeCount: 50, yearFounded: 1995, summary: "Leading specialty chemicals distributor in southern Poland. €13M revenue. Exclusive agreements with global manufacturers. Growing 12% YoY.", description: "The largest independent specialty chemicals distributor in the Silesian industrial corridor, serving automotive, mining, and heavy industry clients. The company holds exclusive distribution agreements with 8 global chemical manufacturers and operates a REACH-compliant warehouse facility. Revenue has grown 12% annually as Polish industry continues to expand.", highlights: ["8 exclusive distribution agreements", "REACH-compliant facility", "12% annual growth", "Leading position in Silesia", "€13M revenue"], reasonForSale: "Owner health reasons", sellerFinancing: false, timeline: "6 months", status: "ACTIVE" as const, daysAgo: 16 },
    { sellerId: sellers[2].id, title: "EdTech Platform — Spain", slug: "edtech-platform-spain", sector: "Education", country: "ES", region: "Community of Madrid", revenue: 8000, ebitda: 1600, ebitdaMargin: 20.0, askingPrice: 9600, askingMultiple: 6.0, employeeCount: 35, yearFounded: 2017, summary: "Online tutoring and exam prep platform operating across Spain and Latin America. €8M revenue, 20% EBITDA margins, scalable platform model.", description: "A tech-enabled education platform that connects students with qualified tutors and offers self-paced exam preparation courses for primary, secondary, and university-level subjects. The platform has 15,000+ registered tutors, 120,000+ active students, and handles 80,000+ sessions per month. Hybrid revenue model combining marketplace commissions and B2B licensing to schools.", highlights: ["15,000+ tutors on platform", "120,000+ active students", "80,000+ monthly sessions", "20% EBITDA margins", "B2B school licensing channel"], reasonForSale: "Founder pursuing new venture", sellerFinancing: false, timeline: "3-6 months", status: "ACTIVE" as const, daysAgo: 11 },
    { sellerId: sellers[3].id, title: "Renewable Energy Installer — Belgium", slug: "renewable-energy-installer-belgium", sector: "Energy", country: "BE", region: "Wallonia", revenue: 11000, ebitda: 1650, ebitdaMargin: 15.0, askingPrice: 8250, askingMultiple: 5.0, employeeCount: 55, yearFounded: 2012, summary: "Solar panel and heat pump installer for residential and commercial properties across Belgium. €11M revenue. Certified by major manufacturers.", description: "A leading renewable energy installation company in Belgium, specializing in solar panels, heat pumps, and home battery systems. The company is a certified installer for SunPower, Daikin, and Tesla Powerwall. With Belgian and EU climate targets driving demand, the company has grown 30% annually over the past 2 years and expanded from Wallonia to serve all of Belgium.", highlights: ["30% annual growth", "SunPower/Daikin/Tesla certified", "Residential + commercial", "EU Green Deal tailwinds", "€11M revenue"], reasonForSale: "Strategic reasons", sellerFinancing: true, timeline: "6-12 months", status: "UNDER_LOI" as const, daysAgo: 60 },
    { sellerId: sellers[4].id, title: "Luxury Hotel & Spa — Lake Como", slug: "luxury-hotel-spa-lake-como", sector: "Real Estate", country: "IT", region: "Lombardy", revenue: 10000, ebitda: 2000, ebitdaMargin: 20.0, askingPrice: 14000, askingMultiple: 7.0, employeeCount: 65, yearFounded: 1998, summary: "Boutique 4-star luxury hotel & spa on Lake Como. €10M revenue. 42 rooms, Michelin-starred restaurant, and award-winning spa. 82% occupancy rate.", description: "A stunning 4-star boutique hotel overlooking Lake Como with 42 elegantly appointed rooms, a Michelin-starred restaurant, and a full-service spa. The property has maintained an 82% average occupancy rate with an ADR of €380. The hotel is ranked in the top 10 hotels on Lake Como on TripAdvisor and has won multiple hospitality awards.", highlights: ["42-room boutique hotel", "Michelin-starred restaurant", "82% occupancy rate", "€380 ADR", "Top 10 TripAdvisor ranking"], reasonForSale: "Owner retiring", sellerFinancing: true, timeline: "12-18 months", status: "ACTIVE" as const, daysAgo: 50 },
  ];
