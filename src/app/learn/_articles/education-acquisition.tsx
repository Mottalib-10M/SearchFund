    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          the digital transformation reshaping how people learn. For search
        ...
        <p>
          ...
          capital expenditures to factor into your model.
        </p>
        ...
        <p>
          ...
          4&ndash;8x EBITDA, with variation driven by sub-sector,
        ...
        <p>
          ...
          competitive landscape rich with acquisition targets. The keys
          to success are understanding the specific accreditation and
