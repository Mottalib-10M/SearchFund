      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            price than they would receive in an all-cash transaction.
          ...
          <li>
            ...
            buyer cannot secure sufficient bank financing to cover the
            full purchase price, seller financing bridges the gap.
        ...
        <p>
          Earn-outs and seller notes are both forms of deferred
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            seller financing, offer trade-offs: a higher interest rate,
