  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          The return data strongly favors ETA on an IRR basis. The 2024
          Stanford Search Fund Study, which tracks over 500 search funds
        ...
        <p>
          ...
          for concentrated, high-IRR alpha.
        </p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            milestones. This equity is earned entirely through operational
