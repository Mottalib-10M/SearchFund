    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          financial due diligence in any search fund acquisition. It separates
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            and bank underwriters rely heavily on the QoE to size their loans.
          </li>
          <li>
        ...
        <p>
          ...
          in the right provider, engage deeply with the process, and use the
