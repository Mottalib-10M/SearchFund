    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          for Entrepreneurship Through Acquisition in Europe. With a GDP per capita
        ...
        <p>
          ...
          autonomy in setting tax rates, creating a competitive tax landscape
        ...
        <p>
          Switzerland&apos;s banking sector plays a central role in KMU financing
          and can be a critical partner in search fund acquisitions. The Swiss
