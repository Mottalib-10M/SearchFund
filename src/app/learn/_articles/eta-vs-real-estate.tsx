  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <h3 className={h3Class}>ETA acquisition financing</h3>
        <ul className={ulClass}>
          <li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            fund more than doubles EBITDA during the hold period. The
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            most powerful tax benefit available in any asset class.
          </li>
          <li>
        ...
        <p>
          ...
          are comfortable with business risk, and want exposure to the
          operational upside of growing a company. It is the right
