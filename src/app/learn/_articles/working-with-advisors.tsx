  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Engage a transaction attorney no later than the Letter of Intent (LOI)
        ...
        <p>
          Engage an accountant at two critical points. First, hire a Quality of
          Earnings (QoE) provider when you enter due diligence after signing
          the LOI. The QoE report is the financial backbone of your diligence
        ...
        <p>
          ...
          acquisitions: SBA lending requirements, seller notes, earn-outs,
          working capital adjustments, and the personal nature of small
