    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          is managing a leveraged company with debt service obligations. Poor
        ...
        <ul className={ulClass}>
          <li>
            ...
            to pay down debt, fund growth, or distribute to investors.
          </li>
          <li>
        ...
        <ol className={olClass}>
          ...
          <li>
            <strong>Switch to electronic invoicing</strong> with online payment
            options. This alone typically reduces DSO by 5&ndash;10 days.
          </li>
          <li>
