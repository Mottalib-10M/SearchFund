    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          from the 2024 Stanford study are striking:
        </p>
        ...
        <p>
          These returns are not driven by a few outliers. While the top
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            equity only upon successful acquisition, and earns most of
        ...
        <p>
          ...
          Europe represents an increasingly compelling opportunity for
