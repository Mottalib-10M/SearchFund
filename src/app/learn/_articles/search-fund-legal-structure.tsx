    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          when you should be focused on closing a deal.
        </p>
        ...
        <p>
          ...
          income, losses, and distributions among the searcher and investors. If
        ...
        <p>
          ...
          fundraise, structure the acquisition vehicle for tax efficiency, and
