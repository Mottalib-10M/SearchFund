  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ETA returns follow a markedly different distribution. The 2024
          Stanford Search Fund Study shows that roughly two-thirds of
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            returns, according to Stanford data. A portfolio of 10 to 15
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            at $50,000. Meaningful participation in top-tier VC requires
        ...
        <p>
          ...
          investment objectives, and allocate capital accordingly.
        </p>
      </div>
    </article>
  );
