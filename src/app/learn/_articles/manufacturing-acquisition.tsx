  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Map every raw material and component supplier, along with their share
        ...
        <p>
          Evaluate inventory levels relative to revenue (inventory turns),
          ...
          physical counts during due diligence — do not rely solely on book
          values.
        </p>
        ...
        <p>
          ...
          (typically 3-6x EBITDA versus 8-15x for SaaS) and protects well-run
          operations from easy disruption. A searcher who masters equipment
