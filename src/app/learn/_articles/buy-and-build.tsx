    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          business purchased at 4&ndash;6x. The platform must have the
        ...
        <p>
          ...
          approach. The best acquirers build a proprietary deal pipeline rather
          than relying solely on brokers.
        </p>
        <ul className={ulClass}>
          <li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            your bank will increase your revolver or provide incremental term
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            sells the combined entity to a strategic buyer at 7.5x ($60M
            enterprise value).
          </li>
        </ul>
        <p>
