    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          School of Business study data spanning four decades. This means roughly
        ...
        <p>
          ...
          5.4x return on invested capital, with top-quartile deals exceeding 10x.
        ...
        <ul className={ulClass}>
          <li>
            <strong>Limited capital, strong network:</strong> Traditional search fund
            (investors fund the search)
          </li>
          <li>
            <strong>Moderate personal capital ($100K-$500K):</strong> Self-funded
            search or franchise
          </li>
          <li>
        ...
        <p>
          ...
          path to business ownership available today.
        </p>
        <p>
