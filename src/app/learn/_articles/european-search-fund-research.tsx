    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          annually, making it the fastest-growing ETA market outside North
        ...
        <ul className={ulClass}>
          <li>
            Aggregate US search fund returns have been approximately 33% IRR
            and 5.5x return on invested capital over the four-decade history
            of the model (per the Stanford 2024 study).
          </li>
          <li>
        ...
        <p>
          ...
          through acquisition. For searchers willing to navigate the
