  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          During due diligence, conduct a thorough analysis of revenue
        ...
        <ul className={ulClass}>
          <li>
            <strong>Transition period:</strong> Structure the deal with a
        ...
        <p>
          ...
          enterprise value in a sector with strong fundamentals, high
          margins, and significant consolidation opportunities.
        </p>
      </div>
    </article>
  );
