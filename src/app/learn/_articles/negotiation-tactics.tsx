      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            multiples, discounted cash flow analysis, or industry
        ...
        <ul className={ulClass}>
          <li>
            ...
            exclusivity at the LOI stage, not before. Asking too early
        ...
        <p>
          A seller note (typically 10&ndash;30% of purchase price) serves
        ...
        <p>
          Earn-outs tie a portion of the purchase price to the
