    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          dramatically through organic growth and add-ons, an IPO can generate
        ...
        <ul className={ulClass}>
          <li>Align with your board and investors on timing and expectations.</li>
          <li>
        ...
        <p>
          Valuation is driven by three factors: the level of EBITDA, the
        ...
        <p>
          ...
          investment bank with experience in your industry. Fees typically
        ...
        <p>
          Exit tax planning should begin at least 12 months before the sale.
