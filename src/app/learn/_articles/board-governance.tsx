      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            director with relevant industry experience who is not affiliated
            with any investor group. Independent directors bring objectivity,
        ...
        <ul className={ulClass}>
          <li>
            ...
            meetings. The first year is the riskiest period, and monthly
        ...
        <ul className={ulClass}>
          <li>
            ...
            management. If something material happens &mdash; positive or
        ...
        <ul className={ulClass}>
          ...
          <li>
            When preparing for exit and needing board-level experience with
            sale processes.
          </li>
        </ul>
