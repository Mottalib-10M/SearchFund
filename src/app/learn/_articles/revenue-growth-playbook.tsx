  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Website optimization.</strong> Ensure your website clearly
        ...
        <p>
          ...
          or through acquisition (buying a competitor in an adjacent market).
        </p>
        <ul className={ulClass}>
          <li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Gross margin</strong> by product, service, and customer.
          </li>
          <li>
