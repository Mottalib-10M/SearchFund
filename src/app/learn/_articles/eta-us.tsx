    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          benchmarking their own market against the global standard.
        </p>
        ...
        <p>
          ...
          studies that have become the definitive reference for the industry.
        ...
        <p>
          ...
          financing tool for self-funded searchers and a complement to
