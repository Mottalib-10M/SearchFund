    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          average ones. Here are the most notable search fund success stories
        ...
        <ul className={ulClass}>
          ...
          <li>
            Buy-and-build, when executed with discipline, can transform a
          ...
          <li>
            ...
            fund operators can hold indefinitely, capturing decades of growth.
          </li>
        </ul>
        ...
        <p>
          ...
          at Stanford in the 1984. The success rate has improved over time as
