    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          When a buyer and seller disagree on the value of a business,
          ...
          the common pitfalls that derail earn-out arrangements.
        </p>
        ...
        <p>
          A seller note (vendor loan) defers a portion of the purchase
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            Engage a tax advisor early and ensure the purchase
