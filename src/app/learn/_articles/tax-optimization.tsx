  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Interest deductibility:</strong> Acquisition debt sits
            at the holding level, and interest payments can often be offset
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Installment sales:</strong> Structuring the exit as an
            installment sale can spread the capital gains recognition over
        ...
        <p>
          ...
          should be involved from the entity formation stage, not just at
          closing. They can advise on entity selection, deal structure
          (asset vs. stock), purchase price allocation, election strategies,
