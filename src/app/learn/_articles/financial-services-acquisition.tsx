  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          In insurance and wealth management, the &ldquo;book of
        ...
        <p>
          ...
          material ongoing expense. During due diligence, review:
        </p>
        <ul className={ulClass}>
          <li>
        ...
        <p>
          ...
          most active roll-up sectors in the entire search fund
          ecosystem. The economics are compelling: individual agencies
        ...
        <p>
          ...
          is real but manageable with proper advisory support &mdash;
