...
export const metadata: Metadata = {
  ...
  description:
    "62 guides on Entrepreneurship Through Acquisition: search fund models, returns data, due diligence, regional guides, industry playbooks, and glossary. Start learning.",
  openGraph: {
    title: "Learn About ETA — Guides, Data & Resources for Search Funds",
    description:
      "From Stanford studies to country-by-country acquisition guides — explore the definitive collection of guides and resources on Entrepreneurship Through Acquisition.",
  },
};
