...
export const metadata: Metadata = {
  title: "Terms of Service — SearchFundMarket",
  description:
    "SearchFundMarket terms of service. Read the rules and conditions governing your use of our search fund acquisition marketplace.",
  openGraph: {
    title: "Terms of Service — SearchFundMarket",
    description:
      "Terms and conditions governing your use of the SearchFundMarket platform.",
  },
};
