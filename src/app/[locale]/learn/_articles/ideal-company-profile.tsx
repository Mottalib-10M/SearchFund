...
export default function IdealCompanyProfileArticle() {
  return (
    <article className="prose prose-lg max-w-4xl mx-auto">
      ...
      <ul className={ulClass}>
        <li>
          <strong>Your background and capabilities:</strong> What industries, business models, and operational challenges are you equipped to understand and manage?
        </li>
        <li>
          <strong>Market availability:</strong> What types of companies are actually for sale in sufficient volume to support a 18-24 month search?
        </li>
        <li>
          <strong>Investor preferences:</strong> What deal profiles align with your investor base's return expectations and risk tolerance?
        </li>
      </ul>
      ...
      <h3 className={h3Class}>Efficiency and Focus</h3>
      ...
      <h3 className={h3Class}>Credibility with Intermediaries</h3>
      ...
      <h3 className={h3Class}>Personal Clarity and Confidence</h3>
      ...
      <h3 className={h3Class}>2. Geography</h3>
      ...
      <h3 className={h3Class}>3. Revenue Range</h3>
      ...
      <h3 className={h3Class}>4. EBITDA and Profitability</h3>
      ...
      <h3 className={h3Class}>5. Growth Trajectory</h3>
      ...
      <h3 className={h3Class}>6. Customer Concentration</h3>
      ...
      <h3 className={h3Class}>7. Owner Dependency</h3>
      ...
      <h3 className={h3Class}>9. Workforce Characteristics</h3>
      ...
      <h3 className={h3Class}>10. Deal Type and Structure</h3>
      ...
      <h3 className={h3Class}>11. Seller Motivation and Timing</h3>
      ...
      <h2 className={h2Class}>Balancing Specificity vs. Flexibility</h2>
      ...
      <ul className={ulClass}>
        <li>Minimum EBITDA of $1.5M (required for debt sizing and deal economics)</li>
        <li>No customer exceeding 25% of revenue (unacceptable concentration risk)</li>
        <li>Geographic location within X radius or willingness to relocate (lifestyle non-negotiable)</li>
        <li>No regulated industries requiring professional licenses you don't have (legal impossibility)</li>
      </ul>
      ...
      <ul className={ulClass}>
        <li>Prefer B2B over B2C (but will consider B2C with subscription revenue)</li>
        <li>Prefer 10%+ growth (but will consider stable businesses with clear expansion opportunities)</li>
        <li>Prefer asset-light models (but will consider capital-intensive businesses with strong returns)</li>
        <li>Prefer existing management team (but will consider owner-dependent businesses with attractive economics)</li>
      </ul>
      ...
      <h2 className={h2Class}>Template: Build Your Own ICP</h2>
      ...
      <h3 className={h3Class}>Create a One-Page Buyer Profile</h3>
      ...
      <h2 className={h2Class}>Iterating Your ICP Based on Market Feedback</h2>
      ...
      <h3 className={h3Class}>Valuation Expectations</h3>
      ...
      <h3 className={h3Class}>Your Own Learning</h3>
      ...
      <h3 className={h3Class}>The "Perfect Business" Trap</h3>
      ...
      <h3 className={h3Class}>Excessive Geographic Restriction</h3>
      ...
      <h3 className={h3Class}>Industry Overspecialization Without Experience</h3>
      ...
      <h3 className={h3Class}>Ignoring Investor Preferences</h3>
      ...
      <h3 className={h3Class}>Static ICP Despite Market Evidence</h3>
      ...
      <h2 className={h2Class}>Case Studies: How ICPs Evolved During Real Searches</h2>

      <p className={bodyClass}>
        Here are three real examples of how searchers refined their ICPs based on market feedback:
      </p>

      <h3 className={h3Class}>Case Study 1: From SaaS to Services</h3>
      ...
      <ul className={ulClass}>
        <li>Quality SaaS businesses were trading at 6-8x revenue, far above her financing capacity</li>
        <li>Most sub-$3M revenue SaaS companies had serious churn issues or founder dependency on product development</li>
        <li>PE-backed roll-up platforms were outbidding her on every attractive opportunity</li>
      </ul>
      ...
      <ul className={ulClass}>
        ...
        <li>
          Walker Deibel, <em>Buy Then Build: How Acquisition Entrepreneurs Outsmart the Startup Game</em> (2018)
        </li>
        <li>
          Robb Hecht, "Defining Your Target Company Profile," <em>BizBuySell</em> (2022)
        </li>
        <li>
          <a
