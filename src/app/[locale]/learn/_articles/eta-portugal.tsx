  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          Portugal has 1.3 million SMEs, and more than a third of their owners are over 55 with no succession plan. Acquisition multiples sit at 3-5x EBITDA, one to two turns below Spain and three below the UK. The country offers EU single-market access, a 21% corporate tax rate with a preferential 17% band for small businesses, government-backed acquisition financing, and a cost base 40-50% below Western European peers. Yet fewer than five search funds have ever operated here. For acquisition entrepreneurs targeting{" "}
        ...
        <p>
          This article breaks down the Portuguese SME market, target industries, legal and tax structures, deal sourcing tactics, financing options, and residency pathways, everything a searcher needs to evaluate Portugal as an acquisition geography.
        </p>
        ...
        <p>
          Tourism accounts for roughly 15% of Portuguese GDP (direct and indirect), and the sector grew over 30% between 2015 and 2023. The opportunity for ETA is not in hotels themselves, those are capital-intensive and cyclical, but in the B2B services behind them: hotel management companies, tour operators, ground transportation, laundry and linen services, F&amp;B supply chains, and activity booking platforms. Many of these are family-run, profitable, and tied to an owner who personally manages relationships with 50-200 hotel clients. Typical EBITDA margins range from 12% to 20%, and the recurring revenue nature of contractual B2B services reduces risk.
        </p>

        <h3 className={h3Class}>Manufacturing: Cork, Textiles, and Components</h3>
        <p>
          Portugal produces over 50% of the world&rsquo;s cork and has a long heritage in textiles, ceramics, and automotive components. The manufacturing belt runs from Braga and Guimar&atilde;es in the north (textiles) through Aveiro (ceramics, molds) to the Alentejo (cork). These businesses often have &euro;1M-&euro;5M in revenue, 10-40% EBITDA margins, existing export relationships with European and US buyers, and an owner-operator who handles everything from production scheduling to client visits. Post-acquisition, the value creation playbook is clear: professionalize management, invest in automation, and expand the client base, the{" "}
        ...
        <p>
          Lisbon and Porto have emerged as major tech hubs, driven by competitive developer salaries (&euro;25K-&euro;45K vs. &euro;60K-&euro;90K in Germany), a strong university pipeline (IST, FEUP, and Universidade do Minho produce roughly 5,000 engineering graduates annually), and a time zone aligned with both London and New York working hours. IT services companies with 20-80 employees, providing staff augmentation, managed services, or custom development for Northern European clients, are prime ETA targets. Revenue per employee often sits at &euro;50K-&euro;80K, margins at 15-25%, and growth rates at 10-20% annually. The risk: key-person dependency on the founder who holds the client relationships.
        </p>

        <h3 className={h3Class}>Food, Wine, and Agriculture</h3>
        <p>
          Portugal&rsquo;s wine industry alone has over 60,000 growers and hundreds of small producers. Olive oil, canned fish (conservas), and specialty foods represent a fragmented market ripe for buy-and-build strategies. Many producers have premium products and established export channels but lack the commercial sophistication to scale. Acquisition multiples in food production typically range from 3-4x EBITDA, partly because of the capital intensity and partly because the buyer pool is tiny.
        </p>

        <h3 className={h3Class}>Healthcare and Professional Services</h3>
        <p>
          Private dental clinics, physiotherapy practices, veterinary clinics, and accounting firms (gabinetes de contabilidade) follow a pattern familiar to US ETA: recurring revenue, high margins, and owner-dependent operations. Portugal&rsquo;s universal healthcare system (SNS) has long waiting lists, which drives demand for private alternatives. A dental group with 3-5 locations and &euro;500K EBITDA is a realistic target at 3.5-4.5x.
        </p>
        ...
        <p>
          The <strong>Lda (Sociedade por Quotas)</strong> is Portugal&rsquo;s equivalent of a German GmbH or French SARL, a limited liability company with quotas (ownership interests) instead of shares. It requires minimum capital of just &euro;1, though practically most operating companies have &euro;5K-&euro;50K in stated capital. About 95% of Portuguese SMEs are organized as Ldas. The <strong>SA (Sociedade An&oacute;nima)</strong> is the public limited company form, requiring &euro;50,000 minimum capital, a board structure, and a statutory auditor. Larger targets or companies preparing for institutional investment may use SAs.
        </p>
        <p>
        ...
        <p>
          <strong>Asset deals (trespasse)</strong> are used when the buyer wants specific assets, a customer book, equipment, real estate, a brand, without the corporate shell. They trigger IMT (Imposto Municipal sobre Transmiss&otilde;es Onerosas de Im&oacute;veis) at 5-8% on any real estate included and may have VAT implications on other assets. Asset deals are less common but appropriate when the target has problematic liabilities or you only want one division.
        </p>

        {/* ───── SECTION 4 ───── */}
        <h2 className={h2Class}>Tax Regime and Optimization</h2>
        <p>
          Portugal&rsquo;s corporate tax rate is 21% (IRC, Imposto sobre o Rendimento das Pessoas Coletivas), with a reduced rate of 17% on the first &euro;50,000 of taxable income for SMEs. An additional municipal surcharge (derrama) of up to 1.5% may apply depending on the municipality. Here are the key tax considerations for an acquisition:
        </p>
        <ul className={ulClass}>
          <li><strong>Goodwill amortization:</strong> Goodwill arising from a share acquisition can be amortized over 5 years, creating a meaningful tax shield. On a &euro;2M acquisition with &euro;1.2M in goodwill, that is &euro;240K per year in deductible expense, roughly &euro;50K in annual tax savings</li>
          ...
          <li><strong>Participation exemption:</strong> Portuguese holding companies (SGPS, Sociedade Gestora de Participa&ccedil;&otilde;es Sociais) can receive dividends and capital gains tax-free from qualifying subsidiaries, provided they hold at least 10% for 12+ months. This is relevant for structuring the exit</li>
        ...
        <ul className={ulClass}>
          <li><strong>Commercial banks:</strong> CGD (Caixa Geral de Dep&oacute;sitos), Millennium BCP, BPI (now part of CaixaBank), and Novo Banco all offer acquisition financing. Typical terms: 60-70% LTV, 5-10 year amortization, priced at Euribor + 2-4%. Banks will want personal guarantees and a credible business plan</li>
          <li><strong>Mutual guarantee societies:</strong> Lisbon Guarantee (now part of the SPGM system), Norgarante, and Garval provide 50-80% guarantees on bank loans, effectively reducing the bank&rsquo;s risk and enabling higher use. The guarantee fee is typically 1-2% annually</li>
          <li><strong>IAPMEI programs:</strong> The &ldquo;Linha de Cr&eacute;dito Capitalizar&rdquo; and its successors provide subsidized credit lines specifically for business transfers and succession. Interest rates can be 1-2 percentage points below market</li>
          <li><strong>Portugal 2030 (EU structural funds):</strong> The current EU programming period runs through 2030 and includes grants and subsidized financing for SME modernization, digital transformation, and internationalization, all applicable post-acquisition</li>
          <li><strong>Seller financing:</strong> Common and expected in Portuguese family business transfers. Typical structure: 10-30% of the purchase price deferred over 3-5 years, sometimes with a modest interest rate or tied to performance milestones. Sellers accept this because the alternative (finding a different buyer) is often worse</li>
        </ul>
        <p>
          A realistic capital structure for a &euro;2M enterprise value acquisition: &euro;1.2M-&euro;1.4M in senior bank debt (with mutual guarantee support), &euro;200K-&euro;400K in seller financing, and &euro;400K-&euro;600K in equity from search fund investors. The{" "}
        ...
        <ol className={olClass}>
          ...
          <li><strong>Direct proprietary outreach:</strong> Building a target list from SABI (the Iberian company database by Bureau van Dijk), Racius (Portuguese company registry search), or Infoempresas, then contacting owners directly via letter, email, or warm introduction through a shared contact. Expect a 5-10% response rate, lower than the 15-20% typical in the US</li>
        </ol>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>D2 Visa (Entrepreneurial Activity):</strong> Specifically for non-EU nationals who intend to start or acquire a business in Portugal. Requires a business plan, proof of investment, and evidence that the activity benefits Portugal. Processing takes 2-4 months. This is often the most direct route for a searcher who has signed an LOI and needs residency to close the deal</li>
        </ul>
