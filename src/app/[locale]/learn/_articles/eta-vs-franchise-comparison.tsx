    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Cost:</strong> $1M-$20M enterprise value (funded through{" "}
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Cost:</strong> $100K-$2M+ initial investment (franchise fee + buildout + working capital), according to the International Franchise Association (IFA). Some franchises require $5M+</li>
          ...
          <li><strong>Returns:</strong> Varies widely. Average franchise owner earns $80K-$150K/year. Top performers earn $300K+. Capital returns of 15-25% annually for well-performing units</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>ETA advantage:</strong> Higher ceiling. Search fund CEOs earn $150K-$250K salary + 20-25% equity that can be worth $2M-$10M+ at exit</li>
          <li><strong>Franchise reality:</strong> Lower ceiling but more predictable. Ongoing royalties (5-8% of revenue) and marketing fees (2-4%) reduce margins permanently</li>
        ...
        <ul className={ulClass}>
          <li><strong>ETA exit:</strong> Sell the independent business at 4-8x EBITDA to PE, strategic, or another search fund</li>
          <li><strong>Franchise exit:</strong> Sell your franchise unit(s). Multiples are typically lower (2-4x) because the brand and system belong to the franchisor, not you. Franchisor approval is usually required</li>
        ...
        <p>
          ...
          5-8% of gross revenue in royalties plus 2-4% in mandatory
          ...
          franchisor rather than the owner, every year, in perpetuity.
        ...
        <p>
          ...
          want full autonomy, higher wealth creation potential (20-25%
        ...
        <p>
          On average, no. Average franchise owners earn $80K-$150K per year
          and pay ongoing royalties (5-8%) and marketing fees (2-4%).
          Search fund CEOs earn $150K-$250K in salary plus 20-25%
          equity that can be worth $2M-$10M or more at exit. However,
        ...
        <p>
          ...
          paths typically require a 10-20% buyer equity injection.
        </p>
