    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Recurring vs. transactional revenue:</strong> A business with 80%+ recurring or contracted revenue is worth 1x or more higher in multiple than a comparable business with entirely transactional revenue. Recurring revenue provides predictability that supports use.</li>
