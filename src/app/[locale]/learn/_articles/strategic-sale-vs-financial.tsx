    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Valuation premium:</strong> Typically pay 20-50% more than financial buyers because synergies increase the business&apos;s value to them specifically.</li>
          ...
          <li><strong>Seller role:</strong> Transition period (3-12 months) then departure. Strategic buyers don&apos;t need you to run the business long-term.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Valuation:</strong> Pay fair market value (4-7x EBITDA for search fund-sized deals). No synergy premium but competitive for quality businesses.</li>
          ...
          <li><strong>Seller role:</strong> May retain equity rollover position (10-30%). Often involved in transition for 6-24 months.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Speed to close:</strong> Financial buyers: 3-6 months. Strategic buyers: 4-12 months (longer for larger companies).</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Strategic buyers typically pay a 20-50% synergy premium but may significantly change the business, brand, and team post-acquisition</li>
