    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          entrepreneurs, a conclusion reinforced by our{" "}
        ...
        <ul className={ulClass}>
          <li><strong>Startups:</strong> 20% survive 5 years. Only 10% reach 10 years. Median revenue at failure: $0. The startup mortality curve is steepest in years 1-3</li>
          <li><strong>Acquired businesses:</strong> 85-95% survival rate for established SMEs purchased through search funds. These businesses have existed for 10-30 years before acquisition</li>
          <li><strong>Search fund returns:</strong> Stanford&rsquo;s 2024 study shows{" "}
            ...
            across the asset class, with median CEO equity outcomes of $5-15M</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Startup:</strong> Revenue is zero on day one. It takes 12-36 months for most startups to generate meaningful revenue</li>
        </ul>

        <h3 className={h3Class}>Cash flow timeline</h3>
        <ul className={ulClass}>
          <li><strong>Acquisition:</strong> Positive cash flow from month 1 (after debt service). A $2M EBITDA acquisition with standard use generates $500K-$800K annual free cash flow</li>
          <li><strong>Startup:</strong> Negative cash flow for 18-48 months. Total cash investment before breakeven: $200K-$2M+ depending on sector</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Acquisition:</strong>{" "}
            ...
            of $150K-$300K starting day one, plus equity upside of $5-15M over 5-7 years</li>
          <li><strong>Startup:</strong> Founders typically pay themselves $0-$80K in early years. Meaningful income often doesn&rsquo;t materialize until year 3-5</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Acquisition:</strong> Main risk is the transition, maintaining the business under new ownership. Systems, processes, and customers already exist. The{" "}
        ...
        <ul className={ulClass}>
          <li><strong>Acquisition CEO:</strong> General management, leading teams, improving operations, growing revenue. You&rsquo;re the CEO of a real business from day one</li>
          <li><strong>Startup founder:</strong> Wearing every hat, coding, selling, supporting customers, bookkeeping. It&rsquo;s exciting but exhausting and often lonely</li>
        </ul>

        <h3 className={h3Class}>Work-life balance</h3>
        <ul className={ulClass}>
          <li><strong>Acquisition:</strong> Demanding but structured. Most acquired businesses operate during normal business hours. CEO hours are 50-60 per week</li>
          <li><strong>Startup:</strong> All-consuming, especially in the first 2-3 years. Founder hours are typically 70-80+ per week. Burnout is endemic</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>You have a genuine innovation</strong>: new technology, business model, or market insight that doesn&rsquo;t exist</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>You prefer managing to building</strong>: you&rsquo;re a better operator than inventor</li>
          <li><strong>You value risk-adjusted returns</strong>: $5-15M in personal wealth is a great outcome</li>
          <li><strong>You have financial obligations</strong> (family, mortgage, debt) that preclude zero-income startup risk</li>
          <li><strong>You want to be a CEO now</strong>, not in 5-10 years after climbing a corporate ladder. Take our{" "}
            <Link href="/learn/is-eta-right-for-you" className="text-apple-accent hover:underline">
              ETA self-assessment
            </Link>{" "}
            to see if you fit the profile</li>
          <li><strong>You&rsquo;re 30-45</strong> with significant opportunity cost and limited appetite for startup-level risk</li>
          <li><strong>You know{" "}
        ...
        <p>
          Yes. Acquisition CEOs typically draw a salary of $150K-$300K from day one, funded by the business&rsquo;s existing cash flow. This is one of the biggest advantages over a startup, where founders commonly pay themselves $0-$80K in early years. In a search fund structure, you also earn 20-25% equity in the acquired company, creating significant wealth over a 5-7 year hold period.
        </p>
      </div>
    </article>
  );
