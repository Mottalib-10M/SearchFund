    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          self-funded buyers, provided you understand the regulatory minefield around
        ...
        <ul className={ulClass}>
          <li>
            ...
            minority stakes since 1991, the longest-running exception in the country.
          </li>
          <li>
            ...
            100% lawyer-owned and handles legal work exclusively. A separate MSO , 
            owned by investors or operators, acquires and runs the business
            infrastructure: technology, marketing, HR, real estate, billing, and staffing.
            The MSO charges a management fee, typically 15-30% of the firm&rsquo;s
          ...
          <li>
            ...
            legal-adjacent services, document automation, compliance consulting,
            contract review, legal process outsourcing, operate outside bar regulation
        ...
        <p>
          ...
          traditional firms on ethics compliance, undermining the core argument
        ...
        <p>
          ...
          drives profitability. Biglaw, the Am Law 200 firms with $100M+
          revenue, is off the table for ETA-scale buyers. The sweet spot is
          firms with $1M-$10M in revenue across these practice areas:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Personal injury (PI):</strong> The most acquisition-friendly practice
            area, with clear economics. PI firms typically operate on 33-40%
            contingency fees, and well-run shops achieve 40-50% profit margins
            according to{" "}
            ...
            Revenue is lumpy, driven by case settlements that can spike or dip
            quarter to quarter, but the pipeline of pending cases provides
          ...
          <li>
            ...
            per matter is lower ($1,500-$5,000) but volume is consistent and
            predictable. This practice area has the highest automation potential , 
          ...
          <li>
            ...
            systems and delegation. USCIS backlogs mean cases last 12-36 months,
          ...
          <li>
            ...
            Margins are tighter (10-15%) because hourly rates are negotiated with
        ...
        <p>
          ...
          human capital, the attorneys who serve clients, maintain relationships,
          and generate revenue. When a founding partner retires, 30-50% of that
        ...
        <ul className={ulClass}>
          <li>
            ...
            reports that small law firms transact at 0.87x-1.21x annual revenue.
            General practice firms fall at the low end (0.5x-0.8x), while specialized
            practices with transferable client bases command 0.8x-1.5x. PI firms with
          ...
          <li>
            ...
            Seller&rsquo;s Discretionary Earnings (SDE) multiples of 2.4x-2.8x are
          ...
          <li>
            ...
            attorneys and institutional client relationships trade at 2.5x-3.5x EBITDA.
            Firms with strong recurring revenue (retainer-based business law, ongoing
            compliance work) trade at the upper end.
          </li>
          <li>
            <strong>Earnout component:</strong> Given the client transition risk, 20-40%
            of total deal value is commonly structured as an earnout tied to client
            retention over 12-24 months. This protects the buyer against the
        ...
        <p>
          ...
          found that the average law firm utilization rate is just 38%, meaning
        ...
        <p>
          ...
          licensed attorneys are 65 or older. Lawyers in their 60s control 25-35%
        ...
        <p>
          ...
          campaign, targeting attorneys aged 60+ in desirable practice areas and
          geographies, can surface motivated sellers who have no other exit path.
        </p>
        <p>
          ...
          2026. The vast majority of acquired firms have 5-20 lawyers. The trend
        ...
        <p>
          ...
          per 8-hour day, a 33% utilization rate. The gap between time worked
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            and increase effective hourly rates by 30-50%.
          </li>
          <li>
            <strong>AI-assisted document drafting:</strong> Generative AI tools
            specifically trained on legal documents, products from companies
            like CoCounsel (Thomson Reuters), Harvey, and Spellbook, are
            reducing first-draft creation time for standard legal documents by
            50-70%. For high-volume practice areas like estate planning and
          ...
          <li>
            ...
            revenue on marketing. A disciplined investment of 5-10% of revenue
            into SEO, Google Local Services Ads, and content marketing can double
            new client intake within 12-18 months. PI firms in particular are
            marketing businesses that happen to practice law, the firms that
        ...
        <ul className={ulClass}>
          <li>
            ...
            fundamentally. Clients hire lawyers, not firms, especially at
          ...
          <li>
            ...
            of trust account reconciliations. Any irregularities, commingling,
            late reconciliations, unexplained shortfalls, are dealbreakers
          ...
          <li>
            ...
            firms require separate analysis of case pipeline value, discount
        ...
        <p>
          ...
          Legal services businesses that do not involve the practice of law, compliance
          consulting, document automation, legal process outsourcing, have no
          ownership restrictions anywhere.
        </p>

        <h3 className={h3Class}>How much does it cost to acquire a small law firm?</h3>
        <p>
          Small law firms with $500K-$3M in annual revenue typically sell for
          0.5x-1.5x revenue or 2.4x-3.5x earnings, depending on practice
        ...
        <p>
          ...
          retires and key associates leave, 30-50% of clients may follow them.
          Mitigate this through employment agreements with non-solicitation clauses for
          key attorneys, a structured 12-24 month founder transition period,
        ...
        <p>
          ...
          (via MSO or ABS states) offer higher margins, well-run firms generate
          30-50% EBITDA margins, but come with regulatory complexity and
          client transition risk. ALSPs operate in a $28.5 billion market growing at
          18% CAGR with zero bar regulation, but margins tend to be lower (15-25%)
          and competition from technology platforms is intensifying. The hybrid approach
          acquiring an ALSP and expanding into MSO-managed law firm operations
          is increasingly common among sophisticated buyers pursuing a{" "}
