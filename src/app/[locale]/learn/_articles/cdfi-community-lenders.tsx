  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>The Opportunity Finance Network (OFN) reports that CDFIs have historically maintained low default rates (typically 2-4%) despite lending to higher-risk borrowers, demonstrating that character-based and community-impact underwriting can produce strong outcomes. For search fund entrepreneurs, especially first-time buyers, minority entrepreneurs, and those acquiring businesses in rural or underserved areas, CDFIs offer a financing pathway that may not be available through conventional channels.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Loan amounts:</strong> Typically $50,000-$5 million (some go higher for community-impact deals)</li>
          <li><strong>Interest rates:</strong> Generally 5-10%, higher than SBA rates but lower than alternative lenders</li>
          <li><strong>Terms:</strong> 5-25 years depending on use of proceeds</li>
          ...
          <li><strong>Down payment:</strong> Typically 10-20%, sometimes as low as 5% for qualifying projects</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>Can reduce effective borrowing costs by 15-20%</li>
          ...
          <li>Complex structure, requires working with an experienced CDFI or Community Development Entity (CDE)</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>New Markets Tax Credit can reduce borrowing costs by 15-20% for qualifying locations</li>
      ...
      <div className={bodyClass}>
        <p>A Community Development Financial Institution (CDFI) is a private financial institution certified by the U.S. Treasury Department with a primary mission of serving low-income and underserved communities. Unlike traditional banks, CDFIs use character-based underwriting alongside financial analysis, accept lower collateral coverage ratios, and consider community impact in their lending decisions. They can approve loans that conventional banks decline while still maintaining strong portfolio performance. CDFIs include community development banks, credit unions, loan funds, and venture capital funds, over 1,400 certified institutions operate across the US.</p>
      </div>

      <h3 className={h3Class}>Can I use CDFI financing alongside SBA loans?</h3>
      <div className={bodyClass}>
        <p>Yes, and the CDFI + SBA combination is one of the most powerful financing structures for small acquisitions. The <Link href="/learn/sba-7a-loans-acquisition" className="text-apple-accent hover:underline">SBA 7(a) loan</Link> provides 60-70% of the deal as senior debt, while a CDFI subordinated loan fills 10-15% of the gap between the SBA loan and your equity. This can reduce the buyer&apos;s equity requirement to as low as 10-15%. Some CDFIs are also SBA-preferred lenders, which streamlines the process by having one institution coordinate both layers. Seller financing in a standby position rounds out the capital stack.</p>
      </div>
