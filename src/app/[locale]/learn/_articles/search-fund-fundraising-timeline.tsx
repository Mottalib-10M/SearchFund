...
export default function SearchFundFundraisingTimelineArticle() {
  return (
    <article>
      <h1 className={h1Class}>Search Fund Fundraising Timeline: Week-by-Week Guide</h1>
      <p className="text-sm text-apple-gray-500 mt-3">12 min read</p>

      <div className={bodyClass}>
        <p>
          Raising search capital is one of the most consequential phases of the
          entire <Link href="/learn/getting-started" className="text-apple-accent hover:underline">search fund journey</Link>.
          A well-executed fundraise sets the tone for your investor relationships,
          establishes your credibility, and gives you the runway to pursue
          acquisitions with confidence. The typical traditional search fund raise
          takes 8 to 16 weeks from first outreach to final close. The difference
          between a swift close and a drawn-out slog almost always comes down to
        ...
        <p>
          The sections below break each phase into concrete tasks and milestones.
          Adapt the timing to your circumstances, but resist the temptation to
        ...
        <p>
          ...
          review both before you begin outreach.
        </p>
        ...
        <h3 className={h3Class}>Building the investor target list</h3>
        <p>
          Compile a list of 80 to 120 prospective investors organized into tiers.
          Tier 1: institutional search fund investors and ex-searchers who invest
          actively. Tier 2: family offices, angel investors, and individuals in
          your extended network. Tier 3: cold outreach targets identified through
          research. For each prospect note their typical check size, mutual
          connections for warm introductions, and known investment preferences.
        </p>

        <h3 className={h3Class}>Rehearse your pitch</h3>
        <p>
          Practice your presentation at least ten times before sitting across
          from a real investor. Record yourself on video and review pacing,
          filler words, and whether you can deliver the narrative without reading
          from slides. The pitch itself should take 12 to 15 minutes, leaving
        ...
        <p>
          Reach out to professors, former colleagues, MBA classmates, and
          mentors. Ask each for two or three specific introductions to
          investors on your target list. A warm introduction converts at three
          to five times the rate of a cold email. Be specific: &ldquo;Would
          you introduce me to Jane Smith at Pacific Lake Partners?&rdquo;
          works better than &ldquo;Do you know anyone who invests in search
          funds?&rdquo;
        </p>
        ...
        <p>
          ...
          investors already on the cap table.
        </p>

        <h3 className={h3Class}>The initial screening call</h3>
        <p>
          Your first conversation with each investor is typically a 20- to
          30-minute call. The investor wants to understand who you are, why
          you chose ETA, and what makes your thesis compelling. Be prepared
          to discuss your background, search criteria, and your understanding
          of the <Link href="/learn/cap-tables-equity" className="text-apple-accent hover:underline">economics of the search fund model</Link>.
          End each call with a clear next step: sending the PPM and deck, or
        ...
        <p>
          ...
          your in-depth investor meetings, send PPMs, and begin converting
          initial interest into verbal commitments.
        </p>
        ...
        <p>
          ...
          asking directly whether the investor is interested.
        </p>

        <h3 className={h3Class}>Follow-up discipline</h3>
        <p>
          Within 24 hours send a personalized thank-you email referencing a
          specific topic from the conversation. Attach the PPM if not already
          shared. Track every interaction in your CRM with dates, status, and
          next steps. If you have not heard back within seven days, send a
          polite follow-up. One more check-in at 14 days is appropriate before
          moving the prospect to your dormant list.
        </p>

        <h3 className={h3Class}>Parallel processing</h3>
        <p>
        ...
        <h3 className={h3Class}>Understanding the term sheet</h3>
        <p>
          Common negotiation points include the step-up multiple at acquisition
          (typically 1.5x), the <Link href="/learn/searcher-compensation" className="text-apple-accent hover:underline">searcher&rsquo;s equity allocation</Link> and
          vesting schedule, board composition, investor pro-rata rights, and
          information rights during the search. Institutional investors rarely
          deviate from market terms, but individual investors may request
          customizations.
        </p>

        <h3 className={h3Class}>The first close</h3>
        <p>
          Most search funds conduct a first close at 60 to 70 percent of the
          target raise. This milestone lets you begin drawing salary, covering
          expenses, and initiating your search while continuing to fill the
          remaining units. Coordinate with your attorney to circulate
          subscription agreements, collect signed documents, and process wire
          transfers. The first close typically takes one to two weeks once all
          verbal commitments are in hand.
        </p>

        <h3 className={h3Class}>Managing expectations during the close</h3>
        <p>
          Between verbal commitment and wire transfer, things can stall.
          Investors may need time to review documents, consult attorneys, or
          free up capital. Stay in regular contact and provide gentle reminders
          without being pushy. If a committed investor begins to waver,
          schedule a call to address their concerns directly rather than
        ...
        <p>
          After the first close you typically have 30 to 40 percent of units
        ...
        <p>
          ...
          of units open for several months, allowing them to add strategic
          investors who emerge during deal sourcing. This flexibility can be
          valuable, but be careful not to let perpetual fundraising distract
          from the primary mission of finding an acquisition target.
        </p>

        <h3 className={h3Class}>Transitioning to active search</h3>
        <p>
        ...
        <h2 className={h2Class}>Institutional vs. individual investors</h2>

        <h3 className={h3Class}>Institutional investors</h3>
        <p>
          Dedicated search fund firms invest across dozens of funds per year.
          They understand the model deeply, move quickly, and bring pattern
          recognition from backing many searchers. They typically write checks
          of $50,000 to $100,000 per unit and can invest significantly more at
          acquisition. Their commitment is a powerful signal to other investors.
          Learn more in our guide to <Link href="/learn/finding-investors" className="text-apple-accent hover:underline">finding search fund investors</Link>.
        </p>
        ...
        <p>
          ...
          specific expertise that complements your thesis and can be more
          flexible on terms.
        </p>

        <h3 className={h3Class}>Balancing your cap table</h3>
        <p>
        ...
        <h2 className={h2Class}>What to do if fundraising stalls</h2>

        <h3 className={h3Class}>Diagnose the bottleneck</h3>
        <p>
          Stalls typically stem from one of three causes: your pipeline is too
          thin, your pitch is not resonating, or your materials have gaps. Ask
          investors who passed for honest feedback and look for patterns.
        </p>

        <h3 className={h3Class}>Refine your thesis and materials</h3>
        <p>
        ...
        <ol className={olClass}>
          ...
          <li>Send personalized outreach emails to Tier 2 prospects.</li>
        ...
        <ol className={olClass}>
          ...
          <li>Send formal close announcement to all investors.</li>
          <li>Establish monthly investor update cadence.</li>
          <li>Transition fully to active search operations.</li>
        </ol>
        ...
        <p>
          ...
          compound in value over the years ahead.
        </p>

        <p>
          If you are just beginning, start with the foundational guides:{" "}
          <Link href="/learn/getting-started" className="text-apple-accent hover:underline">getting started with ETA</Link>,{" "}
          <Link href="/learn/finding-investors" className="text-apple-accent hover:underline">how to find search fund investors</Link>,
