  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Position it as a win-win:</strong> Frame the seller note as{" "}
            <Link href="/learn/tax-optimization" className="text-apple-accent hover:underline">tax-efficient</Link>{" "}
            for the seller (installment sale treatment) and as evidence of their confidence in the business. Sellers who refuse any seller note may be signaling concerns about business sustainability.</li>
