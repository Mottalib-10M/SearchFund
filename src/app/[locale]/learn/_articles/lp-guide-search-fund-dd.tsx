    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          raise, you are underwriting a person, their judgment,
          temperament, and operating potential, with no company to
        ...
        <p>
          ...
          phase, what to evaluate, which questions to ask, and where
        ...
        <p>
          ...
          the company, but through the lens of whether this
        ...
        <ul className={ulClass}>
          <li>
            ...
            capital checks are typically $25K-$100K per LP.
            If the searcher identifies a target, acquisition capital
            checks run $100K-$500K or more. You face a binary
          ...
          <li>
            ...
            7-10 years. This means your diligence must price in
          ...
          <li>
            ...
            typically hold 15-30 funds to capture enough top-quartile
            outcomes. Our{" "}
        ...
        <p>
          The searcher is the investment. Everything else, the
          eventual target, the price paid, the operating plan, flows
        ...
        <p>
          The ideal searcher has 3-7 years of progressively
          ...
          outcomes, what matters is evidence of increasing
        ...
        <p>
          ...
          temperament or resilience required to search for 18-24
        ...
        <p>
          The searcher will become CEO of a small company with 20-200
          employees. They will face cash crunches, employee departures,
          customer losses, and operational crises, often in the
        ...
        <p>
          ...
          target industries, company size ($1M-$5M EBITDA is the
        ...
        <p>
          ...
          targets, companies contacted, NDAs signed, LOIs
          submitted, and a realistic 18-24 month timeline
        ...
        <p>
          ...
          clear communication, three traits you need in a future CEO.
        </p>
        <p>
        ...
        <ul className={ulClass}>
          <li>
            ...
            searcher equity allocation is 20-25%, typically
            vesting over 3-5 years. Watch for non-standard
          ...
          <li>
            ...
            $400K-$600K covering 24 months is standard for a
        ...
        <p>
          ...
          searcher told you, they are about surfacing information
        ...
        <ol className={olClass}>
          <li>
            <strong>Former managers and supervisors (2-3 calls).</strong>{" "}
          ...
          <li>
            <strong>Peers and direct reports (2-3 calls).</strong>{" "}
          ...
          <li>
            <strong>Prior investors or board members (2-3 calls).</strong>{" "}
        ...
        <p>
          ...
          &ldquo;On a scale of 1-10, how strongly would you
        ...
        <p>
          Search fund acquisitions typically close at 4-7x adjusted
          EBITDA for businesses in the $1M-$5M EBITDA range.
         ...
         , this is one of the most common value destroyers in
          the asset class.
        </p>
        <p>
        ...
        <ul className={ulClass}>
          <li>
            ...
            consistent activity levels, a searcher who goes quiet
            for six weeks is often struggling.
          </li>
          <li>
            <strong>Deal flow quality.</strong> Early deal flow is
            typically broad and unfocused. By months 6-9, the
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            Always request back-channel references, people the
        ...
        <p>
          ...
          amounts are larger, often 3-5x the original
          search check, and you now have more information to work
          with: a real company, real financials, and 12-24 months
        ...
        <p>
          ...
          that disciplined co-investors who decline 25-35% of
        ...
        <p>
          ...
          at least two back-channel references, people the searcher
        ...
        <p>
          ...
          an obligation. Experienced LPs decline 20-35% of
        ...
        <p>
          A minimum of 10-15, with 20-30 as the target for
