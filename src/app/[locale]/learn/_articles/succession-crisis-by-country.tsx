  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          According to OECD estimates, 10 to 15 million SMEs across OECD member countries will need to change ownership or face closure within the next decade due to aging business owners. The combined enterprise value at risk exceeds $10 trillion. Japan&apos;s METI estimates 1.27 million businesses at risk in Japan alone, while KfW&apos;s Nachfolge Monitor reports 600,000 German Mittelstand companies seeking successors by 2030. In the United States, the Exit Planning Institute estimates that 4.5 million baby boomer-owned businesses valued at approximately $10 trillion will transition by 2035. The <Link href="/learn/baby-boomer-succession" className="text-apple-accent hover:underline">baby boomer succession wave</Link> is the single largest generational transfer of business ownership in economic history, and the failure rate for succession (30&ndash;50% of listed businesses never finding a buyer) highlights the urgency for qualified acquirers.
        </p>
