...
export default function SearchFundCommunitiesArticle() {
  return (
    <article className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <h2 className={h2Class}>Regional Searcher Groups</h2>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          ...
          <ul className="space-y-2">
            <li>
              ...
              >
                SearchFunder - Search Fund Community Platform
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                className="text-apple-accent hover:underline"
              >
                Pacific Lake Partners - Search Fund Investment
              </a>
            </li>
            <li>
              <a
                href="https://www.relayinvestments.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-apple-accent hover:underline"
              >
                Relay Investments - Search Fund Community
              </a>
            </li>
            <li>
              <a
