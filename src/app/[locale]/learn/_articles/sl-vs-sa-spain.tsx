    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Transfer tax (ITP):</strong> 1-6% depending on autonomous community (not subject to securities transfer tax)</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Ownership units:</strong> Acciones (shares), freely transferable by default</li>
          ...
          <li><strong>Transfer tax:</strong> Share transfers are exempt from ITP (Transfer Tax) and VAT, significant tax advantage for share deals</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Transfer tax:</strong> SA share transfers are exempt from ITP; SL transfers face 1-6% ITP depending on the region</li>
          ...
          <li><strong>Cost:</strong> SL requires only &euro;3,000 capital; SA requires &euro;60,000, meaningful for holding company setup</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>SA offers free share transferability, share classes, and ITP exemption on transfers, better for investor-backed deals</li>
