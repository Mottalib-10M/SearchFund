...
export default function ETASelfAssessmentArticle() {
  return (
    <article>
      <h1 className={h1Class}>Is ETA Right for You? A Self-Assessment Framework</h1>
      ...
      <div className={bodyClass}>
        <p>
          ...
          committing. This framework gives you the tools to evaluate whether ETA
          aligns with your skills, temperament, finances, and life stage. Answer
          the questions honestly, not aspirationally, and you will walk away with
          a clear-eyed view of your readiness.
        </p>
        ...
        <h2 className={h2Class}>The skill assessment: what makes a good searcher?</h2>
        <p>
          ETA demands a broad skill set that few professionals possess in full
          on day one. The good news: gaps can be closed during{" "}
        ...
        <h3 className={h3Class}>Financial analysis and modeling</h3>
        <p>
          Can you build an LBO model from scratch? Read a quality of earnings
          report critically? Understand the implications of an asset purchase
          versus a stock purchase? Financial fluency is non-negotiable in ETA.
          You do not need to be a former investment banker, but you must be able
          to evaluate a business&apos;s economics with confidence. If you score
          yourself below a 3, plan to invest significant time in financial
          modeling coursework (Wall Street Prep, CFI, or structured programs at
          IESE and Booth) before launching your search.
        </p>

        <h3 className={h3Class}>Sales and relationship building</h3>
        <p>
          ...
          <Link href="/learn/deal-sourcing-strategies" className="text-apple-accent hover:underline">
            deal sourcing
          </Link>. If cold outreach makes you deeply uncomfortable, ETA will be
          an uphill battle.
        </p>

        <h3 className={h3Class}>Leadership and people management</h3>
        <p>
          After acquisition, you become CEO of an established business with an
        ...
        <h3 className={h3Class}>Resilience and emotional regulation</h3>
        <p>
          The search is a psychologically grueling process. As our guide on{" "}
        ...
        <h3 className={h3Class}>Strategic and operational thinking</h3>
        <p>
          As CEO, you will need to set strategy, manage operations, and
          identify levers for growth and efficiency. Strong searcher-operators
          are able to zoom out to the strategic level and zoom in to
          operational details within the same conversation. They are comfortable
          discussing a three-year growth plan with the board in the morning and
          troubleshooting a supply chain bottleneck in the afternoon. If your
          career has been entirely strategic (consulting) or entirely
          operational (plant management), consider how to round out the other
          dimension.
        </p>

        <h2 className={h2Class}>Financial readiness checklist</h2>
        <p>
          Financial preparation is one of the most objective parts of the
          self-assessment. Use this checklist to evaluate your readiness. Each
          item you cannot check increases your risk of a premature or
          compromised search.
        </p>
        <ol className={olClass}>
          ...
          <li>
            <strong>Health insurance:</strong> Have you identified and budgeted
            for individual health insurance coverage if you leave employer-sponsored
            benefits?
          </li>
          <li>
            <strong>Partner income:</strong> If you have a partner, does their
            income cover baseline household expenses during the search period?
            If not, is your savings buffer large enough to compensate?
          </li>
          <li>
            <strong>Opportunity cost acceptance:</strong> Have you calculated
            the total compensation you are forgoing over two years and accepted
            it as a calculated bet?
          </li>
          <li>
            <strong>Worst-case plan:</strong> If the search fails after 24
            months and you do not acquire, do you have a viable financial and
            career fallback?
          </li>
        </ol>
        <p>
          If you can check five or more items confidently, you are in a
          reasonable financial position to begin. Fewer than four checked items
          suggests you need to strengthen your financial foundation before
          committing. The{" "}
          ...
          can help you determine which model better fits your financial
          situation.
        </p>
        ...
        <ol className={olClass}>
          ...
          <li>
            <strong>Ego resilience:</strong> Can you handle a year of being
            ignored by brokers, ghosted by sellers, and outbid by competitors
            without it eroding your confidence? The search is a long stretch
            of &ldquo;no&rdquo; punctuated by a single, life-changing
            &ldquo;yes.&rdquo;
          </li>
          <li>
          ...
          <li>
            <strong>Autonomy vs. structure:</strong> ETA provides almost no
            structure. You set your own schedule, define your own process, and
            hold yourself accountable. If you thrive in structured environments
            with clear deliverables and regular feedback, the open-endedness
            of the search may be destabilizing.
          </li>
          <li>
        ...
        <p>
          ...
          10 (completely comfortable). Be honest with yourself.
        </p>
        <ol className={olClass}>
          <li>
          ...
          <li>
            <strong>Career gap:</strong> Spending two years on a search that
            ultimately does not result in an acquisition, then re-entering
            the job market. (Your score: ___/10)
          </li>
          <li>
          ...
          <li>
            <strong>Operational failure:</strong> Making a strategic decision
            as CEO that costs the business $200K+ and having to face your
            board and investors to explain it. (Your score: ___/10)
          </li>
          <li>
            <strong>People decisions:</strong> Firing a long-tenured employee
            who is well-liked but underperforming within your first six months
            as CEO. (Your score: ___/10)
          </li>
          <li>
            <strong>Social uncertainty:</strong> Explaining to friends, family,
            and former colleagues that you left a high-paying job to
            &ldquo;search for a business to buy&rdquo; and fielding confused
            or skeptical reactions for months. (Your score: ___/10)
          </li>
          <li>
            <strong>Relocation disruption:</strong> Uprooting your household
            and moving to a new city (possibly one you have never lived in)
            to close the right deal. (Your score: ___/10)
          </li>
        </ol>
        <p>
          <strong>Scoring interpretation:</strong> If your average score across
          all eight scenarios is 7 or above, your risk tolerance is
        ...
        <h2 className={h2Class}>Career timing: when is the right moment?</h2>
        <p>
        ...
        <p>
          ...
          returns. The challenge: you may lack the management experience and
          professional credibility that sellers and investors value. If you
          are in this window, consider whether an MBA program with a strong
          ETA track (Stanford, IESE, INSEAD, Booth) would accelerate your
          trajectory, or whether two to three more years of operating
          experience would give you the foundation to search with greater
          confidence.
        </p>
        ...
        <p>
          ...
          to weather the financial exposure, and a long enough runway to
          enjoy the compounding benefits of ownership. The trade-off is that
          mid-career professionals often have higher fixed costs (mortgage,
          children, dual-career households) that make the income disruption
          more consequential. The key question at this stage is not
          &ldquo;can I do it?&rdquo; but &ldquo;can my household sustain
          the financial transition?&rdquo;
        </p>

        <h3 className={h3Class}>Late career (40+)</h3>
        <p>
          You bring deep expertise and a strong professional network, which
          can accelerate both fundraising and deal sourcing. The challenges:
          a shorter time horizon reduces the compounding benefit,
          compensation expectations may be harder to match during the
          search, and investors may question whether you have the energy for
          a seven-to-ten-year commitment. Late-career searchers often
          succeed best with self-funded approaches in industries where
          their specific expertise is a decisive advantage.
        </p>

        <h2 className={h2Class}>Family and support system considerations</h2>
        <p>
          ETA is not a solo endeavor. If you have a partner, a family, or
          significant personal obligations, their alignment is a
          prerequisite, not a nice-to-have. Misalignment at home is one of
          the leading causes of search abandonment and post-acquisition
          CEO burnout.
        </p>

        <h3 className={h3Class}>Partner alignment</h3>
        <p>
          Your partner needs to understand and accept not just the concept of
          ETA but its practical implications: reduced income for two or more
          years, possible relocation to a new city, the all-consuming nature
          ...
          if you reach that limit without acquiring.
        </p>

        <h3 className={h3Class}>Dependent obligations</h3>
        <p>
          Children, aging parents, and other dependent obligations add
          ...
          are no surprises when the search or CEO role demands 60-hour
          weeks.
        </p>

        <h3 className={h3Class}>Emotional support network</h3>
        <p>
          Beyond your household, you need a broader support system. Identify
          two to three people who will be your sounding boards during the
          search: former searchers who understand the journey, close friends
          who will be honest with you, or a professional coach or therapist.
        ...
        <h2 className={h2Class}>Alternative paths if ETA is not right</h2>
        <p>
          If your self-assessment reveals significant gaps or misalignment,
          that does not mean entrepreneurship is off the table. It means the
          traditional search fund path may not be the optimal vehicle for
          your goals right now. Consider these alternatives:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Operating role at a search fund portfolio company:</strong>{" "}
          ...
          <li>
            ...
            not the time or temperament for operating, investing in search
            funds gives you exposure to the asset class and the ETA
            community. Our guide on{" "}
            <Link href="/learn/why-invest-in-search-funds" className="text-apple-accent hover:underline">
              why invest in search funds
            </Link>{" "}
            covers the investor perspective in detail.
          </li>
          <li>
            <strong>Part-time self-funded search:</strong> If your primary
            concern is income disruption, some searchers conduct a self-funded
            search alongside their current employment. This extends the
            timeline significantly (three to four years is common) and
            limits your deal sourcing bandwidth, but it eliminates the
            financial cliff of quitting your job.
          </li>
          <li>
            <strong>Startup founding:</strong> If you are drawn more to
            building something from scratch than to acquiring an existing
            business, a startup may be a better fit. The risk profile is
            higher, but the creative satisfaction may better match your
            temperament. Our comparison of{" "}
          ...
          <li>
            <strong>Corporate development or M&amp;A role:</strong> If you
            love the deal process but not the CEO responsibility, a career
            in corporate development lets you source, evaluate, negotiate,
            and close acquisitions as an employee rather than a principal.
          </li>
        </ul>

        <h2 className={h2Class}>Red flags vs. green flags: self-assessment table</h2>
        <p>
          Use this table as a quick diagnostic. Red flags do not automatically
          disqualify you, but each one increases the risk and difficulty of
          your search. Green flags do not guarantee success, but they
          indicate strong alignment with the ETA model.
        </p>
          ...
          <table className="min-w-full border border-gray-200 text-sm">
            <thead>
              <tr className="bg-gray-50">
                <th className="px-4 py-3 text-left font-semibold text-apple-black border-b border-gray-200">
                  Dimension
                </th>
                <th className="px-4 py-3 text-left font-semibold text-red-700 border-b border-gray-200">
                  Red Flags
                </th>
                <th className="px-4 py-3 text-left font-semibold text-green-700 border-b border-gray-200">
                  Green Flags
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-100">
                ...
                <td className="px-4 py-3 text-red-800">Running away from current job; attracted to title and prestige</td>
                <td className="px-4 py-3 text-green-800">Genuinely excited about owning and operating a small business</td>
              </tr>
              ...
              <tr className="border-b border-gray-100">
                ...
                <td className="px-4 py-3 text-red-800">Loses sleep over financial uncertainty; needs guaranteed outcomes</td>
                <td className="px-4 py-3 text-green-800">Comfortable with calculated bets; can function well under uncertainty</td>
              </tr>
              <tr className="border-b border-gray-100 bg-gray-50">
                <td className="px-4 py-3 font-medium">Resilience</td>
                <td className="px-4 py-3 text-red-800">Takes rejection personally; gives up after setbacks</td>
                <td className="px-4 py-3 text-green-800">Learns from failure; maintains motivation through extended difficulty</td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="px-4 py-3 font-medium">Leadership experience</td>
                <td className="px-4 py-3 text-red-800">Never managed people; uncomfortable with conflict</td>
                <td className="px-4 py-3 text-green-800">Has managed teams; made difficult personnel decisions</td>
              </tr>
              <tr className="border-b border-gray-100 bg-gray-50">
                <td className="px-4 py-3 font-medium">Family alignment</td>
                <td className="px-4 py-3 text-red-800">Partner unaware of or opposed to plan; relocation non-negotiable</td>
                <td className="px-4 py-3 text-green-800">Partner fully informed and supportive; flexible on geography</td>
              </tr>
              <tr className="border-b border-gray-100">
              ...
              <tr className="border-b border-gray-100 bg-gray-50">
                ...
                <td className="px-4 py-3 text-red-800">Only interested in &ldquo;cool&rdquo; or tech businesses; sees small business as beneath them</td>
                <td className="px-4 py-3 text-green-800">Excited about HVAC, staffing, healthcare services, specialty manufacturing</td>
              </tr>
              <tr className="border-b border-gray-100">
                <td className="px-4 py-3 font-medium">Decision-making</td>
                <td className="px-4 py-3 text-red-800">Analysis paralysis; needs consensus before acting</td>
                <td className="px-4 py-3 text-green-800">Decisive with incomplete information; trusts own judgment</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-medium">Support system</td>
                <td className="px-4 py-3 text-red-800">No mentors or peer network; plans to figure it out alone</td>
                <td className="px-4 py-3 text-green-800">Connected to ETA community; has mentors and a support network</td>
              </tr>
            </tbody>
          </table>
        </div>
        <p>
          Count your green flags and red flags. If you have seven or more
          greens, you are well-positioned. Four to six greens suggests
          promising potential with specific areas to address. Fewer than
          four greens warrants serious reflection on whether ETA is the
          right path at this point in your life.
        </p>

        <h2 className={h2Class}>Decision framework: score yourself</h2>
        <p>
          Bringing together all the dimensions above, use this composite
          scoring framework to generate a single readiness score. For each
          of the ten categories below, assign yourself a score from 1
          (not ready) to 10 (fully ready). Be rigorously honest.
        </p>
        <ol className={olClass}>
          <li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            <Link href="/learn/pre-search-preparation" className="text-apple-accent hover:underline">
              structured pre-search preparation
            </Link>{" "}
          ...
          <li>
            ...
            <Link href="/learn/getting-started" className="text-apple-accent hover:underline">
              introductory study of the model
            </Link>{" "}
        ...
        <h2 className={h2Class}>Final considerations</h2>
        <p>
          No self-assessment framework can tell you with certainty whether
        ...
        <p>
          If they do not, that is equally valuable to know now, before you
