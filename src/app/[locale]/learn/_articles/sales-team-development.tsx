  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Many businesses acquired through search funds have no formal sales function. Revenue comes from the owner&apos;s personal relationships, referrals, and repeat customers. Building a real sales team and process is one of the most powerful growth levers available to a new CEO, often unlocking 20-40% revenue growth within the first 18 months.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Compensation:</strong> Base + commission with a 60/40 or 70/30 split. Include a 3-6 month ramp period with guaranteed minimum.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Most acquired businesses have no formal sales function, building one can unlock 20-40% revenue growth</li>
