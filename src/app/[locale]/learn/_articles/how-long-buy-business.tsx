    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          how long will this actually take? The honest answer is 6-24
        ...
        <ul className={ulClass}>
          <li><strong>Self-funded search (part-time):</strong> 12-24 months from start to close</li>
          <li><strong>Self-funded search (full-time):</strong> 6-18 months</li>
          <li><strong>Traditional search fund:</strong> 18-30 months (including fundraise)</li>
          <li><strong>Direct acquisition (known target):</strong> 3-9 months</li>
        </ul>

        <h2 className={h2Class}>Phase 1: Preparation (1-3 months)</h2>
        <p>
        ...
        <h2 className={h2Class}>Phase 2: Deal sourcing (2-12 months)</h2>
        <p>
        ...
        <ul className={ulClass}>
          <li><strong>Business brokers:</strong> Register with 5-15 brokers in your target market. Expect 2-6 months to see a strong pipeline. See our{" "}
            <Link href="/learn/deal-sourcing-strategies" className="text-apple-accent hover:underline">
              deal sourcing strategies
            </Link>.</li>
          <li><strong>Online marketplaces:</strong> BizBuySell, Axial, DealNexus, immediate access but lower quality</li>
          <li><strong>Direct outreach:</strong> Cold calling/mailing business owners. Highest quality but longest lead time (3-12 months to develop)</li>
          <li><strong>Professional referrals:</strong> CPAs, attorneys, wealth advisors, build relationships that produce deal flow over 3-6 months</li>
        </ul>

        <h3 className={h3Class}>Typical funnel</h3>
        <ul className={ulClass}>
          <li>Opportunities reviewed: 100-300</li>
          <li>Signed NDAs: 30-80</li>
          <li>First meetings: 15-40</li>
          <li>Deep analysis: 5-15</li>
          <li>LOIs submitted: 2-5</li>
          <li>LOIs accepted: 1</li>
        </ul>

        <h2 className={h2Class}>Phase 3: LOI and exclusivity (2-6 weeks)</h2>
        <p>
          ...
          typically takes 2-6 weeks. Key elements that affect
          timing:
        </p>
        <ul className={ulClass}>
          <li>Initial{" "}
            ...
            analysis: 1-2 weeks</li>
          <li>LOI drafting and legal review: 1-2 weeks</li>
          <li>Negotiation with seller: 1-4 weeks (multiple rounds common)</li>
          <li>Exclusivity period: typically 60-120 days from LOI signing</li>
        </ul>

        <h2 className={h2Class}>Phase 4: Due diligence (45-120 days)</h2>
        <p>
        ...
        <ul className={ulClass}>
          <li><strong>Simple deals (&lt;$2M):</strong> 30-60 days</li>
          <li><strong>Mid-market ($2-$10M):</strong> 60-90 days</li>
          <li><strong>Complex deals ($10M+):</strong> 90-120 days</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            ...
            3-6 weeks for the accounting firm to complete
          </li>
          <li><strong>Legal review:</strong> Contracts, leases, IP, litigation, 3-6 weeks</li>
          <li><strong>Environmental (if applicable):</strong> Phase I assessments take 4-6 weeks</li>
        ...
        <h2 className={h2Class}>Phase 5: Financing (30-90 days, parallel with DD)</h2>
        <p>
          Financing typically runs in parallel with due diligence:
        </p>
        <ul className={ulClass}>
          <li><strong>SBA 7(a):</strong> 45-90 days from application to funding, per SBA processing data. Start early, SBA underwriting is the most common cause of closing delays.</li>
          <li><strong>Conventional bank loan:</strong> 30-60 days</li>
          <li><strong>Search fund equity:</strong> 2-4 weeks (investors have pre-committed)</li>
          <li>
            <strong>
        ...
        <h2 className={h2Class}>Phase 6: Closing (2-4 weeks)</h2>
        <p>
          After DD is complete and financing is approved, the closing
          process takes 2-4 weeks:
        </p>
        <ul className={ulClass}>
          <li>Purchase agreement finalization: 1-2 weeks of back-and-forth between attorneys</li>
          ...
          <li>Post-closing adjustments (typically within 60-90 days after closing)</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Full-time search:</strong> Part-time searchers take 50-100% longer than full-time</li>
        </ul>

        <h2 className={h2Class}>What slows things down</h2>
        <ul className={ulClass}>
          <li><strong>Seller cold feet:</strong> The most common delay, sellers who aren&rsquo;t emotionally ready</li>
        ...
        <ul className={ulClass}>
          <li>Sourcing to LOI: 2-6 months</li>
          <li>LOI to close: 2-4 months</li>
          <li><strong>Total: 4-10 months</strong></li>
        </ul>

        <h3 className={h3Class}>Lower mid-market ($2-$10M)</h3>
        <ul className={ulClass}>
          <li>Sourcing to LOI: 4-12 months</li>
          <li>LOI to close: 3-6 months</li>
          <li><strong>Total: 7-18 months</strong></li>
        </ul>

        <h3 className={h3Class}>Mid-market ($10M+)</h3>
        <ul className={ulClass}>
          <li>Sourcing to LOI: 6-18 months</li>
          <li>LOI to close: 4-9 months</li>
          <li><strong>Total: 10-27 months</strong></li>
        </ul>

        <h2 className={h2Class}>Bottom line</h2>
        <p>
          Expect the process to take longer than you think. The median
          first-time buyer underestimates the timeline by 6-12
          months. Build buffer into your personal financial runway , 
          our{" "}
          <Link href="/learn/search-fund-cost" className="text-apple-accent hover:underline">
            search fund cost breakdown
          </Link>{" "}
          can help you plan, start
        ...
        <p>
          ...
          pre-qualification before you identify a target eliminates 2-4
          ...
          3-6 months before you are ready to submit LOIs ensures a warm
          ...
          BizBuySell data suggests full-time searchers close 50-100%
        ...
        <p>
          ...
          cold feet. Approximately 30-50% of deals that reach LOI stage
        ...
        <p>
          ...
          in 6-18 months, while part-time searchers take 12-24
