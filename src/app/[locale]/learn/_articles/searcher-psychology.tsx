...
export default function SearcherPsychologyArticle() {
  return (
    <article>
      <h1 className={h1Class}>The Psychology of the Search: Mindset &amp; Resilience</h1>
      ...
      <div className={bodyClass}>
        <p>
          ...
          <Link href="/learn/pre-search-preparation" className="text-apple-accent hover:underline">pre-search preparation</Link> you
          can undertake.
        </p>
        <p>
        ...
        <h2 className={h2Class}>The rejection machine</h2>
        <p>
        ...
        <p>
          Rejection comes in many forms. Sellers who ghost you after weeks of
          engagement. Brokers who won&apos;t return your calls because you&apos;re a
          first-time buyer. LOIs that get outbid by private equity firms with
          deeper pockets. Deals that fall apart during due diligence when you
          discover undisclosed liabilities. Each rejection stings, and they
          accumulate.
        </p>
        <p>
        ...
        <p>
          Research on decision fatigue, pioneered by psychologist Roy Baumeister,
          shows that the quality of our decisions deteriorates as the number of
          decisions increases. Searchers are particularly vulnerable because the
          stakes of each decision feel enormous. Should I pursue this $8M
          manufacturing company or the $12M services business? Is this revenue
          decline cyclical or structural? Is the seller being honest about
          customer concentration risk?
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Build decision frameworks early.</strong> Define your criteria
            before you start seeing deals, not after. What industries, geographies,
            revenue ranges, and margin profiles are acceptable? A clear framework
            prevents you from relitigating the same questions with every new
            opportunity
          </li>
          <li>
            <strong>Batch your evaluations.</strong> Dedicate specific days to
            reviewing new opportunities and other days to advancing existing deals.
            Context-switching between sourcing and diligence drains cognitive energy
          </li>
          <li>
        ...
        <h2 className={h2Class}>Imposter syndrome: am I good enough to be CEO?</h2>
        <p>
          Nearly every searcher experiences imposter syndrome at some point during
          the process. You&apos;re 28-35 years old, you&apos;ve never run a company,
          and you&apos;re about to convince investors to back you with millions of
          dollars, convince a seller to hand you their life&apos;s work, and then
          step into the CEO role of a company with employees who have decades more
          industry experience than you.
        </p>
        <p>
        ...
        <p>
          ...
          everything on day one but those who learned fastest and weren&apos;t afraid
          to ask questions.
        </p>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Financial stress:</strong> Leaving a well-paying corporate job
            to pursue a search means 12-24 months of reduced or uncertain income.
            For a traditional search fund, you&apos;ll earn a modest stipend of
            $80K-$120K. For a self-funded search, you may earn nothing during the
            search phase
          </li>
          <li>
            <strong>Relocation uncertainty:</strong> You don&apos;t know where
            you&apos;ll end up. The right acquisition target might be in Tulsa,
            rural Wisconsin, or the suburbs of Atlanta. For partners with their own
            careers, this uncertainty can be deeply destabilizing
          </li>
          <li>
            <strong>Emotional availability:</strong> The search is all-consuming.
            Even when you&apos;re physically present, you may be mentally replaying
            a conversation with a broker or stress-testing a financial model. This
            emotional absence takes a toll on relationships
          </li>
          <li>
            <strong>Timeline ambiguity:</strong> Unlike a job where you know your
            start date, the search has no guaranteed endpoint. &quot;It could take
            6 months or 24 months&quot; is not a reassuring answer for a partner
            who wants to plan their life
          </li>
        </ul>
        <p>
          The most important thing you can do is have explicit, honest
          conversations with your partner before you begin. Agree on financial
          boundaries (at what savings level do you pull the plug?), geographic
          constraints (are there cities that are absolute no-go?), and timeline
          limits (if you haven&apos;t closed after 24 months, what&apos;s the plan?).
          These conversations are uncomfortable, but having them early prevents
          far worse conversations later.
        </p>
        ...
        <p>
          Experienced searchers recommend several strategies for maintaining
          momentum during dry spells:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Track activity metrics, not just outcomes.</strong> You can&apos;t
            control whether a deal closes, but you can control how many outreach
            emails you send, how many brokers you meet, and how many NDAs you sign.
            Focusing on inputs gives you a sense of agency even when outcomes are
            absent
          </li>
          <li>
            <strong>Reconnect with your &quot;why.&quot;</strong> Why did you choose
            this path? What does success look like for you personally? Revisiting
            your original motivation provides energy when the process feels
            grinding
          </li>
          <li>
            <strong>Change your sourcing strategy.</strong> Our guide to{" "}
            <Link href="/learn/deal-sourcing-strategies" className="text-apple-accent hover:underline">deal sourcing strategies</Link> offers
            practical alternatives. If proprietary outreach
            isn&apos;t working, lean into broker relationships. If brokers aren&apos;t
            producing, try industry conferences or direct mail campaigns. A change
            in approach can reignite momentum
          </li>
          <li>
        ...
        <p>
          The critical psychological skill here is compartmentalization. You need
          to mourn the lost deal, extract lessons, and then move forward without
          letting the experience contaminate your evaluation of future
          opportunities. Some searchers become overly cautious after a broken deal,
          seeing red flags everywhere. Others become overly eager, lowering their
          standards to avoid another extended search. Neither reaction serves you.
        </p>

        <h2 className={h2Class}>Mental health strategies that work</h2>
        <p>
          Based on patterns observed across hundreds of searchers, the following
          mental health strategies have proven most effective:
        </p>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            <strong>Work with an executive coach.</strong> A growing number of
            searchers invest in professional coaching during the search phase.
            Coaches help with decision-making frameworks, emotional regulation,
            and accountability
          </li>
          <li>
            <strong>Maintain a non-search identity.</strong> If your entire identity
            is &quot;I&apos;m a searcher,&quot; every setback becomes an existential
            crisis. Maintain hobbies, friendships, and interests outside the search.
            You are more than your deal pipeline
          </li>
          <li>
            <strong>Set boundaries with work time.</strong> Searching 80 hours a
            week doesn&apos;t produce twice the results of 50 hours. Set working
            hours, take weekends (or at least Sundays), and create space for
            recovery
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Quit if:</strong> You&apos;ve exhausted your financial runway
            with no promising deals in the pipeline, your personal relationships
            are breaking under the strain, or you&apos;ve realized that being a CEO
            of an acquired company isn&apos;t actually what you want
          </li>
          <li>
        ...
        <h2 className={h2Class}>The &quot;grass is greener&quot; trap</h2>
        <p>
        ...
        <p>
          What you don&apos;t see is their frustration with corporate politics,
          their limited autonomy, and their diminishing sense of purpose. You chose
          the search because you wanted something different. The comparison trap
          robs you of conviction at exactly the moment you need it most. Stay in
          your lane. Your timeline is not their timeline.
        </p>
        ...
        <p>
          ...
          time to being responsible for an organization.
        </p>
        <p>
          ...
          CEO. You now need leadership, empathy, decisiveness, and the ability to
