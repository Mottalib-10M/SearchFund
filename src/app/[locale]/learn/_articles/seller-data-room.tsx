    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          average due diligence now takes 203 days, up 64% from a decade ago, and 41% of dealmakers cite diligence as the top obstacle to closing.
      ...
      <div className={bodyClass}>
        <p>
          Most sellers think of the data room as a box to check, upload some financials, share the link, move on.
          ...
          on diligence failures notes, most deals do not stall because the business is weak, they stall because disorganized diligence
        ...
        <p>
          ...
          For a small business in the $1M-$10M range, expect to assemble 100-250 documents. The point is not volume, it&rsquo;s completeness and structure.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <p>
          ...
          expect a numbered folder hierarchy. This structure is based on the Bloomberg Law framework used by M&amp;A attorneys and adapted
          for small-to-mid-market transactions:
        </p>
        <ol className={olClass}>
          <li><strong>01_Corporate &amp; Governance:</strong> Articles of incorporation, bylaws, organizational chart, board minutes, cap table, operating agreements, shareholder agreements (15-25 documents)</li>
          <li><strong>02_Financials:</strong> 3-5 years of audited or reviewed financial statements, monthly/quarterly P&amp;L, balance sheets, cash flow statements, accounts receivable and accounts payable aging, debt schedules, projections (15-20 documents)</li>
          <li><strong>03_Tax:</strong> Federal, state, and local tax returns (3-5 years), sales tax filings, nexus analysis, any pending audits or disputes (10-15 documents)</li>
          <li><strong>04_Legal &amp; Contracts:</strong> Material contracts, customer and vendor agreements, change-of-control provisions, debt instruments, real estate leases, equipment leases (15-25 documents)</li>
          <li><strong>05_Customers &amp; Revenue:</strong> Customer list with annual revenue per account, concentration analysis, renewal calendar, churn data, pipeline summary (10-15 documents)</li>
          <li><strong>06_HR &amp; Employment:</strong> Employee census with compensation, employment agreements, handbook, benefits summary, organizational chart, key person bios (10-15 documents)</li>
          <li><strong>07_IP &amp; Technology:</strong> Patent portfolio, trademarks, copyrights, domain names, trade secrets, open-source disclosures, technology architecture diagrams (15-20 documents)</li>
          <li><strong>08_Operations:</strong> Standard operating procedures, SLAs, vendor agreements, quality documentation, supply chain overview, business continuity plans (10-15 documents)</li>
          <li><strong>09_Regulatory &amp; Compliance:</strong> Licenses and permits, regulatory correspondence, industry certifications, environmental assessments, remediation plans (10-15 documents)</li>
          <li><strong>10_Insurance:</strong> All active insurance policies, claims history (3-5 years), coverage summary, pending claims (5-10 documents)</li>
          <li><strong>11_Real Estate &amp; Assets:</strong> Property deeds, lease agreements, ALTA surveys, equipment inventories with depreciation schedules, appraisals (5-15 documents)</li>
          <li><strong>12_Confirmatory (Gated):</strong> Items reserved for post-LOI access, sensitive customer contracts, employee social security data, trade secret documentation (varies)</li>
        </ol>
        <p>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Datasite (formerly Merrill Datasite):</strong> $2,000-$5,000+/month, averaging ~$68,000/year. Best-in-class M&amp;A features, AI-powered redaction, dedicated support. Per-page pricing model ($0.40-$0.85/page) can escalate rapidly. Charges extra for Excel files and special media types. Best for competitive auctions with 10+ bidders.</li>
          <li><strong>Intralinks:</strong> $1,000-$5,000+/month, ranging from $10,000 to $200,000+/year. Similar per-page model to Datasite (~$7,500 for 10,000 pages). Strong in cross-border deals. Adds costs for non-standard file formats.</li>
        </ul>

        <p><strong>Mid-market VDRs (deals $5M-$25M):</strong></p>
        <ul className={ulClass}>
          ...
          <li><strong>iDeals:</strong> $460-$1,000+/month ($5,520-$12,000+/year). Setup fees of $1,000-$5,000. Clean interface with built-in NDA management.</li>
          <li><strong>DealRoom:</strong> $625-$2,083/month ($7,500-$25,000/year). Unique project management layer on top of standard VDR features.</li>
        </ul>
        ...
        <p>
          Hidden fees to watch for across all providers: setup and onboarding ($500-$2,500), storage overages ($75-$300/GB/month),
          and user overages ($15-$90/user/month). Always negotiate an all-inclusive cap before signing a VDR contract.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <p>
          ...
          Each category maps to the 12-folder structure above. Prioritize items marked with an asterisk (*), buyers request these in the first week of diligence.
        </p>

        <p><strong>Financials (Folder 02), the foundation of every{" "}
        ...
        <ul className={ulClass}>
          ...
          <li>* Cash flow statements (3-5 years)</li>
          ...
          <li>Financial projections (2-3 years forward)</li>
          <li>Capital expenditure history and forecast</li>
        </ul>

        <p><strong>Tax (Folder 03):</strong></p>
        <ul className={ulClass}>
          <li>* Federal tax returns (3-5 years)</li>
          <li>* State and local tax returns (3-5 years)</li>
      ...
      <div className={bodyClass}>
        <p>
          ...
          That is not enough. Start 3-6 months before going to market. Here is a practical timeline:
        </p>
        <ul className={ulClass}>
          ...
          <li><strong>Market launch:</strong> Share pre-LOI access (Folders 01-03 plus summary documents from Folders 05-06). Customer names, detailed contracts, and employee personal data remain gated in Folder 12 until a letter of intent is signed.</li>
          <li><strong>Post-LOI:</strong> Unlock full access. Designate a Q&amp;A coordinator who responds to buyer questions within 24-48 hours. Prompt responses maintain deal momentum and buyer confidence.</li>
        </ul>
        <p>
      ...
      <div className={bodyClass}>
        <p>
          Access control is not just about keeping competitors out, it is about demonstrating to buyers that you handle sensitive
        ...
        <ul className={ulClass}>
          <li><strong>Role-based permissions:</strong> Create distinct user groups, financial buyer, strategic buyer, legal counsel, M&amp;A advisor. Each group sees only the folders relevant to their role and deal stage.</li>
        ...
        <p>
          ...
          most serious bidder, allocate your management time accordingly.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          ...
          <li><strong>Missing financials.</strong> Gaps in your financial history, a missing Q3 P&amp;L, an unexplained revenue spike, tax returns with missing schedules, create red flags that trigger additional diligence requests and slow the process by weeks. Completeness matters more than perfection.</li>
          ...
          <li><strong>Ignoring the Q&amp;A log.</strong> When buyers submit questions and get no response for five days, they assume the worst. Designate one person, typically your CFO or M&amp;A advisor, as the Q&amp;A coordinator, with a 24-48 hour response SLA.</li>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          For mid-market deals ($5M-$25M), Firmex averages ~$7,800/year, and iDeals runs $5,520-$12,000/year.
        ...
        <p>
          A typical small business data room ($1M-$10M deal) contains 100-250 individual documents spanning the 12 categories outlined above.
          Mid-market transactions ($10M-$100M) often reach 300-500+ documents.
          The Bloomberg Law standard framework identifies 174 distinct document types across 10 core categories.
          Focus on completeness within each category rather than hitting a specific number, a missing tax return is far more damaging than
          having &ldquo;only&rdquo; 120 documents.
        </p>

        <h3 className={h3Class}>When should I start preparing my data room?</h3>
        <p>
          Start 3-6 months before going to market. The average seller spends only 27 days on data room preparation, which leads to gaps,
          ...
          begun{" "}
          <Link href="/learn/prepare-business-for-sale" className="text-apple-accent hover:underline">preparing your business for sale</Link>,
          start with your financial records and corporate documents, these take the longest to assemble.
        </p>
        ...
        <p>
          ...
          multiple potential buyers or your deal involves sensitive IP, invest in a dedicated VDR, even a budget option like SecureDocs
        ...
        <p>
          Pre-LOI, share Folders 01-03 (corporate overview, summary financials, tax returns) plus high-level summaries from Folders 05 and 06
