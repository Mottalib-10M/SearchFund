    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          into insurance distribution roll-ups &mdash; Hub International,
          Acrisure, and AssuredPartners are among the most prominent examples
          &mdash; but the vast majority of the market remains untouched by
          institutional capital. For a search fund entrepreneur, an independent
          insurance agency in the $1.5M&ndash;$10M revenue range represents a
        ...
        <p>
          ...
          commissions per account &mdash; 10&ndash;20% of premium versus
          8&ndash;15% for personal lines &mdash; and have stickier client
        ...
        <p>
          ...
          A whole life policy might pay 50&ndash;100% of first-year premium
          as commission, dropping to 2&ndash;5% in renewal years. This
          ...
          vision, disability, life) typically pay 3&ndash;8% trailing
          commissions and retain at very high rates &mdash; 90%+ for
          employer-sponsored group plans.
        </p>

        <h3 className={h3Class}>Employee benefits</h3>
        <p>
          Benefits brokerage &mdash; advising employers on group health,
          retirement plans, and voluntary benefits &mdash; is increasingly
          attractive for acquirers. Revenue is highly recurring, retention
          rates of 92&ndash;96% are typical, and the complexity of employee
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            88&ndash;95% are standard in commercial lines and benefits.
          ...
          <li>
            ...
            sellers at reasonable valuations &mdash; a dynamic unlikely to
            change for years.
          </li>
          <li>
          ...
          <li>
            ...
            agencies acquired at 6&ndash;8x EBITDA can be integrated into a
            platform that trades at 10&ndash;15x or higher, creating
          ...
          <li>
            ...
            insurance markets, rate increases of 5&ndash;15% flow directly
        ...
        <p>
          ...
          Independent agents represent multiple insurance carriers and &mdash;
          critically &mdash; own their book of business. They can move client
          ...
          represent a single carrier and generally do not own the book &mdash;
        ...
        <p>
          Personal lines agencies focus on individual consumers &mdash; home,
          auto, renters, and umbrella insurance. These books tend to have
          lower revenue per account ($500&ndash;$2,000 in annual commission),
          higher policy counts, and somewhat lower retention rates
          (85&ndash;90%) because consumers are more price-sensitive. Personal
        ...
        <p>
          ...
          significantly higher ($2,000&ndash;$25,000+ in annual commission),
          retention is stronger (90&ndash;95%), and the advisory relationship
        ...
        <ul className={ulClass}>
          <li>
            ...
            Ideally, no single account should represent more than 3&ndash;5%
          ...
          <li>
            ...
            data, tracked monthly. Look for trends &mdash; declining retention
          ...
          <li>
            ...
            the past 3&ndash;5 years. A flat or declining book suggests the
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            can represent 1&ndash;5% of total premiums and are a significant
            income source for well-managed agencies. However, they are
            volatile and not guaranteed &mdash; a year with heavy losses
        ...
        <ul className={ulClass}>
          <li>
            ...
            transfer. Start carrier notifications early in the process &mdash;
          ...
          <li>
            ...
            should have relationships with 8&ndash;15 carriers across
        ...
        <p>
          ...
          (below 50&ndash;55% for commercial lines) signals a well-managed
          ...
          remarket accounts &mdash; a labor-intensive process that risks
          client attrition.
        </p>
        ...
        <ul className={ulClass}>
          <li>
            ...
            significant transition risk. Plan for a 12&ndash;24 month seller
          ...
          <li>
            ...
            Producer books are portable &mdash; if a producer leaves, they
          ...
          <li>
            ...
            30&ndash;50% of commissions for new business and 20&ndash;35%
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            and personal lines might trade at 1.5&ndash;2.2x overall.
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Small agencies ($3M&ndash;$5M revenue):</strong>
            5&ndash;7x EBITDA. These are typical search fund-sized
            acquisitions.
          </li>
          <li>
            <strong>Mid-sized agencies ($5M&ndash;$20M revenue):</strong>
            7&ndash;10x EBITDA. Agencies in this range attract interest from
            both search funds and private equity-backed platforms.
          </li>
          <li>
            <strong>Large agencies and platforms ($20M+ revenue):</strong>
            10&ndash;15x EBITDA. These multiples are driven by institutional
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            0.5&ndash;1.0x to account for transition risk.
          </li>
          <li>
        ...
        <p>
          ...
          12&ndash;24 month transformation roadmap.
        </p>
        ...
        <p>
          ...
          employment practices liability coverage. Account rounding &mdash;
          increasing the number of policies per client &mdash; is the
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            simultaneously, reducing the time per quote from 2&ndash;3 hours
            to 15&ndash;30 minutes for personal lines and small commercial.
          </li>
          <li>
            ...
            20&ndash;40% and improves the client experience.
          </li>
          <li>
        ...
        <ul className={ulClass}>
          <li>
            Recruit 1&ndash;2 experienced producers within the first year.
            Offer a competitive base salary during a ramp period (typically
            18&ndash;24 months) plus commission splits that increase as they
            build their book.
          </li>
          <li>
        ...
        <p>
          ...
          20&ndash;25% of premium with any single carrier and actively
          diversify.
        </p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            complete 20&ndash;40 hours of continuing education per renewal
        ...
        <p>
          ...
          professional mistakes &mdash; a missed renewal, an incorrect
        ...
        <ul className={ulClass}>
          ...
          <li>
            Ensure adequate limits &mdash; most agencies carry $1M&ndash;$5M
          ...
          <li>
            ...
            premiums are typically 150&ndash;250% of the annual premium for
            a 3-year tail.
          </li>
          <li>
        ...
        <p>
          ...
          commercial insurance has been limited &mdash; complex risks still
          require human expertise and carrier relationships &mdash; acquirers
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            acquisitions include 10&ndash;30% seller financing, which aligns
