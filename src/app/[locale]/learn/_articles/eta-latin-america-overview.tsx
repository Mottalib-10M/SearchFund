...
export default function ETALatinAmericaOverviewArticle() {
  return (
    <article>
      <h1 className={h1Class}>ETA in Latin America: A Continental Overview</h1>
      <p className="text-sm text-apple-gray-500 mt-3">13 min read</p>

      <div className={bodyClass}>
        <p>
          Latin America is rapidly emerging as one of the world&rsquo;s most compelling frontiers for{" "}
          <Link href="/learn/what-is-eta" className="text-apple-accent hover:underline">Entrepreneurship Through Acquisition</Link>.
          With a combined population exceeding 650&nbsp;million people, a regional GDP surpassing
          $6&nbsp;trillion, and millions of family businesses approaching a generational succession
          wave, the continent offers a rare combination of scale, demographic tailwinds, and
        ...
        <h2 className={h2Class}>Why Latin America matters for ETA</h2>
        <p>
          Several structural factors make Latin America uniquely attractive for search fund
          entrepreneurs seeking outsized returns in less competitive environments.
        </p>
        ...
        <h2 className={h2Class}>Key markets across the continent</h2>
        <p>
          Latin America is not a monolith. Each major market presents distinct characteristics,
          regulations, and cultural dynamics that searchers must understand before launching.
        </p>
        ...
        <p>
          ...
          Real) and requires careful structuring.
        </p>

        <h3 className={h3Class}>Mexico</h3>
        <p>
          <Link href="/learn/eta-mexico" className="text-apple-accent hover:underline">Mexico</Link> is
          Latin America&rsquo;s second-largest economy, with deep integration into North American
          supply chains through the USMCA trade agreement. The country has over four&nbsp;million
          formal SMEs. Mexico City, Monterrey, and Guadalajara are the primary commercial hubs,
          each with distinct business cultures and industry concentrations.
        </p>
        <p>
          The Sociedad An&oacute;nima Promotora de Inversi&oacute;n (SAPI) has become the preferred
          legal vehicle for acquisition-oriented companies, offering flexible governance and
          shareholder agreement provisions. Mexico&rsquo;s proximity to the United States, combined
          with a large bilingual talent pool, makes it an attractive base for searchers who want to
          maintain ties to US-based investors while operating in Latin America.
        </p>

        <h3 className={h3Class}>Colombia, Chile &amp; Peru</h3>
        <p>
          The Andean economies have become the most dynamic corridor for ETA activity in the
          region. Our dedicated guide to{" "}
          <Link href="/learn/eta-colombia-chile-peru" className="text-apple-accent hover:underline">ETA in Colombia, Chile, and Peru</Link>{" "}
          explores these markets in depth.
        </p>
        <p>
          <strong>Colombia</strong> has emerged as a regional leader in search fund activity,
          driven by a rapidly professionalizing economy, strong business school networks
          (Universidad de los Andes and CESA), and a government that encourages foreign
          investment. The Sociedad por Acciones Simplificada (S.A.S.) provides a modern, flexible
          corporate form well-suited to search fund structures. Multiples typically range from
          3x to 4.5x EBITDA.
        </p>
        <p>
          <strong>Chile</strong> is often cited as Latin America&rsquo;s most business-friendly
          market, with strong rule of law, transparent regulations, and deep capital markets. The
          Sociedad por Acciones (SpA) offers flexibility comparable to the Colombian S.A.S.
          Chilean SMEs tend to have better-quality financial records, simplifying due diligence.
          However, the smaller population (roughly 19&nbsp;million) limits total deal flow.
        </p>
        <p>
          <strong>Peru</strong> is an earlier-stage market for ETA but presents compelling
          fundamentals: a growing middle class, increasing formalization, and a generation of
          owners who built enterprises during the commodity boom and now seek exits. The Sociedad
          An&oacute;nima Cerrada (S.A.C.) is the most common entity for closely held businesses.
        </p>

        <h3 className={h3Class}>Argentina</h3>
        <p>
          Argentina presents a paradox: one of the most educated workforces and entrepreneurial
        ...
        <p>
          The result is a widening gap between the number of businesses that need new ownership
        ...
        <p>
          The succession gap is particularly pronounced in secondary cities and regional
          economies, where fewer professional acquirers operate and where founders have even
          fewer options for a smooth transition. Searchers willing to relocate to cities like
          Medell&iacute;n, Guadalajara, Curitiba, or Valpara&iacute;so can access deal flow
          that is essentially invisible to investors based in major capitals. These regional
          markets often feature lower real estate costs, strong community ties that aid in
          employee retention, and businesses with deep local moats.
        </p>

        <h2 className={h2Class}>Business school connections and ETA communities</h2>
        <p>
          The growth of ETA in Latin America is closely tied to the influence of leading business
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Insper and FGV (Brazil):</strong> Brazil&rsquo;s top business schools are producing a new generation of aspiring acquirers, supported by a growing network of local search fund investors.</li>
          <li><strong>Regional communities:</strong> WhatsApp groups, annual conferences (such as the Latin American Search Fund Conference), and informal peer networks connect searchers across borders, enabling knowledge sharing and deal referrals.</li>
        </ul>
        ...
        <h3 className={h3Class}>Local investors and family offices</h3>
        <p>
          A growing number of Latin American family offices and high-net-worth individuals are
          investing in search funds. In Colombia, Mexico, and Chile, local investor groups have
          formed specifically to back first-time acquirers. These investors often bring invaluable
          local knowledge, regulatory expertise, and personal networks that can accelerate deal
          sourcing and post-acquisition value creation.
        </p>

        <h3 className={h3Class}>Bank debt and seller financing</h3>
        <p>
          Traditional bank acquisition financing is less readily available in most Latin American
          markets than in the US or Europe. Interest rates are generally higher, loan tenors
          shorter, and collateral requirements more stringent. However, development banks such as
          BNDES (Brazil), Nacional Financiera (Mexico), and CORFO (Chile) offer subsidized lending
          programs that can partially fill the gap.
        </p>
        <p>
          Seller financing is culturally more accepted in Latin America than in many other regions,
          as business owners often prefer a structured payout over time rather than a single lump
          sum. Earn-out structures, where a portion of the purchase price is tied to post-acquisition
          performance, are also common and help bridge valuation gaps.
        </p>

        <h3 className={h3Class}>Currency considerations in financing</h3>
        <p>
          Searchers raising capital in US dollars but acquiring businesses that generate revenue in
          local currencies must carefully manage foreign exchange exposure. Many Latin American
          search funds structure their deals with a mix of USD-denominated equity and local-currency
          debt to create a natural hedge. Investors should understand that reported returns in USD
          will be affected by currency movements over the holding period.
        </p>
        <p>
          Some searchers mitigate this risk by targeting businesses with natural dollar linkage,
          such as exporters, companies with USD-denominated contracts, or businesses in dollarized
          sectors like technology services. Others negotiate purchase price adjustments tied to
          exchange rate movements at closing, ensuring that currency shifts between signing and
          completion do not distort deal economics.
        </p>
        ...
        <ol className={olClass}>
          ...
          <li><strong>Mexico:</strong> The General Law of Commercial Companies (Ley General de Sociedades Mercantiles) governs corporate entities. The SAPI structure is preferred for acquisition vehicles. Mexico has a well-developed arbitration framework and is a signatory to the New York Convention.</li>
          <li><strong>Colombia:</strong> The S.A.S. (introduced in 2008) has become the dominant corporate form, offering maximum flexibility in governance, capital structure, and shareholder agreements. Foreign investment is freely permitted in most sectors.</li>
          <li><strong>Chile:</strong> The SpA (2007) is the preferred vehicle. Chile&rsquo;s legal system is widely regarded as the most transparent and predictable in the region, with strong enforcement of contracts and investor protections.</li>
          <li><strong>Peru:</strong> The S.A.C. is the standard closely held entity. Peru&rsquo;s legal framework is generally business-friendly, though bureaucratic processes can be slow. Foreign investors have the same rights as domestic investors under the 1993 Constitution.</li>
          <li><strong>Argentina:</strong> The Sociedad de Responsabilidad Limitada (S.R.L.) and Sociedad An&oacute;nima (S.A.) are the primary corporate forms. Capital controls (cepo cambiario) and restrictions on dividend repatriation are critical considerations for foreign investors.</li>
        </ol>

        <h2 className={h2Class}>Cultural considerations for searchers</h2>
        <p>
          Latin America&rsquo;s business culture places enormous weight on personal relationships,
          trust, and social capital. Searchers who approach the region with a purely transactional
          mindset will struggle to build the rapport necessary to close deals.
        </p>
        <ul className={ulClass}>
          <li><strong>Confianza (trust):</strong> Business owners will only sell to someone they trust personally. Expect multiple in-person meetings, meals, and social interactions before any formal discussions begin. The relationship often matters more than the financial terms.</li>
          <li><strong>Family dynamics:</strong> In family-owned businesses, the decision to sell involves not just the founder but often a spouse, children, and extended family members. Understanding and respecting these dynamics is essential.</li>
        ...
        <p>
          While Latin American ETA is still a young phenomenon compared to the US market, a growing
          number of success stories are demonstrating the model&rsquo;s viability in the region.
        </p>
        <ul className={ulClass}>
        ...
        <p>
          Latin America&rsquo;s attractive fundamentals come with meaningful risks that searchers
          and investors must carefully evaluate.
        </p>

        <h3 className={h3Class}>Currency risk</h3>
        <p>
          Latin American currencies can be highly volatile. The Brazilian real, Colombian peso,
          Mexican peso, and Argentine peso have all experienced significant devaluations over the
          past decade. For searchers who raise capital in USD and generate returns in local
          currency, adverse movements can erode returns even when the underlying business performs
          well. Hedging instruments exist but are expensive in most Latin American markets.
        </p>

        <h3 className={h3Class}>Political and regulatory instability</h3>
        <p>
        ...
        <h3 className={h3Class}>The informal economy</h3>
        <p>
          A significant portion of economic activity in Latin America occurs in the informal
          sector. Even formally incorporated SMEs may have a mix of documented and undocumented
          revenue, unreported cash transactions, and informal employment arrangements. This creates
          challenges for due diligence, valuation, and post-acquisition compliance. Searchers must
          budget extra time for forensic financial analysis and should be prepared to walk away from
          deals where the true economics cannot be verified.
        </p>

        <h3 className={h3Class}>Infrastructure and talent</h3>
        <p>
          Transportation infrastructure, internet connectivity, and supply chain reliability vary
          widely across and within Latin American countries. Businesses operating outside major
          metropolitan areas may face logistical challenges that constrain growth. Meanwhile,
          competition for top managerial talent in certain markets can be intense. Post-acquisition,
          searchers may need to invest significantly in management development and compensation
          structures to retain the talent necessary to execute their value-creation plans.
        </p>
        ...
        <h2 className={h2Class}>Comparing Latin America to other ETA markets</h2>
        <p>
        ...
        <h2 className={h2Class}>The road ahead</h2>
        <p>
