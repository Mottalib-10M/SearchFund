  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Logistics and transportation businesses, trucking companies, freight brokerages, last-mile delivery, and warehousing operations, form the backbone of the $1.3 trillion US logistics industry. For search fund entrepreneurs, the sector offers recession-resistant demand, high barriers to entry through fleet assets and carrier relationships, and a massively fragmented market where 97% of trucking companies operate fewer than 20 trucks.</p>
      </div>

      <h2 className={h2Class}>Types of Logistics Businesses</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Asset-based trucking:</strong> Own fleet of trucks. Higher capex, higher barriers to entry, and more defensible. Typical margins: 5-15% EBITDA.</li>
          <li><strong>Freight brokerage:</strong> Match shippers with carriers without owning trucks. Asset-light, scalable, 15-25% gross margins.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>E-commerce tailwind:</strong> Last-mile delivery and warehousing growing 15-20% annually</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Typical valuations: 4-7x EBITDA for asset-light; 3-5x for asset-heavy trucking companies</li>
        </ul>
      </div>
