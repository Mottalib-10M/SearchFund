  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          Search funds have generated exceptional returns &mdash;{" "}
        ...
        <ul className={ulClass}>
          <li><strong>Risk:</strong> ~25&ndash;30% of search funds fail to acquire a company within the 2-year search window</li>
          <li><strong>Impact:</strong> Total loss of search capital ($400K&ndash;$600K typically)</li>
        ...
        <ul className={ulClass}>
          <li><strong>Risk:</strong> The searcher acquires the wrong business &mdash; overvalued, declining, or fundamentally flawed</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Impact:</strong> Compressed returns even if operations go well. Overpaying by 1x multiple turn reduces IRR by 5&ndash;10 percentage points</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Impact:</strong>{" "}
            ...
            can destroy 20&ndash;40% of business value</li>
        ...
        <ul className={ulClass}>
          <li><strong>Risk:</strong> Search fund investments are locked for 7&ndash;10 years with no interim liquidity</li>
        ...
        <ul className={ulClass}>
          <li><strong>Risk:</strong> Step-up equity gives the operator 20&ndash;25% of the company for a relatively small personal investment. This can incentivize aggressive deal-making</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Breakeven zone:</strong> ~20% return 1&ndash;2x</li>
