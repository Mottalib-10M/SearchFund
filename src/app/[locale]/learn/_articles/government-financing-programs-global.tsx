    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Guarantee:</strong> 75-85% government guarantee to the lender</li>
          <li><strong>Equity required:</strong> 10-20% buyer injection (can include seller notes on standby)</li>
          <li><strong>Rates:</strong> Prime + 1.75-2.75% (variable)</li>
        ...
        <ul className={ulClass}>
          ...
          <li>,  <strong>Prêt Transmission:</strong> &euro;40K-&euro;1.5M subordinated loan, 5-7 years, 1-3% below market, no collateral</li>
          <li>,  <strong>Garantie Transmission:</strong> 50-70% guarantee on bank loans for acquisitions</li>
          <li>,  <strong>Prêt d&rsquo;honneur:</strong> Interest-free loan via partner networks (Réseau Entreprendre, Initiative France)</li>
          <li><strong>Equity required:</strong> 10-20% with Bpifrance support</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Key products:</strong></li>
          <li>,  <strong>ERP-Gründerkredit:</strong> Up to &euro;125K at 1-3% fixed for business successions</li>
          <li>,  <strong>ERP-Kapital für Gründung:</strong> Subordinated loan (quasi-equity), up to &euro;500K, 15-year term</li>
          <li>,  <strong>Bürgschaftsbanken:</strong> Regional guarantee banks providing 50-80% loan guarantees</li>
          <li><strong>Equity required:</strong> 15-25% with KfW support</li>
        ...
        <ul className={ulClass}>
          <li><strong>Program:</strong> British Business Bank, Recovery Loan Scheme (RLS) and Start Up Loans</li>
          <li><strong>Guarantee:</strong> 70% government guarantee on qualifying loans (up to &pound;2M under RLS)</li>
          <li><strong>Equity required:</strong> 20-30% (less generous than SBA or Bpifrance)</li>
        ...
        <ul className={ulClass}>
          <li><strong>Program:</strong> Business Development Bank of Canada (BDC), Business Transition Financing</li>
          <li><strong>Max amount:</strong> No stated cap (typically $1M-$10M CAD)</li>
          <li><strong>Products:</strong> Term loans, subordinated debt, and equity co-investment for acquisitions</li>
          <li><strong>Equity required:</strong> 15-25%</li>
        ...
        <ul className={ulClass}>
          <li><strong>Program:</strong> Instituto de Crédito Oficial (ICO), ICO Empresas y Emprendedores</li>
        ...
        <ul className={ulClass}>
          <li><strong>Program:</strong> Japan Finance Corporation (JFC), Small Business Succession Financing</li>
          <li><strong>Products:</strong> Low-interest loans (0.5-2%) for qualified business succession</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>2. France (Bpifrance):</strong> 10-15% equity with layered products. Best in Europe</li>
          <li><strong>3. Germany (KfW):</strong> 15-20% equity. Excellent subordinated capital</li>
          <li><strong>4. Canada (BDC):</strong> 15-25% equity. Flexible underwriting</li>
        </ul>

        <h3 className={h3Class}>Least generous (highest equity requirement)</h3>
        <ul className={ulClass}>
          <li><strong>UK:</strong> 20-30% equity. No dedicated acquisition program</li>
          <li><strong>Italy:</strong> 25-35% equity. Guarantee fund not acquisition-specific</li>
          <li><strong>Spain:</strong> 20-30% equity. ICO is general-purpose</li>
        </ul>
        ...
        <p>
          ...
          loans. As the global succession crisis intensifies, with an
          estimated 10+ million small business owners approaching retirement
          age across OECD countries, expect more governments to launch
        ...
        <p>
          ...
          as 10-15% buyer equity. Germany (<Link href="/learn/kfw-germany-business-succession" className="text-apple-accent hover:underline">KfW</Link>) is
