    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          carry 50-80% of the purchase price as a{" "}
          <Link href="/learn/seller-financing" className="text-apple-accent hover:underline">
            seller note
          </Link>:
        </p>
        <ul className={ulClass}>
          <li>Typical terms: 5-7 years, 4-7% interest</li>
        ...
        <ul className={ulClass}>
          <li>SBA loan: 75-80% of purchase price</li>
          <li>Seller note (on standby): 10-15%</li>
          <li>Your equity injection: 5-10%</li>
          <li>This structure can reduce your personal cash to as low as $25K-$75K for a $500K-$1M business</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Risk:</strong> Complex compliance, IRS scrutiny, and you&rsquo;re risking retirement savings. Requires a qualified ROBS provider ($5K-$10K setup)</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>Earn equity (5-20%) over 1-3 years based on performance</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Family and friends round:</strong> Raise $50K-$200K from 3-10 individuals at $5K-$50K each</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Typical HELOC: 80% of home equity, variable rate (Prime + 0-2%)</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Typical terms: repay 1.2-1.8x the borrowed amount over 12-36 months</li>
        ...
        <ul className={ulClass}>
          <li><strong>Accounts receivable financing:</strong> Borrow 80-90% against AR</li>
          <li><strong>Inventory financing:</strong> Borrow 50-70% against inventory value</li>
        ...
        <ul className={ulClass}>
          <li>Pay 70-80% at closing, with 20-30% contingent on future performance</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Bridge is repaid from cash flow or refinanced within 6-12 months</li>
          <li>Typically used when bank financing is delayed but the deal needs to close on schedule</li>
          <li>Terms: 8-12% annual interest, 6-12 month maturity</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Over-use:</strong> Creative structures can lead to excessive total debt burden. Always stress-test with a 20-30% revenue decline scenario</li>
        ...
        <p>
          ...
          (75-80% of the purchase price), a seller note on full standby
          (10-15%, which the SBA counts as equity), and ROBS (rolling over
        ...
        <p>
          ...
          withdrawal penalties or taxes. Setup costs $5K-$10K through a
        ...
        <p>
          ...
          financing typically requires 10-20% buyer equity. With creative
          structures like SBA + seller notes, you can reduce personal cash
          to 5-10%. Using ROBS, HELOCs, or earn-in arrangements, some
          buyers close deals with little or no personal savings at risk.
          Always stress-test your structure against a 20-30% revenue
