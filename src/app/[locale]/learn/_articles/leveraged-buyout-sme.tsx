  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Total debt / EBITDA:</strong> 3&ndash;4.5x for SMEs (vs. 5&ndash;7x for large PE deals), per Pepperdine Private Capital Markets data</li>
        ...
        <p>
          ...
          uses of funds at acquisition, (2) a 5&ndash;7 year income
        ...
        <p>
          Most search fund investors target a gross IRR of 25&ndash;35%
          on equity invested over a 5&ndash;7 year hold period. This
          translates to a 3&ndash;5x multiple on invested capital (MOIC).
        ...
        <p>
          ...
          0.5&ndash;2% of the loan amount), choose fixed-rate options
        ...
        <p>
          ...
          cash flow servicing debt &mdash; are identical.
        </p>
      </div>
    </article>
  );
