...
export default function HowToFindBusinessesForSaleArticle() {
  return (
    <article className="mx-auto max-w-3xl">
      <header className="mb-8">
        <h1 className={h1Class}>How to Find Businesses for Sale: The Complete Guide</h1>
        <p className="mt-4 text-sm text-gray-500">13 min read</p>
      </header>
      ...
      <div className={bodyClass}>
        ...
        <h2 className={h2Class}>Online Marketplaces: BizBuySell, Axial, DealStream, MicroAcquire</h2>
        ...
        <h2 className={h2Class}>Business Brokers: Building Your Network</h2>
        ...
        <p>
          Be aware of broker red flags: reluctance to provide detailed financials, inconsistent information across conversations, pressure to make offers without adequate due diligence, or resistance to letting you meet the owner directly. These suggest either a broker who prioritizes commissions over quality deals or fundamental issues with the business being sold. For more on this topic, see our guide on <Link href="/learn/working-with-brokers" className="text-apple-accent hover:underline">working with brokers</Link>.
        </p>
