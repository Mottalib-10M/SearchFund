    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Pre-MBA experience:</strong> 3-7 years of meaningful work experience. Consulting, banking, military, engineering, and operations backgrounds are common.</li>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          ...
          <li>Conduct 1-2 hour in-person or video meeting to assess leadership presence and communication skills</li>
          <li>Check 5-8 references: former managers, colleagues, professors, and any direct reports</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Search fund investing is primarily a bet on the operator, the searcher is more important than the eventual target company</li>
          ...
          <li>Reference checks (5-8 references) are the most valuable due diligence tool for evaluating searchers</li>
