...
export default function EuropeanBusinessBrokersDirectoryArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>The UK has the most mature and developed M&amp;A advisory market in Europe, with a wide range of intermediaries serving the small and medium enterprise (SME) segment. The market is bifurcated between business transfer agents (BTAs) handling smaller transactions (sub-$2M) and corporate finance boutiques and M&amp;A advisors handling mid-market deals ($2M-$50M+).</p>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Corporate finance advisors:</strong> For mid-market transactions, firms like Clearwater International, Lincoln International, Oakley Advisory, and KPMG Small Cap serve as sell-side advisors running competitive auction processes. These firms typically handle deals with enterprise values of &pound;5M-&pound;100M+.</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Cabinets de cession-transmission:</strong> These are specialized M&amp;A advisory firms that handle the sale of SMEs, typically businesses with enterprise values of &euro;1M-&euro;50M. Leading firms include In Extenso Finance, Interfinance, and Clearwater International (France). These advisors typically work on a retainer plus success fee basis.</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>UK:</strong> Sell-side advisors typically charge a retainer (&pound;2,000-&pound;10,000/month) plus a success fee of 3-8% of the transaction value, with the percentage declining as the deal size increases (Lehman or double Lehman formula). Buy-side advisory mandates for search funds are less common but typically involve a monthly retainer plus a smaller success fee.</li>
          <li><strong>France:</strong> Success fees of 3-6% are standard for mid-market transactions. Some advisors work on a pure success-fee basis for smaller deals. The French government&apos;s support for business transfers means some advisory services are subsidized or provided at reduced cost through the CCIs and BPI France.</li>
          <li><strong>Germany:</strong> German M&amp;A advisors for Mittelstand transactions typically charge a minimum fee of &euro;50,000-&euro;150,000 or a percentage of the transaction value (3-6%). The Nachfolgebörsen (succession exchanges) are free to use, though they may charge nominal listing fees.</li>
          <li><strong>Nordics:</strong> Fee structures are similar to the UK, with success fees of 3-7% being standard. Nordic advisors tend to be transparent about fees, reflecting the region&apos;s business culture.</li>
          <li><strong>Southern Europe:</strong> In Spain, Italy, and Portugal, fees tend to be slightly lower than Northern European equivalents, with success fees of 2-5% being common for mid-market transactions. However, the total cost of a transaction may be higher due to longer timelines and additional advisory services required (notarial, tax, regulatory).</li>
        </ul>
      </div>
      ...
      <ul className={ulClass}>
        ...
        <li>Transeo, European Association for SME Transfer, <em>Annual Report on Business Transfers in Europe</em> (2024)</li>
