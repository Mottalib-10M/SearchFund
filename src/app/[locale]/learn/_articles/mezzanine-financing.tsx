    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          sitting between senior debt and equity. For acquisition entrepreneurs who need more use than banks will provide but want to minimize equity dilution, mezzanine debt can be the missing piece that makes a deal work.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <p>According to the{" "}
          <a href="https://digitalcommons.pepperdine.edu/gsbm_pcm_pcmr/" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">Pepperdine Private Capital Markets Report (2024)</a>, mezzanine debt accounts for approximately 10-15% of the capital structure in middle-market acquisitions, with total deployment exceeding $30 billion annually in the US alone.
        </p>
        <p>In a typical acquisition capital stack:</p>
        <ol className={olClass}>
          <li><strong>Senior secured debt (50-65%):</strong> Bank loans, SBA, lowest cost, first in line</li>
          <li><strong>Mezzanine debt (10-20%):</strong> Subordinated, higher cost, may include equity kickers</li>
          <li><strong>Equity (20-35%):</strong> Investor and searcher capital, highest risk, highest return</li>
        </ol>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Cash interest:</strong> 8-14% per annum, paid current</li>
          <li><strong>PIK interest:</strong> 2-6% additional interest that accrues and compounds</li>
          <li><strong>Total coupon:</strong> 12-20% all-in, combining cash and PIK</li>
        </ul>
        <p>For comparison, senior bank debt typically runs 7-10%, while equity investors target 25-35%+ IRR.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Term:</strong> 5-7 years, typically 1-2 years longer than senior debt</li>
          <li><strong>Amortization:</strong> Usually interest-only with bullet repayment at maturity</li>
          <li><strong>Prepayment:</strong> Callable after 2-3 years with declining premiums (3%, 2%, 1%)</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Bridging the gap:</strong> Senior lender funds 60% but you want only 25% equity, mezz covers the 15%</li>
          <li><strong>Minimizing dilution:</strong> At 15% coupon, mezz is expensive but cheaper than equity at 30%+ IRR</li>
          <li><strong>Higher use acquisitions:</strong> Businesses with strong, predictable cash flows supporting 4-5x total use</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Mezz vs. senior debt:</strong> More expensive (12-20% vs 7-10%), but provides additional use with fewer covenants</li>
          <li><strong>Mezz vs. equity:</strong> Cheaper (15% vs 25-35% IRR), less dilutive, but requires cash payments and has fixed maturity</li>
          <li><strong>Mezz vs. seller financing:</strong> Seller notes are cheaper (4-8%) and more flexible. Always maximize seller financing first</li>
          <li><strong>Mezz vs. SBA:</strong> SBA 7(a) loans typically don&apos;t allow subordinated debt without approval, usually incompatible</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Standstill period:</strong> Mezz lender waits 90-180 days before exercising remedies</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>SBICs:</strong> SBA-licensed funds investing in small businesses, can invest as little as $500K. According to the{" "}
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>Senior bank debt: $5.5M (55%), 5-year, 8%, amortizing</li>
          <li>Seller note: $1.5M (15%), 5-year, 6%, subordinated</li>
          <li>Mezzanine: $1.0M (10%), 6-year, 14% (10% cash + 4% PIK), 2% warrants</li>
          <li>Equity: $2.0M (20%), search fund investor capital</li>
        </ul>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>Deal sizes ($5-15M) are at the low end of most mezz fund minimums</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Mezzanine fills the gap between senior debt and equity at 12-20% total cost</li>
          ...
          <li>Subordination agreements are critical, get experienced M&A counsel</li>
        </ul>
      </div>
      ...
      <ul className={ulClass}>
        ...
        <li>Preqin, <em>Private Debt Quarterly Update, Mezzanine Segment</em> (Q4 2024)</li>
      </ul>
    </article>
  );
}
