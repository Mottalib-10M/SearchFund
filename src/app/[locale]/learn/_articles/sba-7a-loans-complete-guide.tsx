    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          acquirers, understanding the SBA 7(a) program is not optional , 
          it is foundational.
        </p>
        <p>
        ...
        <p>
          ...
          guarantees 75-85% of the loan amount to the lender, reducing
          ...
          lend money directly, loans are made by SBA-approved lenders
        ...
        <p>
          ...
          relatively low equity injection (typically 10-20% of the total
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Interest rate:</strong> Variable, typically Prime + 2.25% to Prime + 2.75% (currently ~10-11% as of 2025)</li>
          <li><strong>SBA guarantee:</strong> 85% for loans up to $150K; 75% for loans above $150K</li>
          <li><strong>SBA guarantee fee:</strong> 0-3.75% of the guaranteed portion (varies by loan size)</li>
          <li><strong>Down payment / equity injection:</strong> Minimum 10% of total project cost (many lenders require 15-20%)</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Adequate equity injection (10-20% of total project cost)</li>
        ...
        <h3 className={h3Class}>Step 1: Pre-qualification (2-4 weeks)</h3>
        <p>
        ...
        <h3 className={h3Class}>Step 2: LOI and due diligence (60-90 days)</h3>
        <p>
        ...
        <h3 className={h3Class}>Step 3: Underwriting (3-6 weeks)</h3>
        <p>
        ...
        <h3 className={h3Class}>Step 4: Commitment and closing (2-4 weeks)</h3>
        <p>
        ...
        <ul className={ulClass}>
          <li><strong>SBA 7(a) loan:</strong> 60-75% of total project cost</li>
          <li><strong>Seller financing:</strong> 10-20% (most SBA lenders allow seller notes on standby for 24 months)</li>
          <li><strong>Buyer equity injection:</strong> 10-20% (cash, retirement funds via ROBS, or investor capital)</li>
        </ul>
        <p>
        ...
        <ul className={ulClass}>
          <li><strong>SBA Preferred Lenders (PLP):</strong> These lenders have delegated authority to approve SBA loans without sending them to the SBA for review, saving 2-4 weeks. Always prefer PLP lenders for acquisitions.</li>
        ...
        <p>
          ...
          Some lenders cap goodwill at 50-60% of the loan amount, which
        ...
        <ul className={ulClass}>
          <li><strong>SBA 7(a) vs. conventional bank loans:</strong> SBA loans offer longer terms (10 years vs. 5-7), lower equity requirements, and broader eligibility. Conventional loans may have lower rates but stricter qualification criteria.</li>
        ...
        <ul className={ulClass}>
          <li>Start the lender relationship early, pre-qualify before submitting LOIs</li>
          ...
          <li>Budget 10-15% of the loan amount for closing costs (guarantee fees, legal, appraisals)</li>
          <li>Negotiate{" "}
            <Link href="/learn/seller-financing" className="text-apple-accent hover:underline">
              seller financing
            </Link>{" "}
            into every deal, it reduces your equity need and improves lender confidence</li>
