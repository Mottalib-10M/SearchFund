  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          Recurring revenue separates the businesses that sell for 4-5x EBITDA from
          the ones that sell for 8-12x. For search fund entrepreneurs using{" "}
          ...
          retention, and both differ from a gym with month-to-month memberships
        ...
        <ol className={olClass}>
          <li>
            <strong>Contractual recurring revenue</strong>: Customers sign
          ...
          <li>
            <strong>Subscription recurring revenue</strong>: Customers pay on a
          ...
          <li>
            <strong>Habitual recurring revenue</strong>: No contract or formal
        ...
        <p>
          ...
          EBITDA multiples. According to industry research, businesses crossing the 60-70% recurring revenue threshold start
        ...
        <ul className={ulClass}>
          <li>
            <strong>Contractual SaaS (80%+ recurring):</strong> 4.8-7x ARR for
            bootstrapped companies, per SaaS Capital&rsquo;s 2025 benchmarking report. At
            the EBITDA level, profitable vertical SaaS trades at 10-20x.
          </li>
          <li>
            <strong>Managed IT services / MSPs (80%+ MRR):</strong> 6-8x EBITDA for
            firms with $1-5M EBITDA, according to{" "}
            <a
            ...
            </a>. MSPs below 50% MRR drop to 4-5x.
          </li>
          <li>
            <strong>Insurance agencies (85-95% renewal):</strong> 11.8x EBITDA on
            ...
            >
              Sica | Fletcher
            </a>, the highest multiple among service businesses, driven by
            contractual renewal streams.
          </li>
          <li>
            <strong>Pest control / lawn care (70-85% contract):</strong> 3.5-6x
          ...
          <li>
            <strong>Project-based services (&lt;30% recurring):</strong> 3-4x EBITDA.
        ...
        <ul className={ulClass}>
          <li>
            <strong>Typical retention:</strong> 90-95% gross revenue retention.
            Switching IT providers is painful for SMBs, creating natural lock-in.
          </li>
          <li>
            <strong>Valuation range:</strong> 6-8x EBITDA at $1-5M EBITDA; MSPs
          ...
          <li>
            <strong>ETA fit:</strong> Highly fragmented, thousands of sub-$5M revenue
        ...
        <p>
          ...
          build software for a single industry, property management platforms,
          dental practice management, construction estimating tools. They combine
          recurring revenue with deep competitive moats.
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Typical NRR:</strong> 105-120% for well-run vertical SaaS. The
            median NRR for bootstrapped SaaS companies with $3-20M ARR is 104%, with
          ...
          <li>
            ...
            vertical SaaS often start at $3-10M, which can stretch SBA financing
            limits. The technical due diligence requirements are also higher, you
        ...
        <p>
          ...
          recur annually with 85-95% retention rates. The revenue is nearly
          contractual, policyholders rarely switch agents unprompted.
        </p>
        <ul className={ulClass}>
          <li>
        ...
        <p>
          ...
          quarterly treatment contracts make up 70-85% of revenue for well-run
          operators.
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Typical retention:</strong> 90%+ annual contract renewal rates.
            Industry average monthly attrition is 2-3%; below 2% is considered
            excellent and commands premium multiples.
          </li>
          <li>
            <strong>Valuation range:</strong> 3.5-6x SDE. M&amp;A volume increased
        ...
        <p>
          ...
          earn monthly fees (typically 8-12% of collected rent) on long-term
          management agreements. The model is asset-light with predictable cash flows
          tied to the size of the managed portfolio.
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Revenue quality:</strong> Management agreements typically run 1-3
          ...
          <li>
            ...
            (15-25% EBITDA) than software or insurance, and revenue is directly tied
        ...
        <p>
          ...
          The average tenant stays 14-15 months, and occupancy rates for
          stabilized facilities run 88-92%.
        </p>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            ...
            depends heavily on local supply dynamics, and overbuilding in 2022-2024
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            determines margins. A route with 30 stops per mile generates 2-3x the
        ...
        <p>
          ...
          bootstrapped SaaS companies with $3-20M ARR is 104%, with
          top-quartile companies reaching 118%. For non-software businesses, target at
          least 95% NRR, anything below 90% means the business is a leaky bucket.
        </p>
        ...
        <p>
          ...
          attrition is 2-3% (Capstone Partners, 2025). For SaaS, best-in-class
          ...
          0.4% monthly churn, which is exceptional and should be verified against
        ...
        <p>
          ...
          the business may be under-investing in growth, which is actually a{" "}
        ...
        <ul className={ulClass}>
          <li>
            ...
            represent more than 5-10% of recurring revenue (Acquira, 2024 MRR
            analysis).
          </li>
          <li>
          ...
          <li>
            ...
            discounts (30-40% off monthly pricing) can pull forward revenue and
        ...
        <ol className={olClass}>
          <li>
            ...
            control, and property management where total deal size is $1-5M. SaaS
          ...
          <li>
            ...
            3.5x SDE, growing it to $2M+ EBITDA through tuck-ins, and exiting at 6-8x
            to a PE platform is a well-documented playbook, M&amp;A volume in pest
        ...
        <p>
          ...
          revenue and $1.2M EBITDA, even though the latter earns more. The lender&rsquo;s
        ...
        <p>
          ...
          The premium multiple only kicks in above the 60-70% threshold, according
          ...
          a value-creation opportunity, but price it as a project-based business today.
        </p>
        ...
        <p>
          ...
          trend quarter over quarter, stable or improving retention validates the
        ...
        <p>
          ...
          superior recurring revenue quality but trade at 11-12x EBITDA, making
        ...
        <p>
          ...
          HVAC companies, for example, typically generate only 20-30% recurring
          revenue from maintenance agreements at acquisition. Operators who implement
          structured{" "}
          <Link href="/learn/pricing-optimization" className="text-apple-accent hover:underline">
            pricing and packaging strategies
          </Link>, converting one-time repair customers into monthly maintenance plan
          subscribers, can push recurring revenue above 50% within 18-24 months.
        ...
        <p>
          ...
          price increases or service expansion, which is achievable in MSPs
          ...
          $3-20M ARR is 104%, with top performers at 118% (SaaS Capital, 2025).
        </p>
      </div>
    </article>
  );
