    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Indirect lending:</strong> KfW doesn&rsquo;t lend directly, it provides subsidized loans through commercial banks (Hausbanken) at below-market rates</li>
          <li><strong>Risk-sharing:</strong> KfW assumes 50-80% of the credit risk, making banks far more willing to lend to first-time acquirers</li>
        </ul>

        <h2 className={h2Class}>Key KfW programs for acquirers</h2>

        <h3 className={h3Class}>1. ERP-Gr&uuml;nderkredit - Startgeld</h3>
        <ul className={ulClass}>
          <li><strong>Amount:</strong> Up to &euro;125,000</li>
          <li><strong>Term:</strong> 5-10 years, with 1-2 year grace period</li>
          <li><strong>Rate:</strong> Fixed, below market (currently 4-6%)</li>
        ...
        <h3 className={h3Class}>2. ERP-Gr&uuml;nderkredit - Universell</h3>
        <ul className={ulClass}>
          <li><strong>Amount:</strong> Up to &euro;25 million</li>
          <li><strong>Term:</strong> Up to 20 years (5-10 years typical for acquisitions)</li>
          ...
          <li><strong>Best for:</strong> Larger Mittelstand acquisitions (&euro;1M-&euro;10M+)</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Function:</strong> Subordinated loan, acts as quasi-equity, improving your debt/equity ratio</li>
        ...
        <ul className={ulClass}>
          <li><strong>Senior bank debt (KfW-subsidized):</strong> 50-65% of purchase price</li>
          <li><strong>KfW ERP-Kapital (subordinated):</strong> 10-20%</li>
          <li><strong>Buyer equity:</strong> 15-25%</li>
          <li><strong>Seller financing (Verk&auml;uferdarlehen):</strong> 0-15% (less common in Germany but growing)</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>Total: &euro;2,000,000, KfW provides 75% of the financing</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Step 2:</strong> Apply through your Hausbank, KfW does not accept direct applications</li>
          <li><strong>Step 3:</strong> The Hausbank assesses the deal and submits the KfW application</li>
          <li><strong>Step 4:</strong> KfW approves within 2-4 weeks (routine) or 4-8 weeks (complex)</li>
        ...
        <ul className={ulClass}>
          <li><strong>B&uuml;rgschaftsbanken:</strong> Regional guarantee banks that provide 60-80% guarantees on bank loans (similar to Bpifrance guarantees)</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Share deal advantage:</strong> No real estate transfer tax on share acquisitions &lt;90% (Grunderwerbsteuer saving of 3.5-6.5%)</li>
        ...
        <p>
          ...
          including a 3-5 year financial projection, a description
        ...
        <p>
          Both programs serve similar functions, making acquisition
