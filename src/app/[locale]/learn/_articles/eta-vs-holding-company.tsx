  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          The holding company career has no finish line. Operators like Mark Leonard (who founded Constellation Software in 1995 and still leads it nearly 30 years later) or Brent Beshore (who founded Permanent Equity in 2007) commit to decades of capital allocation. The early years are lean &mdash; the first few acquisitions require intense personal involvement before the operator can step back into a pure capital allocator role. Wilkinson has described the first five years of building Tiny as the hardest of his career. But the compounding effects of a mature portfolio eventually create use: each new acquisition adds incremental cash flow that funds the next deal, and the operator&rsquo;s time shifts from deal execution to strategic portfolio oversight.
        </p>
        <p>
