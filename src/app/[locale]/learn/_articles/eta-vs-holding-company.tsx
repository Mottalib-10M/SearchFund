  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          Two models dominate entrepreneurship through acquisition: the single-asset search fund and the multi-asset holding company. The search fund concentrates all capital and operator energy into one business acquired over a 2-year search, operated for 5&ndash;7 years, then exited. The holding company deploys capital across a growing portfolio of businesses held indefinitely. According to the{" "}
          <Link href="/learn/search-fund-returns" className="text-apple-accent hover:underline">2024 Stanford Search Fund Study</Link>, traditional search funds have produced a 35.1% aggregate pre-tax IRR across 681 funds since 1984. Holding company operators like Mark Leonard at Constellation Software have compounded intrinsic value at 25&ndash;35% annually over roughly the same period. Both paths can build generational wealth &mdash; but they demand fundamentally different skills, capital structures, and temperaments. This guide breaks down exactly how they differ so you can choose the right vehicle for your ambitions.
        </p>

        <h2 className={h2Class}>1. How Each Model Works: Structure and Mechanics</h2>
        <p>
          A traditional search fund follows a linear path codified since H. Irving Grousbeck introduced the model at Stanford GSB in 1984. The searcher raises $400K&ndash;$600K from 10&ndash;20 investors, spends 18&ndash;24 months sourcing deals, acquires a single company in the $5M&ndash;$30M enterprise value range, and operates as CEO for 5&ndash;7 years before exiting via strategic sale or recapitalization. The{" "}
          <Link href="/learn/search-fund-history" className="text-apple-accent hover:underline">history of search funds</Link>{" "}
          shows this structure has remained remarkably stable for four decades, with 94 new core funds launched in 2023 alone &mdash; a record, per Stanford&rsquo;s data.
        </p>
        <p>
          The holding company model is structurally open-ended. The operator raises a larger initial pool of capital &mdash; often $10M or more &mdash; and acquires multiple businesses over time, installing professional managers in each while retaining the capital allocator role at the parent level. There is no planned exit. Returns come from ongoing cash flow distributions and the compounding value of the portfolio. Brent Beshore&rsquo;s Permanent Equity, which now owns 16 portfolio companies generating over $350M in combined annual revenue, exemplifies this approach: the firm invests out of approximately 30-year fund vehicles with no intention of selling, according to Permanent Equity&rsquo;s public disclosures.
        </p>
        <p>
        ...
        <p>
          Search fund capital structure is deliberately simple. Search-phase investors contribute $35,000&ndash;$50,000 per unit, which converts into acquisition equity at a standard 1.5x step-up. The searcher then raises acquisition capital &mdash; typically a combination of investor equity, bank debt (often SBA-backed in the US), and seller financing &mdash; to purchase one company. Total equity raised for the acquisition usually falls between $3M and $15M, depending on the target&rsquo;s size. See our{" "}
        ...
        <p>
          Holding companies use a layered capital strategy. The initial fund anchors the first two or three acquisitions. From that point, operating cash flow from portfolio companies funds subsequent deals, reducing dependence on outside capital over time. Constellation Software perfected this model: Mark Leonard runs a 14-person head office and acquires small vertical market software companies at an average price of $2M&ndash;$4M, funded almost entirely from internal cash flow. By reinvesting rather than distributing, Constellation grew from its 2006 IPO price to a market capitalization exceeding $80 billion by 2024, producing a roughly 190x return for IPO investors, per the company&rsquo;s public filings.
        </p>
        <p>
        ...
        <p>
          Holding company investors have different expectations. Because the vehicle is designed for perpetual ownership, investors accept lower annual cash returns in exchange for compounding and reduced exit risk. Permanent Equity targets a minimum 15% gross annual return (cash-on-cash), below which the economics don&rsquo;t work for the firm, and underwrites deals to a 30%+ IRR. Constellation Software investors have seen 25&ndash;35% annual compounding, but that return is embedded in share price appreciation rather than cash distributions &mdash; Constellation suspended its dividend in 2019 to reinvest all capital into acquisitions.
        </p>
        <p>
        ...
        <p>
          The single-asset nature of search funds creates binary risk. If the acquired business fails &mdash; through market disruption, operator error, or bad luck &mdash; the entire investment is lost. Stanford&rsquo;s data shows that roughly 33% of search fund acquisitions result in a partial or total loss. The searcher bears this risk personally: their equity, their reputation, and 5&ndash;7 years of their career are concentrated in one outcome.
        </p>
        <p>
          Holding companies diversify risk by construction. A portfolio of 10&ndash;15 businesses across different industries and geographies can absorb individual failures without catastrophic portfolio loss. Constellation Software has completed over 900 acquisitions since its founding &mdash; some inevitably underperformed, but the portfolio&rsquo;s diversification ensured that no single failure threatened the parent entity. Tiny, despite its stock declining 48% since going public in 2023, continued growing EBITDA from $27.4M to $31.0M in fiscal year 2024 because portfolio diversification smoothed the impact of underperforming units.
        </p>
        <p>
        ...
        <p>
          A search fund career follows a defined arc: raise (3&ndash;6 months), search (18&ndash;24 months), operate (5&ndash;7 years), exit. From start to finish, the cycle spans 8&ndash;10 years. After exiting, many searchers transition to investing, board roles, or a second search. The model works well for operators in their late 20s to mid-30s who want a decade-long entrepreneurial sprint with a clear finish line. The Stanford study&rsquo;s 2024 data shows that 57% of searchers over the past decade successfully acquired a business, meaning the funnel from formation to operating CEO takes roughly 2 years for those who succeed.
        </p>
        <p>
          The holding company career has no finish line. Operators like Mark Leonard (who founded Constellation Software in 1995 and still leads it nearly 30 years later) or Brent Beshore (who founded Permanent Equity in 2007) commit to decades of capital allocation. The early years are lean &mdash; the first few acquisitions require intense personal involvement before the operator can step back into a pure capital allocator role. Wilkinson has described the first five years of building Tiny as the hardest of his career. But the compounding effects of a mature portfolio eventually create leverage: each new acquisition adds incremental cash flow that funds the next deal, and the operator&rsquo;s time shifts from deal execution to strategic portfolio oversight.
        </p>
        <p>
        ...
        <ol className={olClass}>
          ...
          <li>
            <strong>Capital access.</strong> Traditional search funds require $400K&ndash;$600K in initial capital from institutional investors. Holding companies typically need $10M+ to build a meaningful first portfolio. A{" "}
          ...
          <li>
            <strong>Industry thesis.</strong> Search funds are sector-agnostic by default &mdash; the searcher looks for{" "}
        ...
        <div className="overflow-x-auto mt-4">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="text-apple-gray-700">
              <tr className="border-b border-apple-gray-100"><td className="py-2 pr-4">Number of assets</td><td className="py-2 pr-4">1</td><td className="py-2">10&ndash;100+</td></tr>
              <tr className="border-b border-apple-gray-100"><td className="py-2 pr-4">Operator equity</td><td className="py-2 pr-4">20&ndash;25%</td><td className="py-2">30&ndash;100% of parent</td></tr>
              ...
              <tr className="border-b border-apple-gray-100"><td className="py-2 pr-4">Aggregate IRR</td><td className="py-2 pr-4">35.1% (Stanford 2024)</td><td className="py-2">25&ndash;35% (CSI benchmark)</td></tr>
              <tr className="border-b border-apple-gray-100"><td className="py-2 pr-4">Typical timeline</td><td className="py-2 pr-4">8&ndash;10 years</td><td className="py-2">20&ndash;30+ years</td></tr>
              <tr className="border-b border-apple-gray-100"><td className="py-2 pr-4">Initial capital needed</td><td className="py-2 pr-4">$400K&ndash;$600K search</td><td className="py-2">$10M+ first fund</td></tr>
        ...
        <p>
          Yes, and this is one of the most common career paths in entrepreneurship through acquisition. The search fund cycle gives you deal-sourcing experience, operating credibility, and investor relationships over 8&ndash;10 years. After a successful exit, you can raise a holding company vehicle with a proven track record. Many{" "}
        ...
        <p>
          Significantly. Search funds typically use substantial acquisition debt (SBA loans, bank term loans, seller financing) to leverage the single-asset purchase, with total debt-to-equity ratios of 2:1 or higher being common. Holding companies vary widely: Constellation Software avoids significant corporate-level debt and funds acquisitions from cash flow, while Tiny carried $94.1M in net debt at the end of fiscal 2024. Permanent Equity deliberately avoids debt entirely, viewing leverage as an unacceptable risk for a perpetual vehicle. The choice depends on the operator&rsquo;s risk philosophy and the holding company&rsquo;s cash flow profile.
        </p>
        ...
        <p>
          Partially. The independent sponsor model shares the search fund&rsquo;s deal-by-deal capital raising and the holding company&rsquo;s ambition for multiple acquisitions. But independent sponsors typically plan to exit each deal individually rather than hold indefinitely, making the model closer to serial search funds than to true holding companies. The compensation structure (15&ndash;25% carried interest above a hurdle rate) also mirrors private equity more closely than either search funds or holding companies.
        </p>
      </div>
    </article>
  );
