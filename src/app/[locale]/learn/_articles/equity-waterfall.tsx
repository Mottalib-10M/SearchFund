    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li><strong>Preferred return:</strong> Investors receive 8-10% annual preferred return on invested capital</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Search capital:</strong> $400K-$600K raised from 10-20 investors to fund the 18-24 month search</li>
          <li><strong>Acquisition capital:</strong> $2M-$10M+ raised (often from the same investors) to fund the equity portion of the acquisition</li>
          <li><strong>The 1.5x step-up:</strong> Each dollar of search capital converts into 1.5x its value in acquisition equity, rewarding early investors for the additional risk</li>
        </ul>
        <p>
      ...
      <h2 className={h2Class}>Searcher Equity: The 20-30% Carry</h2>
      <div className={bodyClass}>
        <p>The searcher typically earns 20-30% of the total equity, vesting over time:</p>
        <ul className={ulClass}>
          <li><strong>First tranche (1/3):</strong> Vests at closing of the acquisition</li>
          <li><strong>Second tranche (1/3):</strong> Vests over 3-4 years on a monthly or annual basis</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>Acquisition equity: $3.5M (from investors), total investor equity: $4.25M ($750K + $3.5M)</li>
        ...
        <p>In this scenario, investors achieve approximately 3.5x return ($14.8M on $4.25M) and the searcher receives approximately $2.2M, a strong outcome for both sides.</p>
      </div>

      <h2 className={h2Class}>Preferred Return Mechanics</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Rate:</strong> 8-10% annual preferred return is standard in search funds</li>
          <li><strong>Compounding:</strong> Usually compounds annually (not simple interest)</li>
          <li><strong>Cumulative vs. non-cumulative:</strong> Almost always cumulative, unpaid preferred return accrues</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Traditional search fund:</strong> Standard waterfall as described above. 20-25% searcher equity with 1.5x step-up. This is the dominant model tracked by both the Stanford and IESE studies.</li>
          <li><strong><Link href="/learn/self-funded-vs-traditional" className="text-apple-accent hover:underline">Self-funded search</Link>:</strong> No search capital stage, so no step-up. Searcher typically takes larger equity stake (30-50%) since they bear the search cost personally.</li>
          ...
          <li><strong><Link href="/learn/search-fund-vs-independent-sponsor" className="text-apple-accent hover:underline">Independent sponsor</Link>:</strong> Deal-by-deal fundraising. Promoted interest (carried interest) of 15-25% with no search capital stage.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>For searchers:</strong> Focus on the performance vesting threshold, ensure it&apos;s achievable. Negotiate for full catch-up rather than partial.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Searcher equity (20-30%) vests in three tranches: closing, time, and performance</li>
