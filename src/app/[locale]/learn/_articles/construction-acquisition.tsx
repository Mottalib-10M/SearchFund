  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>The US construction industry generates over $2 trillion annually, with tens of thousands of small and mid-size general contractors, specialty contractors, and construction services firms. For search fund entrepreneurs, construction companies offer attractive cash flow, high barriers to entry through licensing and bonding, and a fragmented market where succession planning is a critical unmet need, many owners are aging baby boomers without exit plans.</p>
      </div>

      <h2 className={h2Class}>Types of Construction Businesses</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>General contractors (GC):</strong> Manage overall projects, subcontract specialty work. Revenue driven by project volume. Margins: 3-8% net.</li>
          <li><strong>Specialty contractors:</strong> <Link href="/learn/acquiring-electrical-contractor" className="text-apple-accent hover:underline">Electrical</Link>, <Link href="/learn/plumbing-acquisition" className="text-apple-accent hover:underline">plumbing</Link>, <Link href="/learn/acquiring-hvac-business" className="text-apple-accent hover:underline">HVAC</Link>, concrete, steel. Higher margins (8-15%) and recurring service revenue.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Backlog visibility:</strong> Contracted backlogs provide revenue visibility 6-24 months out</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>The biggest risk is project concentration and litigation, diversified backlogs across project types are essential</li>
          <li>Typical valuations: 3-6x EBITDA for specialty; 2-4x for general contractors (higher risk)</li>
        </ul>
      </div>
