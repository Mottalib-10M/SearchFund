...
export default function WasteManagementAcquisitionArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Trash collection is mandatory &mdash; businesses and residents must dispose of waste regardless of economic conditions. During the 2008&ndash;2009 recession, waste industry revenue declined less than 3% while most other sectors experienced double-digit drops. Over 90% of revenue is subscription or contract-based with monthly billing and CPI-linked price escalators, providing built-in inflation protection. Municipal contracts, which often run 5&ndash;10 years, provide especially stable long-term revenue visibility.</p>
      </div>

      <h3 className={h3Class}>What is route density and why does it matter?</h3>
      <div className={bodyClass}>
        <p>Route density refers to the number of customers served per mile driven on a collection route. Higher route density means more revenue generated per truck-hour, which directly improves margins. A well-optimized urban route might serve 500&ndash;800 residential customers per day, while a rural route might serve only 150&ndash;300. Adding new customers on existing routes has near-zero marginal cost (the truck is already driving past), making tuck-in acquisitions of neighboring haulers the single most effective growth lever. The entire waste industry consolidation thesis is built on improving route density through geographic clustering.</p>
      </div>

      <h3 className={h3Class}>How much does a refuse truck cost and how does fleet capex work?</h3>
      <div className={bodyClass}>
        <p>New refuse trucks cost $300,000&ndash;$400,000 each, making fleet replacement the single largest capital expenditure for waste businesses. Most trucks have a useful life of 8&ndash;12 years depending on maintenance and operating conditions. During <Link href="/learn/due-diligence-checklist" className="text-apple-accent hover:underline">due diligence</Link>, carefully assess the average fleet age, maintenance records, and upcoming replacement needs. A business with an aging fleet may require $500K&ndash;$1M+ in near-term capex, which should be factored into your valuation and financing model. Many operators finance trucks with equipment leases to spread the cost over the truck&apos;s useful life.</p>
      </div>
    </article>
  );
}
