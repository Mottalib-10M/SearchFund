  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Bank debt is typically the largest component of your <Link href="/learn/capital-stack-explained" className="text-apple-accent hover:underline">capital stack</Link>, often representing 50-65% of the total acquisition price. According to the{" "}
          <a href="https://digitalcommons.pepperdine.edu/gsbm_pcm_pcmr/" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">Pepperdine Private Capital Markets Report (2024)</a>, senior debt terms in the lower middle market have tightened since 2022, with median spreads widening by 50-75 basis points. The terms you negotiate, interest rate, amortization, covenants, prepayment, and collateral, directly impact your cash flow, operational flexibility, and personal risk for years after closing.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Typical spreads:</strong> SOFR + 2.5-4.5% for conventional; SBA rates are capped at SOFR + 2.75% for loans over $50K</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Interest-only period:</strong> Negotiate 6-12 months of interest-only payments to preserve cash during transition</li>
          <li><strong>Seasonal adjustments:</strong> If the business is seasonal, negotiate lower payments during off-peak months</li>
          <li><strong>Balloon payments:</strong> Avoid balloon structures when possible, they create refinancing risk</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Debt Service Coverage Ratio (DSCR):</strong> Typically 1.20-1.50x. EBITDA (or cash flow) divided by total debt payments. The most important covenant.</li>
          <li><strong>Leverage ratio:</strong> Total debt / EBITDA, typically capped at 3.0-4.5x</li>
          <li><strong>Fixed charge coverage:</strong> Similar to DSCR but includes all fixed obligations (rent, insurance, etc.)</li>
          <li><strong>Minimum EBITDA:</strong> Absolute floor for earnings, negotiate this as low as reasonable</li>
        </ul>
        <p>Negotiate: covenant-lite structures, cure periods (30 days to remedy), equity cure rights (ability to inject cash to fix a breach), and holiday periods (first 6-12 months covenant-free while you stabilize).</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Mandatory prepayment:</strong> Some lenders require excess cash flow sweeps (50-75% of excess cash). Negotiate these down or out.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Blanket lien:</strong> Standard, lender gets security interest in all business assets</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Non-bank lenders:</strong> Alternative lenders, BDCs, faster but typically more expensive. For subordinated capital layers, see our <Link href="/learn/mezzanine-financing" className="text-apple-accent hover:underline">mezzanine financing guide</Link></li>
        </ul>
        <p>Talk to 3-5 lenders minimum. Use competing term sheets as use in negotiations. The{" "}
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          <li><strong>Initial inquiry:</strong> Share deal overview, CIM summary, and your background with 3-5 lenders</li>
        ...
        <p>Start the lender process early, ideally when you sign the LOI. Financing delays are a top cause of closing delays.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Get 3-5 competing term sheets and use them as use</li>
          <li>Focus negotiations on covenants, prepayment, and personal guarantee terms, not just interest rate</li>
      ...
      <ul className={ulClass}>
        <li>SBA, <em>Standard Operating Procedure 50 10, Loan Terms and Conditions</em> (2024)</li>
        <li>Pepperdine University, <em>Private Capital Markets Report, Senior Lending</em> (2024)</li>
