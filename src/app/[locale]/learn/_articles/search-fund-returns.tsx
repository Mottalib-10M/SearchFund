    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          considering this asset class, whether as a searcher building a{" "}
        ...
        <ul className={ulClass}>
          <li><strong>35.1% pre-tax IRR</strong>: aggregate across all US/Canadian search funds, as documented in the <Link href="/learn/stanford-2024-study" className="text-apple-accent hover:underline">Stanford 2024 Search Fund Study</Link>.</li>
          <li><strong>4.5x pre-tax ROIC</strong>: aggregate return on all invested capital.</li>
          <li><strong>Outperforms PE and VC</strong>: search funds have consistently outperformed both private equity and venture capital benchmarks on a risk-adjusted basis. Discover <Link href="/learn/why-invest-in-search-funds" className="text-apple-accent hover:underline">why investors choose search funds</Link> over traditional alternatives.</li>
        </ul>
        <p>
          These aggregate figures represent the combined performance of all
          search funds that have reached a terminal outcome, whether
        ...
        <ul className={ulClass}>
          <li><strong>IRR:</strong> 50-100%+ in the best-performing funds.</li>
          <li><strong>MOIC:</strong> 7x-20x+ return on invested capital.</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Median outcomes typically involve steady operational improvements, modest revenue growth of 5-15% per year, and an exit at a modestly higher multiple than the entry price.</li>
        </ul>

        <h3 className={h3Class}>Bottom quartile (25th percentile and below)</h3>
        <ul className={ulClass}>
          <li><strong>IRR:</strong> negative to low single digits.</li>
          <li><strong>MOIC:</strong> 0x-1x, meaning investors lose some or all of their capital.</li>
          ...
          <li>Within this group, approximately 10-15% of all acquisitions result in a near-total or total loss of invested capital.</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Public equities (S&P 500):</strong> long-run average annual return of 8-10%. Search funds offer roughly 3-4x this return on a gross basis, though public equities offer daily liquidity and zero management burden.</li>
          <li><strong>Private equity:</strong> top-quartile PE funds generate net IRRs of 15-20%. Search fund median returns of 33% IRR significantly exceed even top-quartile PE performance. However, PE portfolios offer greater diversification and institutional-grade reporting. See our comparison of <Link href="/learn/eta-vs-private-equity" className="text-apple-accent hover:underline">ETA vs. private equity</Link>.</li>
          <li><strong>Venture capital:</strong> top-quartile VC funds target 20-25% net IRR, but with extreme variance, most individual VC investments fail entirely. Search funds offer a more balanced risk profile with a lower total-loss rate than VC. Our <Link href="/learn/eta-vs-venture-capital" className="text-apple-accent hover:underline">ETA vs. venture capital</Link> analysis explores this in detail.</li>
          <li><strong>Real estate:</strong> commercial real estate typically targets 8-15% annual returns. Search funds outperform on an IRR basis but lack the tangible asset backing and inflation-hedging properties of real estate. Read more in our <Link href="/learn/eta-vs-real-estate" className="text-apple-accent hover:underline">ETA vs. real estate</Link> guide.</li>
        </ul>
        <p>
          On a pure risk-adjusted basis, search funds look particularly
          attractive when held as a portfolio. An investor who backs 15-25
        ...
        <p>
          ...
          initiative alone can add 3-5 percentage points of EBITDA margin
        ...
        <p>
          Organic revenue growth of 5-15% per year is typical among
        ...
        <p>
          Search funds typically acquire businesses at 4-6x EBITDA and
          exit at 6-10x EBITDA. This multiple expansion occurs naturally
        ...
        <p>
          ...
          often 50-60% of the purchase price. As the business
        ...
        <ul className={ulClass}>
          <li><strong>Search phase:</strong> 18-24 months (the 2024 Stanford study reports a 20-month average).</li>
          <li><strong>Acquisition and transition:</strong> 3-6 months from LOI to close, plus 3-12 months of intensive transition work with the seller.</li>
          <li><strong>Operating period:</strong> 4-6 years of active management, growth, and value creation.</li>
          <li><strong>Exit process:</strong> 6-12 months from engagement of an investment banker to close of sale.</li>
        </ul>
        <p>
        ...
        <p>
          ...
          emerge. Funds raised in the early 2000s, when the asset class
          was smaller and less competitive, produced some of the highest
        ...
        <p>
          More recent vintages (2015-2020) show returns that are modestly
        ...
        <p>
          ...
          but most experienced investors target 15-25 search fund
        ...
        <p>
          ...
          acquisition targets, small, profitable, owner-managed
          businesses with succession needs, continues to grow in
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Debt-to-equity ratio:</strong> typically 50-60% debt financing at acquisition, declining to 20-30% by exit through cash flow-driven paydown.</li>
          <li><strong>Exit multiples:</strong> 6-10x EBITDA for well-managed companies with demonstrated growth, representing 1.5-2.5x multiple expansion over the entry price.</li>
        </ul>
        ...
        <p>
          ...
          3-5x range, which is encouraging given the lower entry multiples
          and less mature investor ecosystem. As the European search fund
          community matures, with more experienced investors, better
          operational playbooks, and a growing alumni network, many
