    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Business services:</strong> 30-35% of search fund acquisitions. IT services, staffing, professional services, and facility maintenance.</li>
          <li><strong>Healthcare:</strong> 10-15%. Physician practices, dental, behavioral health, and healthcare technology.</li>
          <li><strong>Technology:</strong> 10-15%. SaaS, software, and IT infrastructure. Growing share of search fund targets.</li>
          <li><strong>Education:</strong> 5-10%. Test prep, corporate training, and educational technology.</li>
          <li><strong>Manufacturing:</strong> 5-10%. Niche manufacturing with proprietary products or processes.</li>
          <li><strong>Consumer services:</strong> 5-10%. Home services, pet services, and consumer health.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Revenue range:</strong> $5-30M annual revenue. Sweet spot is $8-20M for traditional search funds.</li>
          <li><strong>EBITDA range:</strong> $1-5M EBITDA. Target 15-25% EBITDA margins. Cash-flow-positive from day one.</li>
          <li><strong>Valuation multiples:</strong> 4-7x EBITDA for most search fund acquisitions. Premium for recurring revenue and strong growth.</li>
          <li><strong>Enterprise value:</strong> $5-30M. Larger deals ($20-50M) becoming more common as the model matures.</li>
          <li><strong>Revenue growth:</strong> Flat to modest growth (0-10%) at acquisition. High-growth businesses command premiums beyond search fund economics.</li>
          <li><strong>Recurring revenue:</strong> 50-80% recurring revenue preferred. Contract-based, subscription, or maintenance agreement revenue.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Customer diversification:</strong> No single customer &gt;15-20% of revenue. Diversified customer base reduces concentration risk.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Equity:</strong> 40-60% of enterprise value. Raised from search fund investors via pro rata commitments and co-investment.</li>
          <li><strong>Senior debt:</strong> 30-45% of enterprise value. SBA 7(a) loans are common in US deals. Bank term loans in international deals.</li>
          <li><strong>Seller financing:</strong> 10-20% of enterprise value. 2-5 year term with interest. Aligns seller with transition success.</li>
          <li><strong>Earn-outs:</strong> Used in 20-30% of deals. Bridges valuation gaps and reduces closing risk.</li>
          <li><strong>Searcher equity:</strong> 20-30% of common equity to the searcher-CEO. Vesting over 3-5 years based on operational and return milestones.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Business services, healthcare, and technology account for 55-65% of all search fund acquisitions</li>
          <li>The typical search fund target: $8-20M revenue, $1-5M EBITDA, 4-7x valuation, with 50-80% recurring revenue</li>
          <li>80%+ of targets are owner-operator businesses where succession is the primary selling motivation</li>
          <li>Deal structures typically combine 40-60% equity, 30-45% senior debt, and 10-20% seller financing</li>
