    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Transfer taxes:</strong> Some states charge transfer taxes on business sales. Real property transfer taxes can add 1-4% to deal costs.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Apply early:</strong> SBA loan approval takes 30-90 days. Begin the process as soon as LOI is signed, not after due diligence is complete.</li>
          <li><strong>Multiple applications:</strong> Apply to 2-3 lenders simultaneously. Terms and appetite vary significantly between lenders.</li>
          <li><strong>Down payment:</strong> SBA requires 10-20% equity injection. Seller financing can count toward equity in some structures.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>SBA 7(a) loans provide up to $5M for acquisitions with 10-year terms and rates tied to prime, the most favorable acquisition financing available</li>
          ...
          <li>Apply to 2-3 lenders simultaneously and start the process at LOI signing, SBA approval takes 30-90 days</li>
      ...
      <div className={bodyClass}>
        <p>California, Texas, and Florida consistently lead in SBA 7(a) lending volume, together accounting for roughly 30% of all SBA acquisition loans nationally. These states benefit from deep ecosystems of SBA-preferred lenders, active SBDC advisor networks, and large pools of small businesses available for acquisition. States with no income tax, including Texas, Florida, Nevada, Wyoming, Washington, South Dakota, and Tennessee, further improve post-acquisition cash flow by reducing the new owner&rsquo;s overall tax burden. The SBA Office of Advocacy reports that states with 50+ active SBA lenders see significantly more competitive loan terms than states with fewer than 10 participating lenders.</p>
      </div>

      <h3 className={h3Class}>How long does SBA 7(a) loan approval take for a business acquisition?</h3>
      <div className={bodyClass}>
        <p>SBA 7(a) loan approval typically takes 30-90 days from application to closing, though the timeline varies depending on the lender and deal complexity. SBA Preferred Lenders (PLP) can approve loans internally without SBA headquarters review, often cutting approval time to 30-45 days. Standard lenders must submit the application to the SBA for review, which adds 2-4 weeks. Best practice is to begin the SBA application process immediately after signing the letter of intent, not after completing due diligence. Applying to 2-3 lenders simultaneously is recommended, as terms, appetite, and timelines vary significantly between institutions.</p>
      </div>

      <h3 className={h3Class}>Can SBA loans be combined with seller financing for an acquisition?</h3>
      <div className={bodyClass}>
        <p>Yes, and this is a common structure in search fund and ETA acquisitions. The SBA requires a 10-20% equity injection from the buyer, and in some structures, seller financing can count toward this equity injection, provided the seller note is placed on &ldquo;full standby&rdquo; (no payments of principal or interest during the SBA loan term) and is fully subordinated to the SBA loan. The SBA&rsquo;s standby requirements are specific and non-negotiable, so both buyer and seller must ensure the seller note terms comply with SBA guidelines before finalizing the deal structure. National SBA lenders like Live Oak Bank, Celtic Bank, and Harvest Small Business Finance are experienced in structuring these combined financing packages.</p>
      </div>
