...
export default function WorkingWithAdvisorsArticle() {
 ...
 - whose expertise is critical to navigating the legal, financial,
        ...
        <p>
          For a typical search fund acquisition in the $3M&ndash;$15M range, total advisory costs typically run $80K&ndash;$200K, representing 2&ndash;5% of the transaction value. This breaks down as: transaction attorney fees of $30K&ndash;$80K (LOI review, purchase agreement, closing), Quality of Earnings report of $20K&ndash;$60K, tax advisory of $5K&ndash;$15K, and specialty advisors (environmental, IT, HR) of $5K&ndash;$20K. According to the American Bar Association&rsquo;s M&amp;A Committee, advisory costs for lower-middle-market acquisitions have increased approximately 15% over the past five years due to greater regulatory complexity and expanded due diligence scope. These costs are typically funded from the acquisition capital budget, not the search capital.
        </p>
