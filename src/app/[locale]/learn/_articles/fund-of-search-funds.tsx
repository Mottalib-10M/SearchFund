...
export default function FundOfSearchFundsArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          A fund of search funds follows a conventional LP/GP private equity structure with one key difference: instead of acquiring companies directly, the GP deploys capital into individual search fund commitments. The fund typically raises $20M-200M from institutional LPs, endowments, pension funds, family offices, and high-net-worth individuals, and then invests across two stages of the search fund lifecycle.
        </p>

        <p>
          <strong>Stage 1, Search capital.</strong> The FoSF commits $30,000-50,000 per searcher during the search phase, typically backing 40-80+ searchers per fund vintage. This initial commitment buys the right (and obligation) to invest pro rata at the acquisition stage. Search capital covers the entrepreneur&rsquo;s salary, travel, deal sourcing tools, and legal expenses during a 20-24 month search period.
        </p>

        <p>
          <strong>Stage 2, Acquisition equity.</strong> When a searcher identifies and closes a deal, the FoSF invests its pro rata share of the equity check, often $200,000-1.5M per deal depending on fund size and deal terms. Strong FoSF managers also reserve capacity for{" "}
        ...
        <p>
          <strong>Fund lifecycle.</strong> A typical FoSF has a 10-12 year fund life: a 3-4 year investment period during which the GP backs new searchers, followed by a 6-8 year harvest period as portfolio companies mature and exit. Because later-vintage searchers within a fund may not acquire until year 3 or 4, and then hold for 5-7 years, the GP often negotiates extension options with LPs.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <p>
          The biggest criticism of fund-of-search-funds vehicles is the layered fee structure, often called the &ldquo;double promote.&rdquo; LPs pay fees at two levels: the FoSF GP takes a management fee and carry, and the underlying searcher takes founder&rsquo;s equity (typically 20-30% of the acquired company). Here is a typical fee stack:
        </p>

        <ul className={ulClass}>
          <li><strong>FoSF management fee:</strong> 1.5-2.0% annually on committed capital during the investment period, switching to invested capital thereafter.</li>
          <li><strong>FoSF carried interest:</strong> 15-20% of profits above a preferred return hurdle, typically 8%.</li>
          <li><strong>GP commitment:</strong> FoSF GPs usually invest 1-5% of fund capital alongside LPs for alignment.</li>
          <li><strong>Searcher&rsquo;s equity:</strong> At the portfolio company level, the searcher earns 20-30% of equity through vesting (the &ldquo;step-up&rdquo; in the{" "}
        ...
        <p>
          <strong>Net return impact.</strong> The aggregate drag of the double promote is significant. If the underlying search fund portfolio generates a gross 35% IRR (consistent with the Stanford aggregate), the searcher&rsquo;s equity share and FoSF fees compress net LP returns to a target range of 15-22% IRR and roughly 2-3x net MOIC. That is lower than the 35% headline figure often cited in search fund marketing, but it is still a compelling return relative to traditional private equity (where median net IRRs cluster around 12-16%), and it comes with genuine diversification.
        </p>

        <p>
          Some newer FoSF vehicles address this by negotiating lower carry (10-15%), offering fee discounts for anchor LPs, or structuring co-investment pools with zero additional fees, giving LPs a path to increase exposure on the best deals without incremental cost.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Minimum commitment.</strong> Direct search fund investing requires $300,000-600,000+ across 15-25 individual funds to build a diversified portfolio. FoSF minimums range from $500,000 to $5M for a single LP commitment that provides instant diversification.</li>
          <li><strong>Time requirement.</strong> Active direct investors evaluate 20-40 searcher pitches per year, serve on 3-8 boards, and spend 200+ hours annually on portfolio management. FoSF LPs delegate sourcing, diligence, and governance to the GP, a quarterly reporting relationship.</li>
          ...
          <li><strong>Gross vs. net returns.</strong> Direct investors capture the full equity return (minus only the searcher&rsquo;s promote), targeting 25-35% gross IRR on a well-constructed portfolio. FoSF LPs receive 15-22% net IRR after the double fee layer, still attractive, but meaningfully lower.</li>
          <li><strong>Variance.</strong> A direct investor with 5-10 positions faces high outcome variance. The Yale study showed that realized MOIC varies dramatically across investors, from below 1x to well above 5x, depending on vintage, deal selection, and griffin exposure. A FoSF with 30+ positions substantially narrows this range.</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Deal sourcing support.</strong> Some FoSF managers employ dedicated deal sourcing analysts who help searchers identify proprietary acquisition targets, build outreach campaigns, and negotiate LOIs, effectively extending the searcher&rsquo;s capacity during the time-limited search phase.</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Large established FoSFs</strong> (Pacific Lake, Search Fund Partners, Relay): minimums of $1M-5M per LP. Fund sizes range from $100M-200M.</li>
          <li><strong>Mid-size and regional FoSFs</strong> (Istria, Moonbase): minimums of &euro;250,000-1M. Fund sizes of &euro;15M-50M.</li>
          <li><strong>Emerging managers and first-time funds:</strong> some accept minimums as low as $250,000-500,000 to build their LP base, though these carry additional manager-selection risk.</li>
        </ul>

        <p>
          Compared to building a diversified direct portfolio, which requires $300,000-600,000 across 15-25 individual searcher commitments, each demanding separate diligence and documentation, a single FoSF commitment at $500,000-1M delivers broader diversification with far less administrative burden. For a deeper look at the due diligence process, see our{" "}
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Fee compression on returns.</strong> The double-promote structure creates a meaningful drag. In a scenario where underlying portfolio gross returns are 3.5x MOIC, the combination of searcher equity (25%) and FoSF fees (1.5% management fee + 20% carry) can compress net LP returns to 2.0-2.5x, still attractive, but roughly half the headline figure. According to the{" "}
          ...
          <li><strong>Illiquidity and long lock-up.</strong> A 10-12 year fund life with limited secondary market liquidity means capital is locked for a decade or more. Extensions are common. LPs should underwrite a 12-14 year total commitment period.</li>
          ...
          <li><strong>Concentration risk within the FoSF.</strong> Smaller FoSF vehicles (&euro;15-20M) may only back 15-20 searchers, which may be insufficient to smooth the binary outcome distribution. LPs should ask about target portfolio size during diligence.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Minimums range from $250,000 for emerging FoSF managers to $5M+ for established vehicles like Pacific Lake Partners (Fund VI) or Relay Investments (Fund III). Most institutional-grade FoSFs set a floor of $1M per LP. Smaller minimums do exist in European vehicles, Moonbase Capital&rsquo;s Search Fund Squared, for example, attracted family office commitments starting at &euro;250,000, but these tend to be first-time funds with shorter track records.
        </p>

        <h3 className={h3Class}>How do fund-of-search-fund returns compare to direct search fund investing?</h3>
        <p>
          Direct search fund investors who build well-diversified portfolios of 20+ funds can target 25-35% gross IRR, consistent with the Stanford 2024 aggregate of 35.1%. FoSF LPs should expect 15-22% net IRR after the double-promote structure (searcher equity + FoSF carry and fees). The Yale 2025 study, however, showed that the median direct investor realizes closer to 2.5x MOIC, well below the 4.5x Stanford aggregate, because few investors participate in every top-decile outcome. A FoSF with 30+ positions is better positioned to capture that upper tail.
        </p>

        <h3 className={h3Class}>Are fund-of-search-funds appropriate for individual accredited investors?</h3>
        <p>
          Most FoSF vehicles require investors to be qualified purchasers (not just accredited investors) due to the fund&rsquo;s structure as a 3(c)(7) private fund. The 10-12 year lock-up and $500K-5M minimums further narrow the investor base. Individual accredited investors with smaller capital bases may find{" "}
          <Link href="/learn/search-fund-term-sheet" className="text-apple-accent hover:underline">direct search fund investing</Link>
          {" "}at $25,000-50,000 per searcher more accessible, though this requires significantly more time commitment and carries higher portfolio variance.
        </p>

        <h3 className={h3Class}>How many search funds should a fund-of-funds back to achieve diversification?</h3>
        <p>
          Given that 31% of search fund deals produce losses and returns are driven by a small number of outsized winners, statistical modeling suggests a minimum of 20-25 search fund commitments to approximate the asset-class average. Most established FoSF managers target 30-80+ searcher relationships per fund vintage. Pacific Lake and Relay each back 40-80 searchers per fund, with the expectation that 55-65% will close acquisitions. Smaller FoSFs backing fewer than 15 searchers face meaningful concentration risk. For a deeper analysis, read our{" "}
