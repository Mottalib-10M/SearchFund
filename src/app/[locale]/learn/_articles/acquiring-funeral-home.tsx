...
export default function AcquiringFuneralHomeArticle() {
  return (
    <article>
      <h1 className={h1Class}>Acquiring a Funeral Home: Industry Playbook</h1>
      ...
      <div className={bodyClass}>
        <p>
          ...
          community-based competitive moats, and predictable cash flows
          anchored by pre-need contracts. Yet funeral homes rarely appear on
          the standard search fund deal list, creating a less competitive
          acquisition environment for searchers willing to learn the
          sector&rsquo;s unique dynamics. This playbook covers everything
          from industry structure and valuation to regulatory compliance and
          the post-acquisition growth levers that can transform a single
          funeral home into a multi-location platform.
        </p>

        <h2 className={h2Class}>Industry overview: a $20B+ defensive market</h2>
        <p>
          The US funeral services industry generates more than $20 billion in
        ...
        <p>
          ...
          this demand floor provides extraordinary downside protection.
        </p>

        <h2 className={h2Class}>Why funeral homes are attractive for ETA</h2>
        <ul className={ulClass}>
          ...
          <li>
            <strong>Community-based moats:</strong> Funeral homes benefit
            from deep community trust built over decades. Families often
            return to the same funeral home across generations. Reputation,
            relationships with local clergy, and word-of-mouth referrals
            form an enduring competitive advantage.
          </li>
          <li>
          ...
          <li>
            <strong>Fragmented ownership:</strong> With 85% of funeral homes
            independently owned and a significant share of owners over age
            60 with no succession plan, the acquisition opportunity is large
            and growing. Many owners prioritize legacy preservation over
            maximum price.
          </li>
        </ul>

        <h2 className={h2Class}>Types of funeral service businesses</h2>

        <h3 className={h3Class}>Traditional full-service funeral homes</h3>
        <p>
          The classic model offering embalming, visitation, funeral
        ...
        <h3 className={h3Class}>Pet cremation and memorial services</h3>
        <p>
        ...
        <p>
          Funeral home due diligence shares many elements with any
          acquisition, but several areas require specialized attention.
        </p>

        <h3 className={h3Class}>FTC Funeral Rule compliance</h3>
        <p>
          The Federal Trade Commission&rsquo;s Funeral Rule requires funeral
          homes to provide itemized General Price Lists (GPLs) to all
          consumers, disclose pricing over the telephone, and refrain from
          bundling services in ways that prevent consumers from choosing
          individual items. Verify that the target&rsquo;s GPL is current
          and compliant, that staff are trained on disclosure requirements,
          and that there is no history of FTC complaints. Violations can
          result in penalties of up to $50,000 per occurrence and
          reputational damage that is devastating in a trust-based business.
        </p>

        <h3 className={h3Class}>Pre-need trust funding</h3>
        <p>
          Pre-need contracts represent committed future revenue, but the
          associated funds are held in trust accounts governed by state law.
        ...
        <h3 className={h3Class}>Real estate considerations</h3>
        <p>
          Funeral home real estate is highly specialized and often the single
          largest asset in the acquisition. Purpose-built facilities with
          chapels, preparation rooms, and refrigerated storage have limited
          alternative use. Key considerations include whether real estate is
          included or leased, facility condition (HVAC, roofing, ADA
          compliance), preparation room adequacy, and whether the facility
          supports projected call volume growth. Many searchers structure
          real estate in a separate entity to create tax advantages and
          protect the operating business from property-related liabilities.
        </p>
        ...
        <p>
          ...
          substantial and will fall on the buyer if not identified before
          closing.
        </p>

        <h3 className={h3Class}>Licensing requirements</h3>
        <p>
        ...
        <p>
          ...
          significant red flag, potentially indicating competitive losses,
          demographic shifts, or reputational problems. Analyze trends
          against local death certificate data to determine whether the
          funeral home is gaining or losing market share.
        </p>

        <h2 className={h2Class}>Valuation: how funeral homes are priced</h2>
        <p>
          Funeral home valuations typically employ two complementary
          methodologies. Understanding both is essential for structuring a
          competitive offer and securing appropriate{" "}
        ...
        <h3 className={h3Class}>Per-call valuation</h3>
        <p>
        ...
        <h3 className={h3Class}>Adjustments unique to funeral homes</h3>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            ...
            booked as operating revenue may not be sustainable and should
            be evaluated separately.
          </li>
          <li>
            <strong>Real estate separation:</strong> If real estate is
            included, adjust EBITDA for fair market rent to enable
            apples-to-apples comparison with homes that lease facilities.
          </li>
          <li>
            <strong>Deferred maintenance:</strong> Budget for immediate
            post-closing capital expenditures and deduct from your offer
            price or negotiate a holdback.
          </li>
        </ul>

        <h2 className={h2Class}>Post-acquisition playbook</h2>
        <p>
          The growth playbook for funeral homes is rich with operational and
          revenue levers. The{" "}
          <Link href="/learn/management-transition" className="text-apple-accent hover:underline">management transition</Link> period
          is especially delicate in funeral services, where staff continuity
          and community relationships are paramount. Move deliberately and
          prioritize trust-building before implementing changes.
        </p>

        <h3 className={h3Class}>Pre-need sales growth</h3>
        <p>
        ...
        <p>
          ...
          with the broader{" "}
          <Link href="/learn/revenue-growth-playbook" className="text-apple-accent hover:underline">revenue growth playbook</Link> approach
          of maximizing revenue from existing customers.
        </p>

        <h3 className={h3Class}>Event and celebration of life services</h3>
        <p>
          Consumer preferences are shifting toward personalized celebrations
          of life. Forward-thinking funeral homes offer catering
        ...
        <p>
          ...
          outdated presences. Investing in a modern website with online
          arrangement capabilities, transparent pricing, obituary hosting,
          and SEO optimization captures the growing segment of consumers who
          begin funeral planning research online.
        </p>

        <h2 className={h2Class}>Multi-location strategy</h2>
        <p>
          The funeral home industry is exceptionally well-suited to a{" "}
          <Link href="/learn/buy-and-build" className="text-apple-accent hover:underline">buy-and-build strategy</Link>.
          The economics of multi-location platforms are compelling, driven
          by shared overhead, centralized preparation facilities, combined
          purchasing power, and specialized staff deployed across locations.
        </p>
        <ol className={olClass}>
          <li>
            <strong>Platform acquisition:</strong> Acquire a well-established
            funeral home with 200+ calls per year, a strong community
            reputation, and adequate facilities as your operational hub.
          </li>
          <li>
        ...
        <h2 className={h2Class}>Key risks and mitigation strategies</h2>
        <ul className={ulClass}>
          <li>
            <strong>Cremation rate acceleration:</strong> The shift from
            burial to cremation compresses average revenue per call.
            Mitigate by developing premium cremation packages, investing in
            crematory capacity, and focusing on service-oriented cremation
          ...
          <li>
            <strong>Regulatory changes:</strong> The FTC periodically updates
            the Funeral Rule, and states revise licensing and pre-need
            regulations. Stay engaged with the National Funeral Directors
            Association (NFDA) to anticipate regulatory shifts.
          </li>
          <li>
          ...
          <li>
            <strong>Disintermediation:</strong> Online planning platforms
            and direct cremation providers have introduced price
            transparency. Operators who embrace transparency and invest in
            the customer experience will thrive; those who resist will lose
            market share.
          </li>
        </ul>
        ...
        <p>
          ...
          The cremation trend creates opportunity for operators willing to
          innovate around service delivery and merchandising. A well-executed
          buy-and-build strategy can transform a single acquisition into a
          multi-location platform with meaningfully higher margins and exit
