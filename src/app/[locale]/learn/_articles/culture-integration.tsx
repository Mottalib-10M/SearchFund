    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          developed over 10&ndash;30+ years under the previous owner.
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Identify the culture carriers:</strong> 2&ndash;3 people who embody the best of the existing culture. These are your allies in any cultural evolution</li>
        ...
        <h2 className={h2Class}>Evolving the culture (months 3&ndash;12)</h2>
