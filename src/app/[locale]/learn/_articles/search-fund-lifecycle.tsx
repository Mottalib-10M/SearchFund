    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          7-10 years from initial fundraise to exit. Understanding each
          stage, the timelines, milestones, economics, and common
          pitfalls, is essential for both searchers planning their
        ...
        <ol className={olClass}>
          <li><strong>Fundraise</strong>: Raise search capital from investors (3-6 months)</li>
          <li><strong>Search</strong>: Source, evaluate, and select a target (12-24 months)</li>
          <li><strong>Acquisition</strong>: Negotiate, finance, and close the deal (3-9 months)</li>
          <li><strong>Operations</strong>: Run and grow the acquired company (4-7 years)</li>
          <li><strong>Exit</strong>: Sell or recapitalize the business</li>
        </ol>
        <p>
          The total timeline from fundraise to exit averages 7-8 years,
          with the operating phase being the longest and most
          value-creating period.
        </p>

        <h2 className={h2Class}>Stage 1: Fundraise (3-6 months)</h2>

        <h3 className={h3Class}>What happens</h3>
        <p>
          The searcher raises $400K-$600K in search capital from
          10-20 investors. This capital funds the searcher&rsquo;s
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            search fund investors (typically $25K-$50K per investor)
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>Searcher receives a modest salary ($80K-$120K) during the search phase</li>
        </ul>

        <h3 className={h3Class}>Common mistakes</h3>
        <ul className={ulClass}>
          <li>Raising too little capital (running out of runway during the search)</li>
          <li>Over-concentrating the investor base (1-2 large investors who can control the process)</li>
        ...
        <h2 className={h2Class}>Stage 2: Search (12-24 months)</h2>
        ...
        <p>
          ...
          lifecycle. The median search duration is 18-20 months, with
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Initial screening:</strong> Reviewing 100-200+ opportunities to find 5-10 serious candidates</li>
          ...
          <li>
            ...
            Submitting 2-5 Letters of Intent before closing one deal
          </li>
        ...
        <ul className={ulClass}>
          <li>Opportunities reviewed: 150-300</li>
          <li>First meetings/calls: 30-60</li>
          <li>Deep dives: 10-20</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Failing to build broker relationships (brokers control 50-70% of deal flow)</li>
          <li>
          ...
          <li>Poor time management, spreading too thin across too many opportunities</li>
        </ul>

        <h2 className={h2Class}>Stage 3: Acquisition (3-9 months)</h2>
        ...
        <p>
          The median search fund acquisition is $10-$30M in enterprise
          value. A typical capital structure:
        </p>
        <ul className={ulClass}>
          <li>Senior debt: 50-65% of enterprise value</li>
          <li>Equity (from search fund investors): 25-40%</li>
          <li>Seller financing: 5-15% (see{" "}
        ...
        <p>
          Upon closing, the searcher receives approximately 20-25%
          of equity, typically vesting over 4-5 years. Combined with
        ...
        <h2 className={h2Class}>Stage 4: Operations (4-7 years)</h2>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Stabilization (Year 1-2):</strong> Systematize
            operations, hire key roles, implement technology
          </li>
          <li>
            <strong>Growth (Year 2-5):</strong> Execute on{" "}
          ...
          <li><strong>Exit preparation (Year 4-6):</strong> Professionalize reporting, reduce owner dependency, optimize for exit</li>
        </ul>
        ...
        <p>
          ...
          (typically 3-5 members including investor representatives
        ...
        <h3 className={h3Class}>What happens</h3>
        <p>
          After 4-7 years of operations, the business is sold or
          ...
          is typically determined 1-2 years before execution.
        </p>
        ...
        <p>
          ...
          exit on a $20M acquisition can generate $5-$15M+ in
        ...
        <ul className={ulClass}>
          <li><strong>Month 0-6:</strong> Fundraise - raise search capital, form entity</li>
          <li><strong>Month 6-24:</strong> Search - source deals, submit LOIs</li>
          <li><strong>Month 18-30:</strong> Acquisition - due diligence, financing, close</li>
          <li><strong>Year 2-8:</strong> Operations - run and grow the business</li>
          <li><strong>Year 6-10:</strong> Exit - sell or recapitalize</li>
        </ul>
        <p>
        ...
        <p>
          ...
          target smaller businesses ($1-$5M enterprise value),
          and use{" "}
        ...
        <p>
          The fundraise and search phases together cost $400K-$600K in
          investor-funded search capital. The acquisition phase adds
          $50K-$150K in due diligence and transaction fees, plus the
          acquisition equity itself ($2M-$10M+). For a detailed
        ...
        <p>
          ...
          acquisition (Stages 1-3). Of those, roughly two-thirds
        ...
        <p>
          ...
          compress the search from 18-24 months to 6-12. The{" "}
