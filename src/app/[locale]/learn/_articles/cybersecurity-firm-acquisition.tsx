    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Gross margin profile:</strong> Managed services businesses typically operate at 40&ndash;60% gross margins, while SaaS businesses can achieve 70&ndash;85%. Higher gross margins indicate scalability and pricing power. Firms that rely heavily on subcontracted labor may have lower margins but also lower fixed costs.</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Employment agreements:</strong> Secure employment agreements with key personnel before or at closing. Include non-compete and non-solicitation provisions (enforceable in most jurisdictions for senior technical and sales staff), retention bonuses vesting over 2&ndash;3 years, and clear role definitions post-acquisition.</li>
