  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>One of the hardest parts of being a new CEO post-acquisition is making personnel changes. The business you acquired comes with its people, and not all of them will be the right fit for where you need to take the company. Delaying inevitable terminations is one of the most common mistakes new search fund CEOs make, often costing months of productivity and morale.</p>
      </div>

      <h2 className={h2Class}>When It&apos;s Time to Act</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Performance is consistently below standard:</strong> You&apos;ve set clear expectations, provided support, and given reasonable time, but results aren&apos;t improving</li>
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li><strong>Reasonable time:</strong> Have you given enough time (typically 30-90 days) for improvement after feedback?</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>Other employees are watching, tolerating poor performance demoralizes your best people</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Offer severance:</strong> Typically 2-4 weeks per year of service. Get a release of claims in exchange.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Don&apos;t act in the first 30 days (unless integrity issues), give people a fair chance to adjust</li>
