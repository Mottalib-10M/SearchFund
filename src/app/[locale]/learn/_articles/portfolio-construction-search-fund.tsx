  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Search fund investing requires a portfolio approach, returns are driven by a small number of outsized winners while many investments produce modest or negative returns. Effective portfolio construction involves determining allocation size, number of investments, diversification strategy, and capital reserve planning. This guide provides a framework for building and managing a search fund investment portfolio.</p>
      </div>

      <h2 className={h2Class}>Portfolio Size &amp; Diversification</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Minimum portfolio:</strong> 10-15 search fund investments to achieve meaningful diversification. Returns are lumpy and concentrated.</li>
          <li><strong>Optimal portfolio:</strong> 20-30+ investments provides better diversification. The top 3-5 performers typically drive portfolio returns.</li>
          <li><strong>Vintage diversification:</strong> Invest across multiple years (vintages) to reduce timing risk. 3-5 investments per year over 5+ years.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Search capital:</strong> $50K-250K per search fund for the initial search phase. This is the &ldquo;option&rdquo; to invest in the acquisition.</li>
          <li><strong>Acquisition capital:</strong> 2-5x the search capital commitment when an acquisition is identified. Pro rata rights allow investors to maintain their ownership.</li>
          <li><strong>Total per investment:</strong> $200K-1M+ total capital deployed per search fund (search + acquisition). Plan for 3-5x the initial search commitment.</li>
          <li><strong>Reserve ratio:</strong> Reserve 60-70% of total allocated capital for acquisition-phase investments. Do not over-commit at the search stage.</li>
          <li><strong>Portfolio allocation:</strong> Search funds typically represent 5-20% of an investor&apos;s total alternative investment portfolio.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Portfolio returns:</strong> Well-constructed portfolios target 2-3x net MOIC and 20-30% gross IRR over a 7-10 year investment horizon.</li>
          <li><strong>Return distribution:</strong> ~25% of search funds don&apos;t complete an acquisition (partial loss). ~15% of acquisitions underperform. ~30% are solid returns. ~15-20% are home runs (5x+).</li>
          <li><strong>J-curve effect:</strong> Search fund portfolios show negative or flat returns in years 1-3. Returns materialize in years 4-8 as acquisitions mature and exit.</li>
          <li><strong>Cash flow timing:</strong> Expect first meaningful distributions in year 4-5. Full portfolio realization takes 8-12 years.</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Board service:</strong> Serving on 2-4 portfolio company boards provides oversight and value-add but requires significant time commitment.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Build a portfolio of 20-30+ search fund investments across vintages, geographies, and industries for meaningful diversification</li>
          <li>Reserve 60-70% of total capital for acquisition-phase investments, don&apos;t over-commit at the search stage</li>
          <li>Expect a J-curve: flat or negative returns in years 1-3, with meaningful distributions starting in years 4-5</li>
          <li>The top 3-5 investments in a portfolio typically drive overall returns, the portfolio approach is essential</li>
