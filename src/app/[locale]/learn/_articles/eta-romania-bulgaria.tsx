  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Bulgaria is smaller, &euro;102 billion GDP, 6.5 million people, but punches above its weight in specific niches. Sofia has emerged as a significant European outsourcing and shared services hub, partly because Bulgarians are often trilingual (Bulgarian, English, plus German or French). The country adopted a currency board arrangement in 1997 that pegs the Bulgarian lev (BGN) to the euro at a fixed rate of 1.95583, effectively eliminating currency risk for euro-denominated investors. Bulgaria is on track for eurozone accession, though the timeline has slipped multiple times.
        </p>
        <p>
          Both economies have averaged 3-5% real GDP growth over the past decade, driven by EU convergence dynamics: structural fund inflows (Romania received &euro;31 billion in the 2021-2027 EU budget cycle), rising productivity, and wage growth that still trails Western Europe by 60-70%. This convergence story is the thesis behind acquiring here, buy at emerging-market multiples, hold while the economy matures toward EU averages. The same playbook worked in Spain and Ireland in the 1990s, and in Poland and the Czech Republic in the 2000s.
        </p>

        <h2 className={h2Class}>Why Valuations Stay Low: The Succession Gap and Thin M&amp;A Markets</h2>
        <p>
          The primary reason acquisition multiples remain at 2-4x EBITDA, compared to 4-6x in <Link href="/learn/eta-europe" className="text-apple-accent hover:underline">Western European ETA markets</Link>, is structural: there are very few organized buyers. Romania has roughly 520,000 active SMEs (European Commission SBA Fact Sheet, 2024), and Bulgaria has approximately 370,000. Many are first-generation businesses founded in the 1990s after the transition from communism. Their founders are now 55-70 years old, and according to a 2023 EBRD survey, fewer than 15% have a formal succession plan.
        </p>
        <p>
          Unlike Germany or France, where business brokers, M&amp;A boutiques, and transfer marketplaces create organized deal flow, Romania and Bulgaria have almost no intermediary infrastructure for small deals. There are perhaps 10-15 active M&amp;A advisory firms in each country, and they focus on transactions above &euro;5 million. Below that threshold, deals happen through personal networks, accountants, or lawyers. This means the <Link href="/learn/deal-sourcing-strategies" className="text-apple-accent hover:underline">deal sourcing process</Link> is fundamentally relationship-driven rather than platform-driven.
        </p>
        <p>
        ...
        <p>
          In Romania, the equivalent of a limited liability company is the <strong>SRL</strong> (Societate cu R&#259;spundere Limitat&#259;). Minimum share capital is RON 200 (roughly &euro;40), essentially symbolic. An SRL can have 1-50 shareholders and is managed by one or more administrators (<em>administratori</em>). Formation takes 3-5 business days at the Trade Registry. For acquisitions, you would typically purchase 100% of the <em>p&#259;r&#539;i sociale</em> (ownership stakes) through a share purchase agreement authenticated by a notary. Romanian law requires notarial authentication of any share transfer in an SRL, which adds a procedural step but also provides a layer of formality that can protect both parties.
        </p>
        <p>
          In Bulgaria, the equivalent is the <strong>OOD</strong> (Druzhestvo s Ogranichena Otgovornost). Minimum capital is BGN 2 (about &euro;1). The structure is functionally identical to the Romanian SRL. Registration at the Bulgarian Commercial Register takes 2-4 days. Share transfers require a notarized agreement and registration with the Commercial Register. A thorough <Link href="/learn/due-diligence-checklist" className="text-apple-accent hover:underline">due diligence process</Link> is critical in both jurisdictions, particularly around undisclosed liabilities, tax compliance history, and informal arrangements that may not appear in audited financials.
        </p>
        <p>
        ...
        <ul className={ulClass}>
          <li><strong>Seller financing:</strong> The most common structure for small deals. Sellers in Romania and Bulgaria are often willing to finance 30-50% of the purchase price over 2-4 years because they have few alternative buyers. This aligns incentives and reduces the equity needed upfront.</li>
          ...
          <li><strong>Earnout structures:</strong> Structuring part of the purchase price as performance-based earnouts over 1-3 years can bridge valuation gaps and reduce the seller&apos;s risk perception when selling to a foreign buyer.</li>
        </ul>
        <p>
          The typical deal structure for a &euro;1-3M acquisition in these markets might look like: 40-50% equity, 30-40% seller financing, and 10-20% earnout. Bank debt, if available, is a bonus rather than a planning assumption.
        </p>
