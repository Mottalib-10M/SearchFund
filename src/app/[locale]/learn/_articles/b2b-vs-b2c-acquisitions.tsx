    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>B2B margins:</strong> Typically higher gross margins (40&ndash;70%) due to relationship-based selling and customized solutions.</li>
          <li><strong>B2C margins:</strong> Variable margins depending on industry. Retail (20&ndash;40%), services (40&ndash;60%), digital (60&ndash;80%).</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>B2B concentration:</strong> Fewer customers with larger accounts. Top 10 customers often represent 40&ndash;80% of revenue. Concentration risk is the primary concern.</li>
          ...
          <li><strong>B2B switching costs:</strong> High switching costs due to integration, training, and relationship depth. Annual churn rates of 5&ndash;15%.</li>
          <li><strong>B2C switching costs:</strong> Low switching costs for most consumer businesses. Churn rates of 20&ndash;50%+ annually without strong brand loyalty.</li>
