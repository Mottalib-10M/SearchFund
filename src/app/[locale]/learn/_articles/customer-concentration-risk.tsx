    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Yellow zone (10-25%):</strong> A top customer at 10-25% is manageable but requires mitigation. Lenders will scrutinize the relationship</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Top 5 customers at 30-50%: moderate risk, investigate retention rates</li>
          <li>Top 5 customers above 50%: high risk, significant valuation discount warranted</li>
          <li>Top 10 customers above 70%: extreme concentration, this is a contract book, not a business</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>Concentrated businesses typically trade at 1-2x lower{" "}
            <Link href="/learn/ebitda-multiples-by-industry" className="text-apple-accent hover:underline">
              EBITDA multiples
            </Link>{" "}
            than diversified peers</li>
          <li>A business with $2M EBITDA at 5x (diversified) becomes $2M at 3-4x (concentrated), a $2M-$4M difference in enterprise value</li>
        ...
        <ul className={ulClass}>
          <li>SBA lenders flag customer concentration above 15-20% in a single customer</li>
          <li>Some lenders will decline to finance if concentration exceeds 25-30%</li>
        ...
        <p>
          ...
          workstream, thoroughly analyze:
        </p>
        <ul className={ulClass}>
          <li><strong>Revenue by customer (last 3-5 years):</strong> Calculate concentration metrics for each year to identify trends (improving vs. worsening)</li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            If key customer(s) remain for 12-24 months, the seller earns additional consideration
          </li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Clear diversification path:</strong> You have a concrete plan (and the skills) to reduce concentration within 12-24 months</li>
          <li><strong>Steep discount:</strong> If the price reflects the risk (2-3x EBITDA for a business worth 5x if diversified), the economics may justify the gamble</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>B2B services:</strong> Some concentration is common. A top customer at 15-20% may be acceptable if contractually protected</li>
          <li>
            <strong>
            ...
            Particularly concentrated due to OEM supply relationships. Automotive suppliers may have 50%+ from one OEM, priced accordingly
          </li>
          <li>
            <strong>
        ...
        <p>
          SBA lenders flag customer concentration above 15-20% in a single
          customer, and some lenders will decline to finance if concentration
          exceeds 25-30%. Concentrated businesses typically receive lower
          use (2-3x EBITDA vs. 3-5x for diversified peers),
        ...
        <p>
          Concentrated businesses typically trade at 1-2x lower EBITDA
          ...
          multiple by 0.25-0.5x. A business with $2M EBITDA that would
          trade at 5x if diversified might sell for 3-4x with significant
          concentration, a $2M-$4M difference in enterprise value.
        ...
        <p>
          ...
          12-24 months, or a steep enough price discount (2-3x EBITDA
