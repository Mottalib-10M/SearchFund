    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Food &amp; beverage:</strong> Broadline or specialty food distribution. Cold chain complexity, thin margins (1-3% net).</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Recurring orders:</strong> Customers reorder consumable products monthly. 70-85% of revenue is repeat business.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Gross margin by product line:</strong> Distribution margins are thin (15-30% gross). Understand the mix and identify high-margin opportunities.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Distribution businesses offer sticky B2B relationships with 70-85% repeat revenue</li>
          <li>Margins are thin but predictable, technology and value-added services are the primary improvement levers</li>
          <li>Working capital management (inventory turns, AR collection) is critical to cash flow</li>
          <li>Supplier relationship transferability is a key due diligence concern, verify manufacturer agreements early</li>
          <li>Typical valuations: 4-7x EBITDA depending on product type, customer diversification, and growth trajectory</li>
        </ul>
      </div>
      ...
      <h3 className={h3Class}>What are typical EBITDA margins for distribution businesses?</h3>

      <div className={bodyClass}>
        <p>Distribution businesses typically operate with EBITDA margins of 5-10%, according to the National Association of Wholesaler-Distributors (NAW). Gross margins range from 15-30% depending on the product category, medical and specialty chemical distributors achieve the highest margins (25-35%), while food and commodity distributors operate at the thin end (10-18%). The key to profitability is operational efficiency: inventory turns, warehouse utilization, and route optimization. Acquirers who invest in technology (modern ERP systems, e-commerce platforms, and warehouse management systems) can typically improve EBITDA margins by 2-4 percentage points within 18-24 months, according to McKinsey &amp; Company&rsquo;s research on distribution sector digitization.</p>
      </div>

      <h3 className={h3Class}>How important is supplier relationship transferability in distribution acquisitions?</h3>

      <div className={bodyClass}>
        <p>Supplier relationship transferability is among the highest-priority due diligence items in any distribution acquisition. According to the US Census Bureau&rsquo;s wholesale trade data, distributors with exclusive or preferred supplier agreements command 20-30% higher valuations than those with non-exclusive arrangements. During diligence, verify whether manufacturer agreements contain change-of-control provisions that could allow the supplier to terminate the relationship upon acquisition. Contact the top 5-10 suppliers directly to assess their willingness to continue under new ownership. Loss of a key supplier can devastate a distributor&rsquo;s business overnight, so this risk must be addressed contractually through representations and warranties in the purchase agreement and, ideally, through supplier consent letters obtained before closing.</p>
      </div>

      <h3 className={h3Class}>What is the typical valuation range for distribution businesses?</h3>

      <div className={bodyClass}>
        <p>Distribution businesses typically trade at 4-7x EBITDA, with the multiple driven by product type, customer diversification, growth trajectory, and the quality of supplier relationships. Commodity distributors with thin margins and high customer concentration trade at the low end (3.5-4.5x), while specialty distributors with value-added services, proprietary brands, and recurring revenue streams command 6-8x, according to NAW industry benchmarks. Technology-enabled distributors with strong e-commerce platforms and strong data analytics capabilities are increasingly attracting premium multiples as private equity recognizes the value of digital infrastructure in traditional distribution businesses.</p>
      </div>
