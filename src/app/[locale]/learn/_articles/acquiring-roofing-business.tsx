...
export default function AcquiringRoofingBusinessArticle() {
  return (
    <article>
      <h1 className={h1Class}>Acquiring a Roofing Business</h1>
      ...
      <div className={bodyClass}>
        <p>
          ...
          category, start with our guide to{" "}
          <Link href="/learn/home-services-acquisition" className="text-apple-accent hover:underline">home services acquisitions</Link>,
          and if you&rsquo;re exploring entrepreneurship through acquisition
          for the first time, see{" "}
          <Link href="/learn/what-is-eta" className="text-apple-accent hover:underline">what is ETA</Link>.
        </p>

        <h2 className={h2Class}>Why acquire a roofing company?</h2>
        <p>
          Roofing stands out even among home services verticals for several
          structural reasons that make it attractive to acquisition
          entrepreneurs.
        </p>
        <ul className={ulClass}>
          ...
          <li>
            <strong>Labor shortage creates a moat:</strong> The skilled trades
            labor shortage is acute in roofing. The physically demanding nature
          ...
          <li>
            ...
            lack professional management, modern technology, and scalable
            systems. An acquirer who professionalizes operations, implements
            CRM and estimating software, and builds a repeatable sales process
            can dramatically outperform the fragmented competition.
          </li>
        </ul>

        <h2 className={h2Class}>Types of roofing businesses</h2>
        <p>
          Not all roofing companies are alike. The type of work a company
          focuses on dramatically affects its risk profile, margin structure,
          and growth trajectory.
        </p>

        <h3 className={h3Class}>Residential re-roofing &amp; storm restoration</h3>
        <p>
          The most common segment for acquisition targets. These companies
          replace aging or storm-damaged residential roofs, typically asphalt
        ...
        <h3 className={h3Class}>Commercial roofing</h3>
        <p>
          ...
          contracts. This segment is particularly attractive as a growth
          vector for primarily residential companies.
        </p>

        <h3 className={h3Class}>Specialty roofing</h3>
        <p>
        ...
        <p>
          ...
          for most roofers, it represents one of the most valuable
          post-acquisition growth levers because it converts a purely
          transactional business into one with predictable, recurring cash flow.
        </p>

        <h2 className={h2Class}>Key due diligence areas</h2>
        <p>
          Roofing businesses present unique due diligence challenges beyond
          those found in other home services verticals. Pay close attention
          to the following areas.
        </p>

        <h3 className={h3Class}>Licensing &amp; bonding</h3>
        <p>
        ...
        <h3 className={h3Class}>Insurance</h3>
        <p>
          Insurance is one of the largest cost items for a roofing company.
        ...
        <h3 className={h3Class}>Safety record &amp; EMR rating</h3>
        <p>
          The Experience Modification Rate (EMR) is the single most important
        ...
        <h3 className={h3Class}>Subcontractor vs. employee model</h3>
        <p>
          Many roofing companies use subcontracted crews classified as 1099
          independent contractors rather than W-2 employees. This reduces
          overhead but carries significant legal and financial risk. The IRS
          ...
          post-acquisition. This is a common form of{" "}
          <Link href="/learn/key-person-risk" className="text-apple-accent hover:underline">key person risk</Link> in
          trades businesses, where the owner&rsquo;s personal relationships
          with subcontractor crews may not transfer to a new owner.
        </p>

        <h3 className={h3Class}>Revenue mix: storm vs. retail</h3>
        <p>
          Decompose revenue into storm/insurance restoration work versus retail
          (non-insurance) work. A company that generates 80%+ of revenue from
          storm work is essentially a weather-dependent business. While storm
          years can be extraordinarily profitable, acquirers should underwrite
          the business on normalized, multi-year average revenue rather than
          trailing twelve-month figures from a banner storm year.
        </p>

        <h3 className={h3Class}>Warranty obligations</h3>
        <p>
          Roofing companies typically offer workmanship warranties ranging from
          5 to 25 years. These represent contingent liabilities that transfer
          with the business. Review warranty claim rates, assess the financial
          exposure of outstanding warranties, and verify that the company has
          maintained proper installation practices to preserve manufacturer
        ...
        <p>
          ...
          certifications are current, understand the renewal requirements,
          and confirm they will transfer post-acquisition.
        </p>

        <h3 className={h3Class}>Fleet &amp; equipment condition</h3>
        <p>
          Roofing operations require trucks, trailers, dump trailers for
          tear-off debris, nail guns, compressors, ladders, scaffolding, and
          safety equipment. Assess the age, condition, and replacement cost
          of all assets. Deferred maintenance on trucks and equipment is a
          common hidden liability. Commercial roofers may also have
          significant equipment investments in cranes, material hoists, and
          specialty application equipment.
        </p>

        <h3 className={h3Class}>Seasonality</h3>
        <p>
          Roofing is heavily seasonal in northern climates, with most work
          concentrated between April and November. In southern markets,
          seasonality is less pronounced but still present. Evaluate how
          the company manages cash flow through the off-season, whether crews
          are retained year-round or laid off seasonally, and what (if any)
          off-season revenue sources exist (interior work, gutter
          installation, snow removal, emergency repairs).
        </p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Revenue volatility discount:</strong> Companies with high
            storm concentration (70%+ of revenue from insurance restoration)
            should trade at a discount to companies with diversified revenue
            streams. Retail re-roofing, commercial work, and maintenance
            contracts all reduce volatility and support higher multiples.
          </li>
          <li>
          ...
          <li>
            ...
            salesperson, estimator, and project manager, the business carries
            significant transition risk. See our guide to{" "}
            <Link href="/learn/key-person-risk" className="text-apple-accent hover:underline">key person risk</Link>{" "}
            for strategies to mitigate this during the acquisition process.
          </li>
        </ul>

        <h2 className={h2Class}>Post-acquisition playbook</h2>
        <p>
          The most successful roofing acquisitions follow a disciplined
          post-close playbook that converts a traditional, transactional
          roofing company into a professionalized, scalable platform. Our{" "}
          <Link href="/learn/pricing-optimization" className="text-apple-accent hover:underline">pricing optimization</Link>{" "}
          guide covers the revenue side in detail; below are the
          roofing-specific operational levers.
        </p>

        <h3 className={h3Class}>Build a maintenance &amp; inspection program</h3>
        <p>
        ...
        <h3 className={h3Class}>Develop a commercial division</h3>
        <p>
          If the acquired business is primarily residential, adding commercial
          roofing capabilities provides more predictable revenue that is less
          dependent on weather events. Commercial projects have longer sales
          cycles but also longer customer relationships, natural maintenance
          contract opportunities, and less seasonal volatility. Start with
          small commercial projects (churches, strip malls, small office
          buildings) and build capacity gradually.
        </p>

        <h3 className={h3Class}>Invest in storm response infrastructure</h3>
        <p>
          For companies in storm-prone markets, the ability to rapidly deploy
          crews to affected areas is a critical competitive advantage. Build
          pre-positioned canvassing teams, develop relationships with
          adjusters, train crews on Xactimate supplement documentation, and
          create playbooks for storm mobilization. The companies that arrive
          first after a hail event capture a disproportionate share of the
          available work.
        </p>

        <h3 className={h3Class}>Implement CRM &amp; estimating software</h3>
        <p>
        ...
        <h3 className={h3Class}>Build a subcontractor network</h3>
        <p>
          Scaling a roofing company often requires supplementing W-2 crews
          with vetted subcontractor crews, particularly during storm surges
          when demand outstrips in-house capacity. Build relationships with
          reliable subcontractor crews before you need them, establish clear
          quality standards and safety requirements, and create a tiered
          compensation structure that rewards performance and reliability.
          A strong subcontractor network is the difference between capturing
          a storm event and watching the opportunity pass.
        </p>

        <h3 className={h3Class}>Add adjacent services</h3>
        <p>
          ...
          to add (low capital investment, similar crew skills), while solar
          represents the largest growth opportunity but requires significant
          investment in training, licensing, and supply chain relationships.
          For a broader framework on adding service lines, review our{" "}
          <Link href="/learn/buy-and-build" className="text-apple-accent hover:underline">buy-and-build</Link>{" "}
          guide.
        </p>

        <h3 className={h3Class}>Improve safety to reduce insurance costs</h3>
        <p>
          ...
          (near misses, safety observations) in addition to lagging indicators
          (lost-time incidents). Reducing the EMR from 1.1 to 0.85 can save
          tens of thousands of dollars annually in workers&rsquo; comp
          premiums alone.
        </p>

        <h2 className={h2Class}>The bottom line</h2>
        <p>
          Roofing is a high-revenue, high-margin trades vertical that rewards
          disciplined acquirers who can professionalize operations, manage risk,
          and build scalable systems. The combination of a massive fragmented
          market, high revenue per job, storm-driven demand surges, and a
          structural labor shortage creates a compelling acquisition thesis.
