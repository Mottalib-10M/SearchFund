    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          {" "}poorly structured board packs are &ldquo;the elephant in the boardroom&rdquo;, too long, too unfocused, and delivered too late to drive productive discussion. This guide gives you a section-by-section template, real KPI examples by business type, and the distribution cadence that top-performing search fund operators follow.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li><strong>Personal credibility.</strong> Transparent reporting, especially when news is bad, builds the kind of trust that gives you room to make bold decisions later. Boards don&rsquo;t punish honesty; they punish surprises.</li>
        </ol>
        <p>
      ...
      <div className={bodyClass}>
        <p>
          A strong board package for a search fund-owned small business runs 8-12 pages. That&rsquo;s not arbitrary, the NACD&rsquo;s{" "}
        ...
        <ol className={olClass}>
          <li><strong>CEO Commentary</strong> (1-1.5 pages)</li>
          <li><strong>Financial Summary</strong> (2-3 pages)</li>
          <li><strong>KPI Dashboard</strong> (1 page)</li>
          <li><strong>Strategic Initiatives Tracker</strong> (1 page)</li>
          <li><strong>People &amp; Organization Update</strong> (0.5-1 page)</li>
          <li><strong>Board Questions &amp; Agenda Items</strong> (0.5 page)</li>
        </ol>
        <p>
          Total: 6-8 pages of core content, plus an optional 2-4 page appendix for detailed schedules (AR aging, debt covenants, detailed P&amp;L). Directors who want to dig deeper can; those who need the summary have it on the first six pages.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <h3 className={h3Class}>Cash Flow &amp; Liquidity (0.5-1 page)</h3>
        <p>
          ...
          {" "}that projects week-by-week liquidity; and (3) a debt summary showing outstanding balances, covenant compliance ratios, and upcoming maturities or amortization payments. Graphite Financial calls the 13-week forecast &ldquo;the gold standard for short-term liquidity planning,&rdquo; and for good reason, it gives your board confidence that you see around the next corner.
        </p>
      ...
      <div className={bodyClass}>
        <p>
          The KPI dashboard should fit on a single page with 5-10 metrics, each shown as a current value, trend line (6-12 months), and a green/yellow/red status indicator. The specific metrics depend entirely on what kind of business you acquired. Here are concrete examples across three common search fund verticals, drawing on frameworks from{" "}
        ...
        <ul className={ulClass}>
          <li><strong>Billable utilization rate</strong>: target: 70-80% for most firms</li>
          <li><strong>Revenue per employee</strong>: trailing 12-month trend</li>
          <li><strong>Employee turnover rate</strong>: monthly, annualized</li>
          <li><strong>Backlog / contracted pipeline</strong>: in dollars and months of coverage</li>
          <li><strong>Average bill rate vs. average cost rate</strong>: gross margin proxy</li>
          <li><strong>Client concentration</strong>: top 5 clients as a % of revenue</li>
        </ul>

        <h3 className={h3Class}>Manufacturing / Distribution</h3>
        <ul className={ulClass}>
          <li><strong>On-time delivery rate</strong>: target: 95%+</li>
          <li><strong>Scrap / rework rate</strong>: as a % of cost of goods sold</li>
          <li><strong>Inventory turns</strong>: monthly, with trend</li>
          <li><strong>Capacity utilization</strong>: actual production hours vs. available hours</li>
          <li><strong>Quote-to-order conversion rate</strong>: pipeline health indicator</li>
          <li><strong>Average order value</strong>: trailing 12-month trend</li>
        </ul>

        <h3 className={h3Class}>SaaS / Recurring Revenue</h3>
        <ul className={ulClass}>
          <li><strong>Monthly recurring revenue (MRR)</strong>: broken into new, expansion, and churned</li>
          <li><strong>Net revenue retention (NRR)</strong>: target: 100%+ indicates expansion exceeds churn</li>
          <li><strong>Gross churn rate</strong>: monthly, shown as both % and absolute dollar loss</li>
          <li><strong>Customer acquisition cost (CAC) payback period</strong>: in months</li>
          <li><strong>LTV:CAC ratio</strong>: healthy threshold: 3:1 or higher per{" "}
          ...
          <li><strong>Daily/weekly active users</strong>: engagement leading indicator</li>
        </ul>
        ...
        <p>
          ...
          {" "}The key principle: every KPI on the board page should connect directly to either revenue, margin, or cash, if it doesn&rsquo;t, move it to the appendix.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <p>
          The CEO letter is the most-read section of the board package, and it&rsquo;s where first-time operators either build or erode credibility. Keep it to 1-1.5 pages. Based on guidance from the{" "}
        ...
        <ol className={olClass}>
          ...
          <li><strong>What went well (2-3 bullets).</strong> Specific wins with numbers attached. Not &ldquo;sales were strong&rdquo; but &ldquo;closed $140K in new contracts, 18% above the monthly target, driven by the new outbound campaign launched in February.&rdquo;</li>
          <li><strong>What didn&rsquo;t go well (2-3 bullets).</strong> This is where trust is built. Name the problem, quantify the impact, and state what you&rsquo;re doing about it. Example: &ldquo;Technician turnover hit 22% annualized this month (target: 15%). Root cause is compensation below market in the Dallas territory. Adjusting pay bands by 8% effective April 1; expect $45K annualized cost increase.&rdquo;</li>
        ...
        <p>
          <strong>Tone guidance:</strong> Write as if you&rsquo;re talking to a trusted business partner over coffee, direct, factual, and unvarnished. Avoid corporate jargon. The{" "}
      ...
      <div className={bodyClass}>
        <p>
          Beyond the monthly financials and KPIs, your board needs visibility into the 3-5 major initiatives that will drive the business forward over the next 6-18 months. This section should fit on a single page and use a simple table format:
        </p>

        <ul className={ulClass}>
          <li><strong>Initiative name</strong>: e.g., &ldquo;ERP Migration,&rdquo; &ldquo;Launch Second Location,&rdquo; &ldquo;Sales Team Buildout&rdquo;</li>
          <li><strong>Owner</strong>: the person accountable (not always the CEO)</li>
          <li><strong>Status</strong>: On Track (green), At Risk (yellow), Delayed (red)</li>
          <li><strong>Key milestone this month</strong>: what was supposed to happen, and did it?</li>
          <li><strong>Next milestone and date</strong>: what&rsquo;s coming in the next 30-60 days</li>
          <li><strong>Budget vs. actual spend</strong>: for capital-intensive initiatives</li>
          <li><strong>Blockers / board input needed</strong>: specific requests, not vague asks</li>
        </ul>

        <p>
          The initiative tracker is also where you surface opportunities that require board approval, an add-on acquisition, a significant capital expenditure, or a major pricing change. If you&rsquo;re evaluating bolt-on opportunities, tie this section to the economics framework in our article on{" "}
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li><strong>The two-page afterthought.</strong> The opposite extreme, a package so thin that directors walk into the meeting blind. If your board members spend the first 30 minutes asking basic questions about revenue and cash, your package failed.</li>
          ...
          <li><strong>Hiding bad news.</strong> Burying a revenue miss in a footnote or omitting a key metric when it trends negatively is the fastest way to lose board trust. When directors eventually discover the problem, and they will, your credibility suffers disproportionately. Surface problems early with a plan attached.</li>
          <li><strong>No specific asks.</strong> If you don&rsquo;t tell your board what you need from them, they&rsquo;ll default to asking whatever occurs to them in the moment. Include 2-3 crisp questions: &ldquo;Should we pursue the $200K equipment lease or purchase outright?&rdquo; is far more productive than &ldquo;Any thoughts on capex?&rdquo;</li>
          <li><strong>Late distribution.</strong> Sending the package the night before (or morning of) the meeting means directors haven&rsquo;t read it. They&rsquo;ll ask basic clarifying questions that eat into strategic discussion time. The standard in{" "}
            ...
            {" "}is distribution 5-7 business days before the meeting.</li>
          <li><strong>Confusing the package with the meeting deck.</strong> The board package is pre-reading material, it&rsquo;s not a slide deck you present live. The meeting itself should focus on discussion, decisions, and the 2-3 topics where you need real board engagement. If you find yourself reading the package aloud during the meeting, something broke.</li>
        </ol>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>Timing:</strong> Send the package 5-7 business days before the board meeting. This means your month-end close process needs to finish by the 10th-12th of the following month at the latest. If your close takes longer than 10 business days, prioritize{" "}
            ...
            {" "},  it&rsquo;s one of the highest-ROI operational improvements you can make.</li>
          <li><strong>Format:</strong> A single PDF is the gold standard. Board members read on laptops, tablets, and phones, a unified PDF renders reliably everywhere. Avoid sending separate Excel files or linking to live dashboards that require logins. If you use a board portal (e.g., Diligent, BoardEffect), upload the consolidated PDF there.</li>
          <li><strong>Length reminder:</strong> 8-12 pages for core content, plus an optional appendix up to 4 pages. If you consistently exceed this, ask yourself what you can cut, not what you can shrink to a smaller font.</li>
          <li><strong>Email framing:</strong> The cover email should be 3-4 sentences, not a second CEO letter. State the meeting date and time, confirm the agenda topics, and note anything in the package that requires a board vote or decision.</li>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Target 8-12 pages of core content. That typically breaks down as 1-1.5 pages for the CEO letter, 2-3 pages for financials, 1 page for the KPI dashboard, 1 page for strategic initiatives, and 0.5-1 page for people and organizational updates. Add an optional appendix of 2-4 pages for detailed schedules like AR aging or covenant calculations. The NACD&rsquo;s research consistently shows that packages longer than 20 pages reduce director engagement rather than increase it.
        </p>
