    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          tranches, each with different vesting conditions, as detailed in our <Link href="/learn/cap-tables-equity" className="text-apple-accent hover:underline">cap tables and equity guide</Link>. In a traditional
        ...
        <p>
          <Link href="/learn/self-funded-vs-traditional" className="text-apple-accent hover:underline">Self-funded searchers</Link> forgo institutional search capital in exchange
