  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>According to the AICPA&apos;s <em>Purchase Price Allocation Guide for M&amp;A Transactions</em>, the net present value of step-up tax benefits typically ranges from 10&ndash;20% of the total purchase price on a standard SME acquisition. For a $3 million deal, that can mean $300,000&ndash;$600,000 in present-value tax savings over the amortization period &mdash; a significant factor in determining the buyer&apos;s true <Link href="/learn/business-valuation" className="text-apple-accent hover:underline">effective acquisition cost</Link>.</p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <p>Deloitte&apos;s <em>Tax Considerations for Business Acquisitions</em> guide recommends engaging an independent valuation firm to perform the purchase price allocation, particularly for deals above $2M. The cost of a third-party valuation ($5,000&ndash;$20,000) is trivial compared to the multi-year tax savings it supports, and it provides a defensible position in the event of an IRS audit.</p>
      </div>
