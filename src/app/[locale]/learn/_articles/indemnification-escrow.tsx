...
export default function IndemnificationEscrowArticle() {
  return (
    <article>
      ...
      <p className={bodyClass}>
        For search fund acquisitions in the lower middle market ($5&ndash;25M enterprise value), typical escrow amounts range from 10&ndash;20% of the purchase price, held for 12&ndash;24 months. SRS Acquiom&rsquo;s 2023 M&amp;A Deal Terms Study found that the median escrow amount across private transactions was 10% of enterprise value with an 18-month hold period. For first-time search fund buyers, advocating for 15&ndash;20% held for 18&ndash;24 months is standard and appropriate given the concentrated risk. A common release structure is 50% at 12 months and the remaining 50% at 18 months, subject to holdback for any pending claims plus a 25&ndash;50% buffer.
      </p>

      <h3 className={h3Class}>Should a search fund buyer consider representations and warranties insurance?</h3>
      <p className={bodyClass}>
        R&amp;W insurance is increasingly relevant for search fund deals above $15M enterprise value. The insurance provides buy-side coverage for losses from seller rep breaches, with premiums typically running 3&ndash;6% of coverage limits. According to Woodruff Sawyer&rsquo;s 2023 market update, R&amp;W insurance policies have become available for deals as small as $10M, though minimum premiums of $150K&ndash;$200K make them less cost-effective below that threshold. The key benefit is competitive differentiation&mdash;offering to close with no or minimal escrow can win deals in competitive processes. R&amp;W insurance is particularly valuable when the seller is remaining in the business post-close, as it avoids the tension of pursuing indemnification claims against a colleague.
      </p>

      <h3 className={h3Class}>What is the difference between a tipping basket and a deductible basket?</h3>
      <p className={bodyClass}>
        The distinction is critical for buyer economics. With a deductible basket, the seller pays only losses exceeding the basket amount&mdash;if the basket is $100K and losses total $150K, the seller pays $50K. With a tipping basket, once losses exceed the threshold, the seller pays all losses from dollar one&mdash;in the same example, the seller would pay the full $150K. The ABA&rsquo;s Private Target M&amp;A Deal Points Study found that tipping baskets appear in approximately 55% of private company transactions and deductible baskets in 45%. Buyers should advocate strongly for tipping baskets, as they provide substantially better economic protection. Typical basket amounts range from 0.5&ndash;1.5% of enterprise value.
      </p>
