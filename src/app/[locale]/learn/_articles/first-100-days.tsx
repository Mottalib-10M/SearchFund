    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          you defer &mdash; during these early weeks will shape your
        ...
        <h2 className={h2Class}>Days 1&ndash;30: Listen, learn, and build trust</h2>
        <p>
          ...
          &mdash; it is to learn.
        </p>

        <h3 className={h3Class}>Week 1&ndash;2: Immersion</h3>
        ...
        <h3 className={h3Class}>Week 3&ndash;4: Mapping and assessment</h3>
        <ul className={ulClass}>
          <li><strong>Map the organization.</strong> Understand reporting lines, decision-making processes, and informal power structures. In many SMEs, the real power dynamics differ significantly from the formal hierarchy. Identify who the &ldquo;go-to&rdquo; people are &mdash; the employees others turn to for advice, institutional knowledge, or problem-solving.</li>
        ...
        <h2 className={h2Class}>Days 30&ndash;60: Diagnose and plan</h2>
        <p>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Identify flight risks.</strong> Some employees may be nervous about new ownership and considering departure. Identify the people you cannot afford to lose and take proactive steps to retain them &mdash; whether through compensation adjustments, expanded responsibilities, or simply a direct conversation about their future with the company.</li>
        </ul>

        <h3 className={h3Class}>Financial infrastructure</h3>
        <ul className={ulClass}>
          <li><strong>Review financial controls.</strong> Ensure accurate, timely financial reporting. Many SMEs have weak financial infrastructure &mdash; inconsistent bookkeeping, no monthly close process, limited cash flow visibility, and no formal budgeting. Establishing basic financial hygiene is one of the highest-value activities in the first 100 days.</li>
          ...
          and independent directors. Use them as a strategic resource. A well-functioning board provides governance, mentorship, and accountability &mdash; all of which are especially valuable for a first-time CEO.</li>
        ...
        <h2 className={h2Class}>Days 60&ndash;100: Execute first initiatives</h2>
        <p>
        ...
        <ul className={ulClass}>
          ...
          with these foundational tools. At minimum, you should have a monthly P&L, balance sheet, cash flow statement, and a dashboard tracking 5&ndash;10 key operating metrics.</li>
          ...
          should develop in parallel. A simple, clear strategic narrative &mdash; where we are, where we are going, and how we will get there &mdash; aligns the entire organization.</li>
        ...
        <ul className={ulClass}>
          <li><strong>Changing too much too fast.</strong> This is the single most common mistake new search fund CEOs make. You will lose the trust of employees and customers if they feel like the new owner is dismantling what they built. Every change has a cost &mdash; even good changes create disruption, uncertainty, and resistance. Pace yourself.</li>
          <li><strong>Ignoring the company culture.</strong> The culture is a key asset you paid for. Many search fund targets are successful precisely because of their culture &mdash; loyal employees, strong customer relationships, and a sense of identity. Disrupting the culture carelessly can trigger departures, morale problems, and customer defections that destroy more value than any operational improvement can create.</li>
          ...
          <li><strong>Underinvesting in the transition period with the seller.</strong> The seller knows things that are not written down anywhere &mdash; customer quirks, supplier relationships, employee dynamics, seasonal patterns. Cutting the seller&rsquo;s transition period short to save money is a false economy that can cost you dearly.</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Regular updates:</strong> Establish a weekly or biweekly communication rhythm &mdash; all-hands meetings, email updates, or informal walk-arounds. Consistency builds trust.</li>
        ...
        <ul className={ulClass}>
          <li><strong>Personal outreach to top accounts:</strong> Call or visit your top 10&ndash;20 customers within the first two weeks. Introduce yourself, express your commitment to the relationship, and ask what you can do better.</li>
          ...
          <li><strong>Listen for pain points:</strong> Customer conversations in the first month often surface issues the seller either did not know about or chose not to address. These insights are gold &mdash; they tell you where to focus improvement efforts for maximum impact.</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Monthly close process:</strong> Establish a formal monthly close with a target of producing complete financial statements within 15&ndash;20 business days of month-end. Many SMEs do not close their books monthly, which leaves the CEO operating blind.</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Plan the seller&rsquo;s departure carefully.</strong> The seller&rsquo;s final day is a significant moment for the company. Help them exit gracefully &mdash; with appropriate recognition and celebration of their contribution. How you handle their departure sends a powerful signal to employees about the kind of leader you intend to be.</li>
        ...
        <p>
          The first 100 days are not an end in themselves &mdash; they are the
