    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          revenue. Tax preparation clients return every year, not because
          ...
          result is annual client retention rates of 90-95% for well-run
        ...
        <p>
          ...
          areas. Sellers are often motivated by fatigue, they have
          survived another tax season and want out, and are willing to
        ...
        <p>
          ...
          provisions like loss carrybacks and credits. During the 2008-2009
        ...
        <p>
          A sole practitioner CPA typically manages 200-500 individual tax
          returns and 20-80 small business clients, generating
          $300K-$1.5M in annual revenue. These practices are the most
          common acquisition targets and offer the lowest entry prices. The
          primary risk is extreme key-person dependency, the owner is the
          ...
          structured transition period of 12-24 months, which we discuss
          in our guide on{" "}
          <Link href="/learn/management-transition" className="text-apple-accent hover:underline">management transitions</Link>.
        </p>

        <h3 className={h3Class}>Small firms (2-10 professionals)</h3>
        <p>
          Small firms with $1M-$5M in revenue represent the sweet spot for
        ...
        <p>
          ...
          construction, real estate, medical practices, nonprofits,
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            malpractice risk but generate premium fees ($15K-$100K+ per
          ...
          <li>
            ...
            revenue commands 2-3x the effective hourly rate of compliance
        ...
        <ul className={ulClass}>
          <li>
            ...
            accounting firms run at 55-65% utilization annualized, with
          ...
          <li>
            ...
            managers to staff. A well-used firm generates $300K-$500K
        ...
        <p>
          ...
          current, properly drafted engagement letters for all services , 
        ...
        <ul className={ulClass}>
          <li>
            ...
            the firm&rsquo;s professional liability insurance policy , 
        ...
        <ul className={ulClass}>
          <li>
            <strong>Tax and bookkeeping practices:</strong> 0.8x-1.2x
          ...
          <li>
            <strong>Audit and attest practices:</strong> 1.0x-1.4x annual
          ...
          <li>
            <strong>Advisory-heavy practices:</strong> 1.2x-2.0x annual
          ...
          <li>
            ...
            revenue and a professional staff, EBITDA multiples of 3x-6x
            are typical. Owner compensation must be carefully normalized , 
            many sole practitioners pay themselves $300K-$500K, significantly
            above the market rate for a replacement CPA ($120K-$200K).
        ...
        <ol className={olClass}>
          <li>
            <strong>60-70% at closing:</strong> Cash or bank-financed
            portion paid at close.
          </li>
          <li>
            <strong>20-30% seller note:</strong> A promissory note over
            3-5 years, often with an interest rate of 4-6%. This
            aligns the seller&rsquo;s incentives with a smooth transition.
          </li>
          <li>
            <strong>10-20% retention-based earnout:</strong> Payments
            contingent on client retention metrics, typically measured at
            12 and 24 months post-close. A standard threshold is 85-90%
            revenue retention.
          </li>
        </ol>
        <p>
          ...
          businesses attractive to lenders. Expect to contribute 10-20%
        ...
        <p>
          ...
          after closing. The following strategies, drawn from successful
          ETA operators, can dramatically increase revenue and margins
        ...
        <p>
          ...
          exclusively on compliance work. Their clients, small business
          owners, high-net-worth individuals, and growing companies, need
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            CFO. Monthly retainers of $2,000-$10,000 for financial
          ...
          <li>
            ...
            engagements command $10K-$50K+ per project and position the
        ...
        <p>
          ...
          representing 50-60% of revenue. Offshoring routine compliance
          work, individual tax preparation, bookkeeping data entry,
          payroll processing, to qualified teams in India, the
          Philippines, or Latin America can reduce labor costs by 40-60%
        ...
        <p>
          ...
          post-acquisition strategy. Small businesses with $2M-$20M in
          revenue frequently outgrow basic bookkeeping but cannot justify a
          $150K-$250K full-time CFO. A fractional CFO offering fills this
          gap at $2K-$10K per month. The accounting practice already
          ...
          $200K-$1M+ in high-margin annual recurring revenue within
          18-24 months of acquisition.
        </p>
        ...
        <p>
          ...
          practitioners or small firms at 0.8x-1.0x revenue and integrate
          ...
          $10M-$50M revenue platforms that command 8-12x EBITDA
          at exit, compared to the 3-5x paid for individual practices.
        </p>
        ...
        <p>
          ...
          suggests that well-managed transitions retain 85-95% of
          revenue, but poorly managed transitions can see 20-40% of
          revenue walk out the door within 18 months.
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Seller transition period:</strong> Require the selling CPA
            to remain actively involved for 12-24 months post-close.
          ...
          <li>
            ...
            announcement letter emphasizing continuity, same staff, same
            location, same phone number. Clients fear change; your message must
            neutralize that fear.
          </li>
          <li>
            <strong>Retention-based earnout:</strong> Tie 10-20% of the
        ...
        <ul className={ulClass}>
          <li>
            ...
            bonuses of 15-30% of annual compensation, vesting over
        ...
        <p>
          ...
          affect your deal structure. This is a threshold issue, if
        ...
        <p>
          ...
          owner is often the primary, and sometimes only , 
          ...
          individual, including yourself, is irreplaceable.
        </p>
        ...
        <p>
          ...
          The risks, client attrition, staff retention, and licensing
          complexity, are real but manageable with proper transition
        ...
        <p>
          Tax and bookkeeping practices typically sell for 0.8-1.2x
          annual revenue. Audit-focused firms command 1.0-1.4x due to
          ...
          reach 1.2-2.0x revenue or 5-8x EBITDA. Owner
          compensation must be normalized carefully, many sole
          practitioners pay themselves $300K-$500K, significantly above
          the replacement cost of $120K-$200K for a salaried CPA. For a
        ...
        <p>
          ...
          deeply personal, and when the trusted partner departs, 10-20%
          of clients may leave within the first 12 months if the transition
          is poorly managed. Mitigate this with a structured 12-24 month
