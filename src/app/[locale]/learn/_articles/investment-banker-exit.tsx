    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Timeline:</strong> Engage 6&ndash;9 months before your target close date</li>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Buyer relationships:</strong> Ask for a preliminary buyer list. A good banker should immediately name 15&ndash;20 likely buyers.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Success fee:</strong> Typically 3&ndash;5% of transaction value for deals under $25M; 1&ndash;3% for larger deals</li>
          <li><strong>Monthly retainer:</strong> $10&ndash;25K/month to cover the banker&apos;s time during the process (often credited against success fee)</li>
          <li><strong>Minimum fee:</strong> Most bankers have a minimum fee ($150&ndash;500K) regardless of deal size</li>
          <li><strong>Expense reimbursement:</strong> Travel, data room, and marketing materials are typically separate</li>
          <li><strong>Tail provision:</strong> The banker earns a fee on any sale to a buyer they introduced, typically for 12&ndash;24 months after engagement ends</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          <li><strong>Preparation (4&ndash;6 weeks):</strong> CIM creation, financial model, data room setup, buyer list</li>
          <li><strong>Marketing (4&ndash;6 weeks):</strong> Teaser distribution, NDA execution, CIM delivery</li>
          <li><strong>First round (3&ndash;4 weeks):</strong> Receive IOIs, evaluate and shortlist bidders</li>
          <li><strong>Management presentations (2&ndash;3 weeks):</strong> Meet with shortlisted buyers</li>
          <li><strong>Final bids (3&ndash;4 weeks):</strong> Receive LOIs, negotiate terms, select buyer</li>
          <li><strong>Due diligence &amp; closing (6&ndash;10 weeks):</strong> Buyer due diligence, definitive agreement, close</li>
        </ol>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Choose based on industry expertise, deal size fit, and senior banker commitment &mdash; not just the pitch</li>
          <li>Typical fees: 3&ndash;5% success fee plus $10&ndash;25K monthly retainer for sub-$25M deals</li>
          <li>Engage 6&ndash;9 months before your target close for optimal process management</li>
          <li>The entire sell-side process takes 6&ndash;9 months from engagement to close</li>
        </ul>
      </div>
