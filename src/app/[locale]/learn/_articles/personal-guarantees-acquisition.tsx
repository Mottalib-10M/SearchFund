    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>SBA guarantee vs. personal guarantee:</strong> The SBA guarantees the lender (75-85% of loan); your PG guarantees the SBA and lender against your personal assets</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Time-based release:</strong> PG expires after a set period (e.g., 3-5 years) regardless of loan balance, provided no defaults have occurred.
          </li>
          <li>
      ...
      <div className={bodyClass}>
        ...
        <p>
          In some states, you can use a &quot;spousal consent&quot; instead of a full guarantee, your spouse acknowledges the guarantee and consents to the lien on jointly owned property but doesn&apos;t become a full guarantor. Discuss this with your attorney.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Self-funded search with SBA:</strong> The searcher provides the full PG. This is the most personally risky model, you&apos;re guaranteeing the entire loan with limited investor backing.
          </li>
          <li>
            <strong>Pledge fund:</strong> Similar to traditional, the operating CEO guarantees while investors do not.
          </li>
        </ul>
        <p>
          Understanding PG implications is critical when evaluating <Link href="/learn/searcher-compensation" className="text-apple-accent hover:underline">searcher compensation</Link>, the personal guarantee is a real cost that should be factored into the overall economics.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          <li><strong>Asset protection planning:</strong> Before signing the PG, consult an asset protection attorney. Some strategies (trusts, entity structuring) can protect certain assets, but they must be implemented before the guarantee, not after.</li>
          ...
          <li><strong>Cash reserves:</strong> Maintain 3-6 months of personal living expenses separate from business accounts.</li>
          <li><strong>Debt service coverage:</strong> Never take on a loan where the business DSCR is below 1.25x. Higher is better, aim for 1.5x+.</li>
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li>Negotiated settlement is common, the{" "}
            ...
            notes that guarantors often settle for 50-80% of the outstanding balance when they engage experienced workout counsel early</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>PGs are unavoidable for most SME acquisition debt, focus on{" "}
      ...
      <div className={bodyClass}>
        <p>
          A burn-off provision reduces or eliminates your personal guarantee as the loan is repaid. For example, the PG might drop to 50% when the loan balance falls below 50% of the original amount, and release entirely at 25%. This is the single most valuable PG negotiation point because it creates a clear path to eliminating your personal risk. Without a burn-off, you remain fully liable for the entire loan term. Always negotiate burn-off provisions before signing, they are much harder to add after the fact.
        </p>
      </div>
