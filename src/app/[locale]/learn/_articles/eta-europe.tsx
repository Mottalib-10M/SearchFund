  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <h3 className={h3Class}>Spain, The Academic Epicenter</h3>
        <p>
        ...
        <p>
          ...
          remain early-stage for ETA: fewer than 15 traditional search funds have been raised in each country. But that scarcity creates opportunity, multiples in Southern Europe consistently sit at the low end of the European range (3-4x), and programs like SDA Bocconi in Milan and Nova SBE in Lisbon are building the next generation of searchers. The{" "}
        ...
        <p>
          The canonical US search fund model, two-year funded search, acquisition, and operation with a target IRR north of 30%, translates to Europe with important modifications. Understanding these differences is critical before you{" "}
          <Link href="/learn/finding-investors" className="text-apple-accent hover:underline">raise capital from investors</Link>.
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Fund sizes are smaller.</strong> The median US search fund raises $450K-$500K for the search phase and acquires companies with $1-$3M EBITDA. European funds typically raise &euro;250K-$400K and target &euro;500K-$2M EBITDA businesses, reflecting lower multiples and smaller average company size.
          </li>
          <li>
            <strong>Use is harder to source.</strong> US searchers rely heavily on SBA 7(a) loans (up to $5M, 10-year terms). No pan-European equivalent exists. Instead, searchers piece together bank debt (typically 2-3x EBITDA at EURIBOR + 250-400 bps), government-backed guarantees (BPI France, ICO Spain, KfW Germany, British Business Bank), and seller notes. Total use rarely exceeds 3x vs. 3.5-4x in the US.
          </li>
          <li>
          ...
          <li>
            <strong>Equity economics mirror the US.</strong> Despite structural differences, the stepped-equity model (25-30% to the searcher upon acquisition) is standard in European deals. Investor units convert at the same ratios. The alignment mechanism works the same way, the economics are portable even when the legal wrapper is not.
          </li>
        </ul>
        ...
        <ol className={olClass}>
          <li>
            <strong>Dedicated search fund investors</strong> (30-40 groups): These include firms like Search Fund Partners, Anacap, Relay Investments, and numerous family offices with repeat search fund exposure. They write checks of &euro;50K-$250K per unit and typically take board seats.
          </li>
          <li>
            <strong>Business school networks</strong>: IESE, INSEAD, and HEC alumni investors form tight referral loops. First-time searchers from these programs often raise 60-70% of their search capital from alumni within 90 days.
          </li>
          <li>
        ...
        <p>
          ...
          is increasingly popular in Europe. Self-funded searchers skip the fundraise entirely, search on personal savings or a small friends-and-family pool, and raise acquisition equity deal-by-deal. This approach sacrifices the safety net of a funded search salary but preserves more founder equity (often 50-70% post-close vs. 25-30% in a traditional model).
        </p>
        ...
        <ul className={ulClass}>
          <li><strong>Southern Europe (Spain, Italy, Portugal):</strong> 3-4.5x EBITDA</li>
          <li><strong>France:</strong> 3.5-5x EBITDA</li>
          <li><strong>Germany/DACH:</strong> 4-5.5x EBITDA</li>
          <li><strong>UK:</strong> 4.5-6x EBITDA</li>
          <li><strong>Nordics:</strong> 4-6x EBITDA</li>
          <li><strong>Benelux:</strong> 4-5x EBITDA</li>
          <li><strong>Eastern Europe:</strong> 2.5-4x EBITDA</li>
        </ul>
        <p>
          These ranges reflect &euro;500K-$3M EBITDA businesses. Below &euro;500K, multiples compress further; above &euro;3M, institutional PE competition pushes multiples toward US levels. Our{" "}
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Labor law:</strong> Dismissal protections, works councils, and collective bargaining agreements vary enormously. A restructuring that takes 30 days in the UK may take 12-18 months in France or Germany due to mandatory consultation procedures. Factor this into your post-acquisition operating plan.
          </li>
          <li>
        ...
        <ol className={olClass}>
          <li>
            <strong>Strategic sale to a larger corporate:</strong> The most common path. European industrial groups, particularly in Germany, France, and the Nordics, actively acquire bolt-on businesses in the &euro;2-$10M EBITDA range. Typical exit multiples: 6-9x EBITDA after 4-7 years of operation.
          </li>
          <li>
          ...
          <li>
            <strong>Secondary search fund sale or management buyout:</strong> A growing category in which the original searcher sells to another ETA operator or to the management team, often with seller financing. This path typically generates lower multiples (4-6x) but allows faster exits.
          </li>
        </ol>
        <p>
        ...
        <p>
          Most European search fund acquisitions target companies with &euro;500K-$2M EBITDA, translating to enterprise values of &euro;1.5M-$8M. The total equity raise (search + acquisition) typically ranges from &euro;1.5M to &euro;5M depending on the use available and the target&apos;s size.
        </p>
