  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          <Link href="/learn/eta-france" className="text-apple-accent hover:underline">France</Link> has the largest and most active search fund ecosystem in
        ...
        <p>
          The <Link href="/learn/eta-germany" className="text-apple-accent hover:underline">German Mittelstand</Link> represents a massive but harder-to-access opportunity.
        ...
        <p>
          The <Link href="/learn/eta-spain" className="text-apple-accent hover:underline">Iberian peninsula</Link> has a growing ETA community, supported by IESE
        ...
        <p>
          The <Link href="/learn/eta-uk" className="text-apple-accent hover:underline">UK</Link> benefits from strong professional services infrastructure and
        ...
        <ul className={ulClass}>
          ...
          <li><strong>IESE Business School</strong> — publishes the International Search Fund Study, whose findings are analyzed in our <Link href="/learn/european-search-fund-research" className="text-apple-accent hover:underline">European search fund research</Link> overview, and hosts the annual Search Fund Conference in Barcelona.</li>
