  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          Yes, but it requires specific structures. The traditional search fund model lets you acquire a business with as little as $0&ndash;$50K of personal capital because investors fund both the search and the acquisition equity. Outside of search funds, creative approaches like maximum seller financing (50&ndash;80% of purchase price), earn-in arrangements, and ROBS rollovers can dramatically reduce personal capital requirements, though truly zero-dollar deals are rare and require exceptional negotiation.
        </p>

        <h3 className={h3Class}>How much equity do I need for an SBA loan to buy a business?</h3>
        <p>
          SBA 7(a) loans require a minimum equity injection of 10&ndash;15% of the total project cost (purchase price plus fees). For a $1M business, that means $100K&ndash;$150K in equity. Seller financing can sometimes count toward the equity injection depending on the structure, which can reduce your personal cash outlay. The SBA guarantees up to $5M in loan value, making it the most popular financing tool for acquisitions under $5M.
        </p>

        <h3 className={h3Class}>What is the total cost of buying a business beyond the purchase price?</h3>
        <p>
          Plan for 15&ndash;25% above the purchase price in additional costs. This includes due diligence ($50K&ndash;$150K for Quality of Earnings, legal, and environmental reviews), transaction legal fees ($30K&ndash;$100K), lender fees (1&ndash;3% of loan amount), working capital reserves (2&ndash;3 months of operating expenses), and 3&ndash;6 months of personal living expenses. A good rule of thumb: budget 1.2x your equity injection to account for these extras.
        </p>
      </div>
    </article>
  );
