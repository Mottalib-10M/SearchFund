...
export default function ETAReadingListArticle() {
  return (
    <article>
      ...
      <p className="text-sm text-apple-gray-500 mt-3">2 min read</p>
      ...
      <div className={bodyClass}>
        <p>
          ...
          fund entrepreneur. Start with our own{" "}
          <Link href="/learn/getting-started" className="text-apple-accent hover:underline">getting started guide</Link> for
          a practical introduction to the search fund model.
        </p>

        <h2 className={h2Class}>Foundational studies</h2>
        <ul className={ulClass}>
          <li><strong>Stanford Search Fund Primer</strong> — The definitive introduction to the search fund model, published by Stanford&apos;s Center for Entrepreneurial Studies. Covers the benefits, challenges, structure, and execution of a search fund. For investor-focused insights, see{" "}
          <Link href="/learn/why-invest-in-search-funds" className="text-apple-accent hover:underline">why investors choose search funds</Link>.</li>
          <li><strong><Link href="/learn/stanford-2024-study" className="text-apple-accent hover:underline">2024 Stanford Search Fund Study</Link></strong> — The most comprehensive dataset on search fund performance, analyzing 681 funds from 1984-2023. Key findings: 35.1% IRR, 4.5x ROIC, 63% acquisition rate.</li>
          <li><strong>IESE International Search Fund Study</strong> — Extends the Stanford data to cover international (primarily European) search funds. See also our analysis of{" "}
          <Link href="/learn/european-search-fund-research" className="text-apple-accent hover:underline">European search fund research</Link>. Essential for understanding the European ETA landscape.</li>
