...
export default function TransitionServiceAgreementArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>TSA terms typically range from 3 to 24 months, depending on the complexity of services and the buyer&rsquo;s readiness to assume them. According to Deloitte&rsquo;s research on carve-out transactions, the median TSA duration is 12 months, with IT-related services often requiring the longest transition periods (12&ndash;18 months) due to the complexity of system migration. Payroll and HR functions typically transition in 3&ndash;6 months, while accounting and financial reporting may need 6&ndash;12 months. Best practice is to use staggered end dates for different services rather than a single expiration, with extension options available in 30- or 90-day increments at pre-agreed rates. Most sellers insist on a hard stop date of 18&ndash;24 months after which no extensions are available, creating urgency for the buyer to complete migration on schedule.</p>
      </div>

      <h3 className={h3Class}>How much does a TSA typically cost?</h3>

      <div className={bodyClass}>
        <p>TSA pricing most commonly follows a cost-plus model, where the seller charges actual cost of service delivery plus a 5&ndash;15% markup. PwC&rsquo;s research on TSA management reports that the total cost of a TSA typically represents 2&ndash;5% of the annual revenue of the acquired business. Pricing should address cost escalation for extensions &mdash; many agreements include a 10&ndash;25% step-up above the base rate for service extensions beyond the initial term, incentivizing the buyer to complete migration on schedule. Alternative pricing models include flat monthly fees (simpler to administer but may not reflect actual costs) and usage-based pricing tied to measurable metrics such as per-employee for HR services or per-transaction for IT. The buyer should also budget for the cost of building replacement systems in parallel with TSA services, which Ernst &amp; Young estimates at 1.5&ndash;3x the annual TSA cost for full separation.</p>
      </div>

      <h3 className={h3Class}>What is the most common mistake buyers make with TSAs?</h3>

      <div className={bodyClass}>
        <p>The most frequent and costly mistake is underestimating transition timelines. McKinsey &amp; Company&rsquo;s research on separation management shows that buyers routinely assume they can migrate off TSA services 30&ndash;50% faster than reality allows, particularly for IT system migrations. This optimism leads to costly extensions at step-up rates and, in worst cases, service disruptions when TSAs expire before replacement systems are fully operational. The second most common mistake is insufficient service descriptions &mdash; vague language like &ldquo;IT support&rdquo; or &ldquo;accounting services&rdquo; invites different interpretations and post-closing disputes. Every service should be described with enough specificity that a neutral third party could determine whether the obligation has been met. Building at least 50% buffer beyond initial timeline estimates and investing in detailed service schedules during negotiation prevents both problems.</p>
      </div>
