    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          7-8x, north of $35M in enterprise value. Geographic expansion is the
        ...
        <ol className={olClass}>
          <li>
            <strong>Market share saturation.</strong> Have you captured at least 15-20%
          ...
          <li>
            <strong>Management depth.</strong> Do you have a local leader, a general
            manager or operations director, who can run the home market while you
          ...
          <li>
            <strong>Financial headroom.</strong> Can you fund 12-18 months of
        ...
        <p>
          Most search fund acquisitions are in fragmented service industries, HVAC,
          pest control, managed IT, janitorial, home health, landscaping, where the
        ...
        <p>
          ...
          a field-service business consists of a local branch manager, 3-8 technicians,
          a small warehouse or staging area, and 1-2 service vehicles. The spoke
          relies on the hub for payroll, accounting, marketing, scheduling software,
          and strategic direction. This keeps spoke overhead at 15-25% of a
          fully standalone location.
        </p>
        <p>
          The hub-and-spoke model scales efficiently up to about 5-7 spokes before
          the hub itself needs a capacity upgrade, typically a dedicated VP of
        ...
        <ul className={ulClass}>
          <li>
            <strong>Typical startup cost:</strong> $75K-$250K depending on industry
            (lease, equipment, initial marketing, hiring costs, working capital).
          </li>
          <li>
            <strong>Revenue ramp:</strong> months 1-3 are essentially zero revenue
            while you recruit and build pipeline. Months 4-6, revenue begins
            trickling in at $15K-$40K/month. Months 7-12, a well-executed
            launch reaches $50K-$100K/month. Break-even typically arrives at
            month 12-18.
          </li>
          <li>
            <strong>Cumulative cash burn to break-even:</strong> $150K-$400K for
            most field-service businesses.
          </li>
          <li>
            <strong>Best suited for:</strong> markets within 60-90 minutes of an
        ...
        <ul className={ulClass}>
          <li>
            <strong>Typical acquisition cost:</strong> $400K-$2M for a
            $150K-$500K EBITDA local operator, purchased at 3-4.5x EBITDA.
          ...
          <li>
            ...
            customers, contracts, and employees. Revenue does not ramp, it transfers.
            The risk shifts from &ldquo;will customers come?&rdquo; to &ldquo;will customers
            stay?&rdquo;
          </li>
          <li>
            <strong>Integration cost:</strong> budget $50K-$150K for system migration,
        ...
        <p>
          ...
          ($200K-$400K EBITDA) to establish a beachhead, then grow that location
        ...
        <ul className={ulClass}>
          <li>
            <strong>HVAC / mechanical services:</strong> 12-16 months to break-even
            on greenfield. Revenue builds through seasonal cycles, a branch opened
            in Q1 benefits from summer cooling demand within months, but a Q3 opening may
            not see meaningful revenue until the following summer. Expect $500K-$800K
            annual revenue by end of year two.
          </li>
          <li>
            <strong>Pest control:</strong> 9-14 months. High recurring-revenue
            ...
            roughly $150K-$200K in annual recurring revenue.
          </li>
          <li>
            <strong>Managed IT / MSP:</strong> 14-20 months. Longer sales cycles
            (B2B, contract-based) slow the ramp, but monthly recurring revenue per client
            is high ($1K-$5K/month). Reaching 30-40 managed clients typically
            marks break-even.
          </li>
          <li>
            <strong>Landscaping / property maintenance:</strong> 6-10 months.
          ...
          <li>
            <strong>Home health / home care:</strong> 10-15 months. Regulatory
            requirements (state licensing, Medicare/Medicaid certification) can add
            3-6 months before you can serve a single patient. Once operational,
        ...
        <p>
          ...
          Miami. Before committing to a market, run a 30-60 day test campaign to
        ...
        <p>
          ...
          to enter than markets dominated by 2-3 well-capitalized regional players.
        ...
        <p>
          Running two locations is not twice as hard as running one, it is
        ...
        <p>
          ...
          above market (10-15% premium) and structure a meaningful bonus tied to
        ...
        <p>
          ...
          makes it possible to compare performance across locations, you cannot
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            develop their own culture, sometimes productively, often not.
          </li>
        </ul>
        ...
        <p>
          Each new location demands 15-25 hours per week of CEO attention during
          ...
          cadence: one new market every 9-12 months until you have a dedicated VP
        ...
        <p>
          ...
          reputation, and referral networks built over decades. Budget for 6-12
          months of aggressive local marketing ($3K-$8K/month for a field-service
        ...
        <p>
          ...
          $5K-$15K in legal and compliance costs per new state, and begin the
          licensing process 60-90 days before your planned launch.
        </p>
        ...
        <p>
          Most successful search fund operators wait 12-18 months. You need that
        ...
        <p>
          ...
          costs $150K-$400K in cumulative cash burn but preserves equity and gives
          you full cultural control. A bolt-on costs $400K-$2M upfront but
          delivers immediate revenue and eliminates the 12-18 month ramp period.
        ...
        <p>
          ...
          bonus (20-30% of base) tied to branch-level profitability. Start
          recruiting 60-90 days before launch so the manager can participate in
        ...
        <p>
          ...
          directly oversee 3-5 locations before needing a regional management layer.
          ...
          capital allocation. The constraint is not span of control, it is the
