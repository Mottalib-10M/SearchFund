  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            <a href="https://www.ifm-bonn.org/en/statistics/business-transfers" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">
              IfM Bonn (Institut f&uuml;r Mittelstandsforschung) &mdash; Business Transfer Statistics and Succession Research
            </a>
          </li>
          <li>
            <a href="https://www.kfw.de/About-KfW/Newsroom/Latest-News/Pressemitteilungen-Details_689792.html" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">
