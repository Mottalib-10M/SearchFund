  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>The BMKB significantly improves lending conditions for acquisitions where the buyer lacks sufficient collateral.</p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <p>ROMs typically invest &euro;250K&ndash;&euro;5M and can be valuable co-investors in acquisition structures.</p>
      </div>
