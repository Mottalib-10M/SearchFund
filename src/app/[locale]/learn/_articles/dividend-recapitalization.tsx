    ...
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Continued growth potential:</strong> You believe the business will be worth significantly more in 2-3 years</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Use:</strong> Total debt of 3-4x EBITDA (including existing debt)</li>
          <li><strong>Dividend size:</strong> Typically 1-2x EBITDA returned to equity holders</li>
          <li><strong>Debt terms:</strong> 5-7 year term, amortizing, with rates dependent on credit quality and market conditions</li>
          ...
          <li><strong>Typical timing:</strong> Most recaps occur 3-5 years post-acquisition, once the business has demonstrated stable cash flows under the new CEO&rsquo;s leadership</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Investor alignment:</strong> Not all investors may want a recap, some prefer to wait for a full exit at a higher valuation</li>
        </ul>
        <p>
          ...
          stress-testing the business against a 20-30% revenue decline
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Typical structure: 3-4x total use, 1-2x EBITDA returned as dividend</li>
          <li>The main risk is reduced financial flexibility, higher debt limits your ability to invest and weather downturns</li>
      ...
      <div className={bodyClass}>
        <p>
          ...
          2-3 years. Typical use is 3-4x EBITDA with
          1-2x EBITDA returned as a dividend. It is most common
          3-5 years post-acquisition when the CEO has demonstrated
      ...
      <div className={bodyClass}>
        <p>
          ...
          (0-20%) if the equity has been held for more than one year.
