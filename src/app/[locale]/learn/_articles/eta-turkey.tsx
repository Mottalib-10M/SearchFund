...
export default function ETATurkeyArticle() {
  return (
    <article>
      <h1 className={h1Class}>ETA in Turkey: Europe&rsquo;s Bridge to Asia</h1>
      <p className="text-sm text-apple-gray-500 mt-3">12 min read</p>

      <div className={bodyClass}>
        <p>
          Turkey occupies a singular position on the global map of{" "}
          <Link href="/learn/what-is-eta" className="text-apple-accent hover:underline">
            Entrepreneurship Through Acquisition
          </Link>. Straddling two continents with a GDP exceeding $900 billion,
          a young population whose median age is just 31, and more than 3.5
          million small and medium-sized enterprises, the country offers
        ...
        <h2 className={h2Class}>The Turkish economic context</h2>
        <p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Diversified economy:</strong> Automotive manufacturing
            (Europe&rsquo;s second-largest producer), textiles, agriculture,
            food processing, construction, tourism, financial services, and
            a rapidly growing technology sector.
          </li>
          <li>
            <strong>Export orientation:</strong> Over $250 billion in goods
            exported in 2023, with many mid-market manufacturers serving
            customers across Europe, the Middle East, and Africa.
          </li>
          <li>
            <strong>Infrastructure:</strong> Modern highways, Istanbul Airport
            (one of the world&rsquo;s largest hubs), high-speed rail, and
            expanding port capacity along three coastlines.
          </li>
        </ul>
        ...
        <p>
          ...
          majority are family-owned, founded during Turkey&rsquo;s rapid
          industrialization in the 1970s through 1990s. KOSGEB (the Small
          and Medium Enterprises Development Organization) and TOBB (Union
          of Chambers and Commodity Exchanges) data show that fewer than 30%
        ...
        <h2 className={h2Class}>The emerging ETA community</h2>
        <p>
          Turkey&rsquo;s ETA ecosystem is nascent but growing fast, catalyzed
          by several institutions:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Sabanc&inodot; University:</strong> An early champion of
            the search fund model. Faculty connections to IESE, Stanford,
            and Harvard have introduced ETA coursework, and the alumni
            network spans Turkey&rsquo;s business elite.
          </li>
          <li>
            <strong>Ko&ccedil; University:</strong> Ko&ccedil;&rsquo;s
            Graduate School of Business has incorporated ETA into its MBA
            program, and the Ko&ccedil; family&rsquo;s conglomerate history
            reinforces the acquisition-as-entrepreneurship narrative.
          </li>
          <li>
            <strong>TOBB ETU:</strong> With direct links to 365 chambers of
            commerce, TOBB University provides unmatched access to the
            Anatolian business community essential for deal sourcing.
          </li>
          <li>
            <strong>Returning diaspora:</strong> Turkish professionals from
            top global MBA programs are returning to pursue search funds,
            bringing international best practices and{" "}
            <Link href="/learn/finding-investors" className="text-apple-accent hover:underline">
              investor networks
            </Link>. This brain-gain phenomenon is a powerful accelerant.
          </li>
        </ul>

        <h2 className={h2Class}>Legal structures for acquisition</h2>
        <h3 className={h3Class}>Anonim &Scedil;irket (A.&Scedil;.)</h3>
        <p>
          ...
          restrict them, and governance is managed by a board of directors
          (y&ouml;netim kurulu).
        </p>

        <h3 className={h3Class}>Limited &Scedil;irket (Ltd.)</h3>
        <p>
          The limited liability form requires TRY 10,000 minimum capital and
          allows up to 50 shareholders. Share transfers need a general
          assembly resolution with 75% of capital represented and a simple
          majority, making it more restrictive. Most Turkish SMEs in the
          target range operate as Ltd. companies. A common approach is to
          purchase Ltd. shares and convert to an A.&Scedil;. post-close if
          governance flexibility is needed.
        </p>

        <h3 className={h3Class}>Holding company (NewCo) structure</h3>
        <p>
          The standard approach mirrors{" "}
        ...
        <h2 className={h2Class}>Financing an acquisition</h2>
        ...
        <h3 className={h3Class}>KOSGEB and KGF support</h3>
        <p>
          KOSGEB provides subsidized credit, grants, and loan guarantees for
          SME succession. The Kredi Garanti Fonu (KGF) offers
          government-backed guarantees that reduce bank lending risk and
          can materially improve terms for acquirers, partially offsetting
          the higher cost of Turkish debt.
        </p>
        ...
        <h2 className={h2Class}>Anatolian Tiger cities</h2>
        <p>
          Beyond Istanbul, the &ldquo;Anatolian Tiger&rdquo; cities offer
          lower costs, strong manufacturing clusters, and deep pools of
          family businesses approaching succession:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Gaziantep:</strong> Textiles, food processing, plastics,
          ...
          <li>
            <strong>Konya:</strong> Agricultural machinery, automotive parts,
            food processing, and construction materials in central Anatolia.
          </li>
          <li>
            <strong>Denizli:</strong> Turkey&rsquo;s textile capital,
            especially towels and home textiles, with significant European
            export volumes.
          </li>
          <li>
            <strong>Bursa:</strong> Automotive capital hosting Fiat, Renault,
        ...
        <h2 className={h2Class}>Target sectors and opportunities</h2>
        <ol className={olClass}>
          ...
          <li>
            <strong>Professional services:</strong> Engineering consultancies,
            logistics, facility management, IT services, and healthcare with
            recurring revenue and high margins.
          </li>
          <li>
            <strong>Food and agriculture:</strong> A major global producer of
            hazelnuts, dried fruits, grains, and processed foods, with
            family-owned processors serving domestic and export markets.
          </li>
          <li>
            <strong>Construction materials:</strong> Building materials,
            fixtures, and chemicals benefiting from domestic demand and
            Middle Eastern/African export growth.
          </li>
        </ol>

        <h2 className={h2Class}>Cultural considerations</h2>
        <p>
          Turkish business culture is warm, relationship-driven, and shaped
          by traditions of hospitality and personal honor. Success in Turkish
          ETA requires genuine cultural engagement:
        </p>
        <ul className={ulClass}>
          <li>
            <strong>Relationship primacy:</strong> Owners will not sell to
            someone they do not trust. Multiple face-to-face meetings, shared
            meals, and genuine interest in the business are non-negotiable.
            The concept of &ldquo;g&uuml;ven&rdquo; (trust) is foundational.
          </li>
          <li>
          ...
          <li>
            ...
            family, accountant (mali m&uuml;&scedil;avir), and advisors all
            involved. Hard deadlines are counterproductive.
          </li>
          <li>
            <strong>Language:</strong> Turkish fluency is a major advantage
            and often essential for Anatolian deals. Even basic Turkish
            demonstrates respect and commitment.
          </li>
          <li>
            <strong>Regional diversity:</strong> Cosmopolitan Istanbul differs
            from conservative Anatolian cities, and the Aegean coast culture
            differs from the Black Sea region.
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Currency volatility:</strong> The lira fell from roughly
            1.5 per dollar in 2010 to over 30 recently. Model multiple
            scenarios and prioritize targets with natural hedges.
          </li>
          <li>
            <strong>Regulatory complexity:</strong> Frequent changes to tax
            rules, foreign investment rules, and sector requirements. The
            SPK, BDDK, and Rekabet Kurumu all play roles depending on the
            deal. Experienced local counsel is essential.
          </li>
          <li>
            <strong>Informal economy:</strong> Some SMEs maintain parallel
            informal accounts. Insist on independent verification of
            revenues, customers, and tax compliance during due diligence.
          </li>
          <li>
            <strong>Geopolitical risk:</strong> Proximity to conflict zones
            and periodic EU/NATO tensions can affect sentiment and currency,
            though daily operations are rarely disrupted.
          </li>
          <li>
            <strong>Inflation:</strong> Elevated inflation creates pricing,
            working capital, and modeling challenges. Prioritize businesses
            with pricing power and cost pass-through ability.
          </li>
        </ul>

        <h2 className={h2Class}>Tax regime overview</h2>
        <ul className={ulClass}>
          <li>
            <strong>Corporate income tax:</strong> 25% on worldwide income.
            Reduced rates in Technology Development Zones and Free Zones.
          </li>
          <li>
          ...
          <li>
            <strong>Withholding taxes:</strong> 10% on dividends to
            non-residents, reducible under 80-plus double taxation treaties.
          </li>
          <li>
            <strong>VAT:</strong> 20% standard rate, with reduced rates of
            10% and 1% for specified goods and services.
          </li>
          <li>
            <strong>Investment incentives:</strong> Tax reductions and social
            security support for qualifying investments, with enhanced
            incentives in eastern and southeastern Turkey.
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>TOBB chambers:</strong> 365 local chambers deeply
            embedded in their communities can facilitate introductions to
            owners considering succession.
          </li>
          <li>
            <strong>Industry associations:</strong> T&Uuml;S&Idot;AD,
            M&Uuml;S&Idot;AD, and T&Uuml;RKONFED provide access to
            business networks and signal credibility.
          </li>
          <li>
            <strong>University alumni:</strong> Sabanc&inodot;, Ko&ccedil;,
            Bo&gbreve;azi&ccedil;i, and Bilkent networks span the Turkish
            business community and yield warm introductions.
          </li>
          <li>
            <strong>Direct outreach:</strong> Turkish culture can be
            receptive to respectful approaches referencing mutual connections
            and genuine interest in the owner&rsquo;s story and legacy.
          </li>
        </ul>

        <h2 className={h2Class}>Practical advice for searchers</h2>
        <ol className={olClass}>
          <li>
            <strong>Establish local presence:</strong> Istanbul for capital
            markets and professional services, with regular Anatolian travel
            for deal sourcing and relationship-building.
          </li>
          <li>
            <strong>Invest in language:</strong> Even basic Turkish fluency
            opens doors and demonstrates commitment.
          </li>
          <li>
            <strong>Prioritize export-oriented targets:</strong> Hard-currency
            revenues hedge against lira depreciation and command premium
            exit valuations.
          </li>
          <li>
            <strong>Stress test currency:</strong> Build financial models
            with multiple exchange-rate assumptions, including severe
            depreciation scenarios.
          </li>
          <li>
            <strong>Engage top-tier advisors:</strong> A leading law firm,
            experienced mali m&uuml;&scedil;avir, and international
        ...
        <p>
          Combined with its unique position bridging European and{" "}
          <Link href="/learn/eta-middle-east" className="text-apple-accent hover:underline">
            Middle Eastern
          </Link>{" "}
