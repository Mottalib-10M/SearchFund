...
export default function DDRedFlagsArticle() {
  return (
    <article className="prose prose-lg max-w-4xl mx-auto">
      ...
      <p className={bodyClass}>
        Stanford GSB&rsquo;s search fund research and data from the International Business Brokers Association identify five red flags that most frequently lead to deal termination: quality of earnings findings showing EBITDA more than 15&ndash;20% below seller representations, single-customer revenue concentration above 30% without long-term contracts, material seller misrepresentations discovered during diligence, key person dependency where customer relationships are untransferable, and structural revenue decline over two or more consecutive years. Pacific Lake Partners&rsquo; due diligence data shows that approximately 40&ndash;50% of deals that reach the LOI stage ultimately fail to close, with financial discrepancies and customer concentration being the two most common causes. The searchers with the best long-term outcomes are those who maintain strict kill criteria and walk away rather than rationalizing problematic findings.
      </p>
