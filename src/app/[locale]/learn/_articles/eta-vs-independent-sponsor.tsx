    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          businesses, but they differ sharply in how capital is raised, how operators
        ...
        <p>
          ...
          {" "}raises $400K-$600K in search capital from 10-20 investors before
          ...
          searcher&rsquo;s salary ($80K-$120K per year), travel, legal fees, and CRM
          tools over an 18-24-month search window. When the searcher finds a target,
          search investors hold pro rata rights to fund the acquisition equity, their
        ...
        <p>
          ...
          source equity from family offices and 81% from high-net-worth individuals, a
        ...
        <p>
          <strong>Search fund economics.</strong> Searchers earn 20-25% of common
          equity, vesting in tranches: roughly one-third at closing, one-third at
          employment milestones over 3-5 years, and one-third tied to investor IRR
          hurdles (commonly 25-35% IRR gates). The Stanford 2024 study reported that
        ...
        <p>
          ...
          deal-by-deal, and the McGuireWoods 2024 Independent Sponsor Deal Survey, drawing
          on over 300 transactions, reveals three standard components:
        </p>
        <ol className={olClass}>
          <li>
            <strong>Closing fee:</strong> 1-3% of enterprise value at closing. Most
          ...
          <li>
            ...
            (72% of EBITDA-based structures fall in the 5-5.99% range, per
            McGuireWoods). Annual fees range from $50,000 to $500,000+ depending on
            company size.
          </li>
          <li>
            <strong>Carried interest:</strong> 15-25% promote after investors receive
        ...
        <p>
          ...
          A self-funded searcher who spends $150K-$300K out of pocket over 12 months
        ...
        <h2 className={h2Class}>Deal Size: $1-5M EBITDA vs. $5-25M EBITDA</h2>
        <p>
        ...
        <p>
          ...
          software, industries that together represent 72% of search fund acquisitions.
        ...
        <p>
          ...
          to McGuireWoods&rsquo; 2024 survey, but the ceiling is far higher, deals
        ...
        <p>
         ...
         , senior debt, mezzanine, seller notes, and multiple equity tranches. They
          ...
          of all closed deals on the platform, the highest share of any buyer type,
        ...
        <p>
          A traditional search fund investor writes a $35K-$50K check per unit
          ...
          The investor ecosystem is specialized, roughly 100-150 active search
        ...
        <p>
          Independent sponsor capital partners commit larger checks ($500K-$10M+
          ...
          proprietary outreach, a significantly more diversified sourcing approach
        ...
        <p>
          ...
          especially important role on the independent sponsor side, we explore that
          relationship in{" "}
        ...
        <p>
          ...
          and capital allocators, and enough personal capital to sustain 12-24
          ...
          acquisitions, a strategy rarely seen in single-acquisition search funds.
        </p>
        <p>
        ...
        <p>
          A self-funded searcher targets smaller deals ($2M-$15M enterprise value,
          $500K-$3M EBITDA), funds the search from personal savings ($50K-$300K),
          and raises acquisition capital deal-by-deal, just like an independent
          sponsor. But self-funded searchers almost always intend to serve as full-time
          CEO, holding 60-80% of equity, which looks more like a traditional
        ...
        <p>
          ...
          working-capital pool ($200K-$500K) to fund sourcing and diligence,
          ...
          where you fall on this spectrum, operator vs. investor, single deal vs.
          repeat dealmaker, determines which structure best serves your goals.
        </p>
        <p>
        ...
        <ol className={olClass}>
          <li>
            <strong>Financial runway.</strong> Can you sustain 12-24 months with no
          ...
          <li>
            <strong>Target deal size.</strong> Businesses with $1-3M EBITDA are
          ...
          <li>
            ...
            for 5-7+ years. Independent sponsors can install management and serve
          ...
          <li>
            <strong>Equity appetite.</strong> Traditional searchers earn 20-25% equity
            with significant vesting constraints. Self-funded searchers retain
            60-80%. Independent sponsors take 15-25% carry plus fees. Run the
            math on a specific deal size to see which structure maximizes your
            total compensation over a 5-7-year hold.
          </li>
        </ol>
        ...
        <p>
          ...
          acquisition for 5-7 years, a successful exit provides both the capital
          ...
          {" "}average 4.5x ROI for investors, capital partners who participated in a
        ...
        <p>
          ...
          versus 20% for PE funds. The trade-off is closing certainty, without
        ...
        <p>
          ...
          higher, self-funding $150K-$300K in search costs with no guarantee of a
        ...
        <p>
          ...
          and its $35K-$50K per-unit economics. Independent sponsor capital
          partners are typically family offices and high-net-worth individuals
          writing $500K-$10M+ checks per deal. The McGuireWoods 2024 survey
          confirmed that the independent sponsor capital partner ecosystem has
          grown substantially, with over 300 transactions surveyed, but the
