    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          capital, in a traditional search fund, the investors fund
        ...
        <p>
          In a traditional search fund, investors provide $400K-$600K
        ...
        <ul className={ulClass}>
          <li><strong>Searcher salary:</strong> $80K-$120K per year (typically 18-24 months = $120K-$240K total)</li>
          <li><strong>Health insurance:</strong> $10K-$25K per year</li>
          <li><strong>Legal formation:</strong> $15K-$40K (entity creation, PPM drafting, subscription agreements)</li>
          <li><strong>Travel:</strong> $15K-$30K per year (visiting businesses, meeting sellers)</li>
          <li><strong>Office/co-working:</strong> $3K-$12K per year</li>
          <li><strong>Technology &amp; tools:</strong> $2K-$5K per year (CRM, databases, research subscriptions)</li>
          <li><strong>Deal expenses:</strong> $5K-$15K per LOI (legal review, preliminary diligence)</li>
          <li><strong>Accounting:</strong> $5K-$10K per year (fund accounting, tax prep)</li>
        </ul>
        <p>
          <strong>Total search capital:</strong> $400K-$600K for an
          18-24 month search. If the search extends beyond the
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Income gap:</strong> Search fund salary ($80K-$120K) is often 30-50% below what MBA grads could earn in consulting, banking, or tech</li>
          ...
          <li><strong>Personal financial runway:</strong> 3-6 months of living expenses as a safety net</li>
        </ul>
        ...
        <p>
          ...
          equity (often 50-100%) but need more personal capital.
        </p>

        <h3 className={h3Class}>Part-time search (while employed)</h3>
        <ul className={ulClass}>
          <li><strong>Monthly cash costs:</strong> $500-$2,000/month (tools, travel, database subscriptions, broker meals)</li>
          <li><strong>Legal:</strong> $5K-$15K for entity formation and initial LOI review</li>
          <li><strong>Total over 12-24 months:</strong> $10K-$50K personal investment</li>
        ...
        <ul className={ulClass}>
          <li><strong>Living expenses:</strong> 6-18 months of personal runway ($30K-$100K+)</li>
          <li><strong>Search expenses:</strong> $15K-$40K (travel, tools, legal, database access)</li>
          <li><strong>Total personal investment:</strong> $50K-$150K</li>
          <li><strong>Key advantage:</strong> Full-time focus typically compresses the search by 6-12 months</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            ...
            $20K-$80K (the most expensive DD item)
          </li>
          <li><strong>Legal due diligence:</strong> $15K-$50K (contract review, IP, employment)</li>
          <li><strong>Environmental assessment:</strong> $5K-$15K (Phase I, if applicable)</li>
          <li><strong>Other specialists:</strong> $5K-$20K (IT, real estate, insurance review)</li>
        </ul>

        <h3 className={h3Class}>Transaction costs</h3>
        <ul className={ulClass}>
          <li><strong>Legal (purchase agreement):</strong> $30K-$100K for buyer&rsquo;s counsel</li>
          <li><strong>Lender fees:</strong> 1-3% of loan amount (SBA guarantee fees, origination)</li>
          <li><strong>Title/escrow:</strong> $2K-$10K</li>
          <li><strong>R&amp;W insurance (if used):</strong> 2-4% of coverage limit</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li>
            ...
            acquisition equity. Searcher invests $0-$50K personal
          ...
          <li>
            ...
            10-15% equity injection required ($50K-$500K
        ...
        <ul className={ulClass}>
          <li><strong>Personal cash needed:</strong> $0-$50K</li>
          <li><strong>Investor capital (search):</strong> $400K-$600K</li>
          <li><strong>Investor capital (acquisition equity):</strong> $2M-$10M+</li>
          <li><strong>Your cost:</strong> Opportunity cost + income gap for 2-3 years</li>
        </ul>

        <h3 className={h3Class}>Self-funded (part-time)</h3>
        <ul className={ulClass}>
          <li><strong>Personal cash needed:</strong> $10K-$50K (search) + $50K-$200K (equity injection)</li>
          <li><strong>Total personal investment:</strong> $60K-$250K</li>
          <li><strong>Your reward:</strong> 50-100% equity ownership</li>
        </ul>

        <h3 className={h3Class}>Self-funded (full-time)</h3>
        <ul className={ulClass}>
          <li><strong>Personal cash needed:</strong> $50K-$150K (search + living) + $50K-$200K (equity injection)</li>
          <li><strong>Total personal investment:</strong> $100K-$350K</li>
          <li><strong>Your reward:</strong> 50-100% equity ownership + faster timeline</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Negotiate QoE costs:</strong> Get 3 quotes; smaller regional CPA firms charge $20K-$35K vs. Big 4 at $50K-$80K</li>
          <li><strong>Use{" "}
            <Link href="/learn/seller-financing" className="text-apple-accent hover:underline">
              seller financing
            </Link>{" "}
            to reduce equity needs:</strong> A 10-20% seller note reduces your equity injection</li>
        ...
        <p>
          ...
          the median successful search fund CEO earns $5M-$15M+
          over the lifecycle of the fund. For self-funded searchers who
          acquire a business at 4-5x EBITDA and grow it over
          5-7 years, the personal wealth creation can be
        ...
        <p>
          ...
          effectively $0, investors fund the entire search and
          acquisition. Some investors request $10K-$50K as &ldquo;skin
          in the game,&rdquo; but it is not universal. For self-funded
          searchers using SBA financing, the minimum equity injection is
          typically 10-15% of the deal size, meaning a $2M acquisition
          requires $200K-$300K in personal or investor equity.
        </p>
        ...
        <p>
          ...
          acquisitions command higher multiples (4-8x ARR) but have
          lower ongoing capex. Home services and business services trade at
          lower multiples (3-6x EBITDA) but may require working capital
        ...
        <p>
          ...
          adjustments at closing ($50K-$200K), post-acquisition
          technology and system upgrades ($20K-$100K), key employee
          retention bonuses ($25K-$75K), and the personal income gap
          during the 2-3 year search-to-stabilization period. Building
          a realistic{" "}
