    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          dispersion, about a third of investments lose money.
        ...
        <ul className={ulClass}>
          <li><strong>Aggregate pre-tax IRR:</strong> 33.0% (all funds 1984-2022)</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>~33% return 1-3x:</strong> Modest returns, roughly comparable to public equities</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Private equity (buyout):</strong> 15-20% net IRR for top-quartile funds. Search funds outperform on IRR but with smaller absolute check sizes</li>
          <li><strong>Venture capital:</strong> 20-30% for top-quartile funds. Similar return profile but search funds invest in profitable businesses, not pre-revenue startups</li>
          <li><strong>Real estate:</strong> 8-15% total returns. Lower risk, lower return, more liquid. See{" "}
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Multiple expansion:</strong> Growing EBITDA above $5M often commands 2-3 higher turn multiples at exit</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Search phase investment:</strong> $30K-$50K per unit (typically 10-20 investors contribute $400K-$600K total)</li>
          <li><strong>Step-up conversion:</strong> At acquisition, search capital converts at 1.5x, meaning $30K buys $45K worth of acquisition equity</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Illiquidity:</strong> 5-7+ year hold period with no secondary market</li>
          <li><strong>Small check sizes:</strong> $30K-$50K search investment + $200K-$500K acquisition equity. For large allocators, deploying meaningful capital requires many investments</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>High-net-worth individuals:</strong> $30K-$50K per search fund fits angel/venture allocation budgets</li>
        ...
        <p>
          ...
          illiquidity (5-7+ year hold), and small check sizes.
        ...
        <p>
          ...
          IRR basis (33% vs. 15-20% for top-quartile PE), though with
          smaller absolute check sizes and higher dispersion. Unlike PE,
          search funds invest in profitable businesses at 4-6x EBITDA
