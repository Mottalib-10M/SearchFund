  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Insurance is one of the most underappreciated elements of any business acquisition. Buyers spend weeks negotiating purchase price, months on financial and legal due diligence, and often devote just a few hours to understanding the target&apos;s insurance coverage, and their own exposure as a new owner. Yet the wrong insurance structure (or missing coverage altogether) can wipe out an acquisition&apos;s returns in a single claim. From directors and officers (D&amp;O) liability to representations and warranties (R&amp;W) insurance, understanding the professional liability market is essential for any searcher or investor involved in M&amp;A transactions.</p>
      ...
      <div className={bodyClass}>
        ...
        <p>The cost of tail coverage is usually a one-time premium equal to 150-300% of the annual D&amp;O premium. This cost is typically borne by the seller or shared between buyer and seller, and it should be addressed explicitly in the purchase agreement. Failing to secure tail coverage can expose outgoing directors to personal liability and create significant friction in negotiations.</p>
      </div>

      <h2 className={h2Class}>Errors &amp; Omissions (E&amp;O) Insurance</h2>
      <div className={bodyClass}>
        <p>Errors and omissions insurance, also known as professional liability insurance in the narrower sense, protects businesses and their employees against claims of negligent or inadequate professional services. E&amp;O coverage is essential for any acquisition target that provides professional advice, consulting, technology services, accounting, legal services, healthcare, financial planning, or similar knowledge-based services.</p>
        ...
        <p>To address this gap, buyers should require either continuation of the existing E&amp;O policy or purchase of an extended reporting period (ERP) endorsement, commonly known as tail coverage. The ERP gives the insured the right to report claims for a specified period (typically 1 to 5 years) after the policy expires. For professional services firms, this tail coverage is non-negotiable.</p>
      ...
      <div className={bodyClass}>
        ...
        <p>R&amp;W insurance premiums typically range from 2% to 4% of the policy limit for transactions in the lower middle market. The policy limit is usually set at 10-20% of the enterprise value, though this varies by deal. Retention amounts (similar to a deductible) are typically 1-2% of the enterprise value and are often shared between the buyer and seller or step down over time. The underwriting process takes 2 to 4 weeks and includes a review of the data room, the purchase agreement, and the buyer&apos;s due diligence findings.</p>
        <p>For search fund-sized deals (enterprise values of $5M-$30M), R&amp;W insurance has historically been less common because the minimum premiums ($150K-$250K) represented a significant percentage of deal value. However, the market has evolved, and several insurers now offer streamlined products for smaller transactions with minimum premiums as low as $50K-$100K. This has made R&amp;W insurance increasingly accessible for entrepreneurship through acquisition.</p>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>D&amp;O insurance:</strong> For a private company with $5M-$30M in revenue, annual D&amp;O premiums typically range from $5,000 to $25,000 for $1M-$5M in coverage. Higher-risk industries (financial services, healthcare, technology) and companies with complex cap tables or investor boards will be at the upper end.</li>
          <li><strong>E&amp;O insurance:</strong> Professional services firms typically pay 1-3% of revenue in E&amp;O premiums. A consulting firm with $5M in revenue might pay $50,000-$150,000 annually for adequate E&amp;O coverage. Technology companies often fall in the 0.5-2% range.</li>
          <li><strong>R&amp;W insurance:</strong> Premiums of 2-4% of the policy limit, with a minimum premium of $50,000-$250,000 depending on the insurer and deal complexity. A $15M deal with a $3M R&amp;W policy limit might cost $60,000-$120,000 in premium.</li>
          ...
          <li><strong>Employment practices liability (EPLI):</strong> Annual premiums of $2,000 to $15,000 for small businesses with 10-100 employees. Companies in litigious states (California, New York, New Jersey) pay higher premiums.</li>
        </ul>
        <p>When building your financial model, budget insurance costs as a percentage of revenue (typically 0.5-2% for most industries) and then refine this estimate during due diligence with actual quotes from brokers. Post-acquisition insurance costs often increase relative to the seller&apos;s historical costs because the buyer typically purchases broader coverage and higher limits than the previous owner maintained.</p>
      </div>
