  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>The opportunity is real: research from the Stanford GSB <em>2024 Search Fund Study</em> shows that top-quartile search fund operators who invested early in marketing and sales capabilities grew revenue 2&ndash;3x faster than peers in the first three years of ownership. The key is sequencing investments correctly so that early spending generates measurable ROI before you commit larger budgets.</p>
      </div>
      ...
      <div className={bodyClass}>
        <p>A practical starting budget is 3&ndash;5% of revenue, which is below the 7&ndash;10% benchmark for growth-stage companies but realistic for a newly acquired SME. Allocate the first $2,000&ndash;5,000/month to the highest-ROI channels: Google Business Profile optimization, Google Ads on high-intent keywords, and a website refresh. As you prove ROI on those channels, increase spend incrementally rather than committing a large budget upfront.</p>
      </div>

      <h3 className={h3Class}>Should I rebrand after acquiring a company?</h3>
      <div className={bodyClass}>
        <p>In most cases, no. The existing brand carries customer recognition, search engine authority, and local reputation that took years to build. The primary exceptions are when the business is named after a departing owner or when the brand has an actively negative reputation. A visual refresh &mdash; updated logo, modernized colors, a new website &mdash; is almost always preferable to a full rebrand and preserves accumulated goodwill.</p>
      </div>

      <h3 className={h3Class}>When should I hire a full-time marketing person vs. using an agency?</h3>
      <div className={bodyClass}>
        <p>For businesses under $10M in revenue, agencies and freelancers are more cost-effective because they bring specialized expertise across multiple channels without the overhead of a full-time salary and benefits. Once you reach $10&ndash;15M in revenue and are spending $15,000+ per month on marketing, a dedicated marketing manager pays for itself through better agency oversight, faster execution, and strategic continuity. The marketing manager coordinates external resources rather than replacing them.</p>
      </div>
