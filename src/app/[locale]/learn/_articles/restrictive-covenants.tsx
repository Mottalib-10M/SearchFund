...
export default function RestrictiveCovenantsArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Garden leave is a concept borrowed from UK employment law that is increasingly used in US M&amp;A transactions, particularly where the seller is expected to remain involved during a transition period. Under a garden leave provision, the seller remains &ldquo;employed&rdquo; (or engaged as a consultant) and continues to receive compensation, but is not required to (and may not) perform active work. The seller is literally &ldquo;in the garden&rdquo;, paid to stay home and not compete.</p>
