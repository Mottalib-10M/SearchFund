  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>When negotiating the duration, consider the target&apos;s customer contract lengths, the typical customer acquisition cycle, and how long it would take a competitor to replicate the business&apos;s market position. The non-compete should last long enough to allow the buyer to solidify relationships with customers and employees &mdash; a critical element of the <Link href="/learn/management-transition-plan" className="text-apple-accent hover:underline">management transition plan</Link>.</p>

        <h3 className={h3Class}>Geographic scope</h3>
        <p>The geographic scope of a non-compete should correspond to the market area in which the target business actually operates. For a local home services business, a 50-mile radius may be appropriate. For a regional professional services firm, the restriction might cover several states. For a business with national or international clients, broader geographic restrictions may be necessary, though courts will scrutinize whether the full scope is reasonable given the actual competitive landscape.</p>
      ...
      <div className={bodyClass}>
        ...
        <ol className={olClass}>
          ...
          <li><strong>Address indirect competition:</strong> Restrict not only the seller&apos;s direct involvement in competing businesses but also indirect involvement through family members, trusts, holding companies, or advisory roles. Define &ldquo;affiliate&rdquo; broadly to prevent circumvention.</li>
      ...
      <ul className={ulClass}>
        ...
        <li><Link href="/learn/management-transition-plan" className="text-apple-accent hover:underline">Management Transition Plan</Link></li>
