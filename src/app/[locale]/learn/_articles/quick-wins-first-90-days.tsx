...
export default function QuickWinsFirst90DaysArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Price increases:</strong> Many owner-operated businesses haven&apos;t raised prices in years. A 3-5% increase across the board often encounters minimal customer pushback and drops straight to the bottom line.</li>
          <li><strong>Renegotiate vendor contracts:</strong> Insurance, telecom, supplies, and services often have room for 10-20% savings. Get competitive quotes immediately.</li>
          ...
          <li><strong>Eliminate owner add-backs:</strong> Personal expenses, excessive salaries for family members, unused subscriptions, clean up discretionary spend.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Fix the #1 employee complaint:</strong> Ask every employee what frustrates them most. Fix the top issue, whether it&apos;s a broken piece of equipment, a confusing process, or an outdated policy.</li>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          <li><strong>Days 1-14:</strong> Listen, observe, and identify opportunities. Call top customers. Fix the #1 employee complaint.</li>
          <li><strong>Days 15-30:</strong> Implement price increases. Start vendor renegotiations. Launch AR collection effort. Set up cash flow forecast.</li>
          <li><strong>Days 31-60:</strong> Technology upgrades. Website refresh. Implement weekly meetings and basic KPI tracking.</li>
          <li><strong>Days 61-90:</strong> Address compensation gaps. Begin SOP documentation. Share results of quick wins with the team.</li>
        </ol>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Quick wins build credibility and momentum, start with high-impact, low-risk improvements</li>
          ...
          <li>Share your quick wins openly, visible progress energizes everyone for larger changes ahead</li>
        </ul>
      </div>
