    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          States, the vast majority generating $1&ndash;10M in revenue. Aging
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Economic sensitivity:</strong> Temp staffing is among the first expenses companies cut in a downturn. ASA data shows that industry revenue declined approximately 26% during the 2008&ndash;2009 recession, though contract staffing was more resilient than temporary placement</li>
        ...
        <p>
          ...
          typically trade at 3&ndash;5x EBITDA because of lower margins and
          high working capital requirements. Direct hire and permanent
          placement agencies sell for 2&ndash;4x due to volatile, project-based
          revenue. Contract and professional staffing agencies &mdash; which
          combine higher margins with recurring billings &mdash; command
          4&ndash;6x EBITDA. Niche specialization in sectors like healthcare
          IT, accounting, or engineering can push multiples 1&ndash;2 turns
        ...
        <p>
          ...
          challenge. Top billers generate disproportionate revenue &mdash;
          losing two or three key recruiters can cut revenue by 30&ndash;50%.
          Offer stay bonuses (15&ndash;25% of annual compensation) that vest
          over 12&ndash;18 months, implement transparent commission structures
          ...
          &mdash; sharing your growth vision and soliciting their input &mdash;
        ...
        <p>
          ...
          synergies of 15&ndash;25% are achievable by centralizing payroll,
          ...
          creates cross-selling opportunities &mdash; a healthcare staffing
