  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Seasonal businesses, companies whose revenue concentrates in specific months or quarters, are common acquisition targets that require specialized analysis. From landscaping and snow removal to tax preparation and holiday retail, seasonal businesses can generate excellent annual returns but present unique cash flow management, staffing, and valuation challenges. Understanding the seasonal dynamic is critical for both deal evaluation and post-acquisition operations.</p>
      </div>

      <h2 className={h2Class}>Common Seasonal Business Types</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Outdoor services:</strong> Landscaping, pool service, pest control, and tree care. Peak spring-fall, slow in winter.</li>
          <li><strong>Winter services:</strong> Snow removal, heating/HVAC installation, ski operations. Peak November-March.</li>
          <li><strong>Tax &amp; accounting:</strong> Tax preparation businesses. 60-70% of revenue in January-April.</li>
          ...
          <li><strong>Construction:</strong> Outdoor construction and paving. Weather-dependent with peak spring-fall.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Normalized EBITDA:</strong> Adjust for weather anomalies, one-time events, and multi-year seasonality patterns. Use 3-5 year averages.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>Cash reserves:</strong> Build 3-6 months of operating expenses as reserve during peak season to fund the off-season.</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li>Always value on annual (not monthly) cash flow and use 3-5 year averages to normalize for weather and seasonal variation</li>
          ...
          <li>Seasonal hiring and retention is the #1 operational challenge, budget for recruiting costs and retention incentives</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <p>Always value seasonal businesses on annual cash flow, never on trailing monthly or quarterly revenue, which can be highly misleading. Use 3-5 year EBITDA averages to normalize for weather anomalies, one-time events, and multi-year seasonality patterns. Account for working capital cycles, as seasonal businesses experience large swings, cash builds during peak season and depletes in the off-season. Fixed costs (rent, insurance, key employee salaries) continue year-round, so understanding the monthly cash burn during slow months is critical. According to IBISWorld, seasonal businesses typically trade at a 10-20% discount to comparable year-round businesses due to the added complexity of cash flow management.</p>
      </div>

      <h3 className={h3Class}>What is the best time of year to close on a seasonal business acquisition?</h3>
      <div className={bodyClass}>
        <p>The optimal closing timing is just before the peak revenue season begins. Closing before peak season means you immediately capture revenue to fund operations and service acquisition debt, rather than funding a full off-season before any meaningful revenue arrives. For a landscaping or pool service business, this means closing in February or March before spring demand kicks in. For a snow removal or heating business, closing in September or October is ideal. Closing after peak season is the worst-case scenario, you inherit months of overhead costs with minimal revenue, creating immediate cash flow pressure on a new acquisition.</p>
      </div>

      <h3 className={h3Class}>How can you reduce the seasonality risk of an acquired business?</h3>
      <div className={bodyClass}>
        <p>The most effective strategy is adding complementary off-season services to create year-round revenue. Classic pairings include landscaping plus snow removal, pool service plus winterization, and pest control plus wildlife management. Converting one-time seasonal customers to annual maintenance contracts creates predictable year-round revenue, SBA data shows that businesses with 60%+ contracted annual revenue receive significantly more favorable lending terms. Other approaches include geographic diversification into regions with different peak seasons, prepayment discount programs that generate off-season cash flow, and cross-training core employees for both peak and off-season services to maintain year-round employment and reduce seasonal recruitment costs.</p>
      </div>
