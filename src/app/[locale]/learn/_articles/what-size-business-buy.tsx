    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          decision, from the financing you can access, to the management
          ...
          Deals under $1 million in enterprise value trade at 3-4x
          ...
          your capital, experience, and risk tolerance, so you avoid the
        ...
        <ol className={olClass}>
          <li>
            ...
            million in EBITDA typically trade at 3-4.5x, while those
            above $5 million trade at 6-8x or higher, according to
          ...
          <li>
            ...
            accounted for 59% of all transactions in the $5M-$50M range
          ...
          <li>
            ...
            company likely has no management layer, you are the general
          ...
          <li>
            ...
            SBA-financed acquisitions to businesses with roughly $1-$1.5
        ...
        <ul className={ulClass}>
          <li>
            <strong>Typical purchase price:</strong> $300K-$2.5M
          </li>
          <li>
            <strong>Valuation method:</strong> Seller&rsquo;s discretionary
            earnings (SDE), not EBITDA, because the owner&rsquo;s
            compensation is a significant portion of profit
          </li>
          <li>
            <strong>Multiples:</strong> 2.0-3.5x SDE (roughly
            equivalent to 3-4.5x EBITDA once you add back a market-rate
            manager salary)
          </li>
          <li>
            ...
            cover 80-90% of the purchase price; the SBA requires a
          ...
          <li>
            <strong>Employees:</strong> 3-20
          </li>
          <li>
            <strong>Competition:</strong> Low, mostly individual
        ...
        <p>
          ...
          margin for error. If your goal is true CEO-level work , 
          setting strategy and managing managers, you likely need to
          move up to Tier 2 or buy a Tier 1 business with a plan (and
          capital) to grow into Tier 2 within 18-24 months.
        </p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Multiples:</strong> 3.5-5.5x EBITDA for most
            industries; recurring-revenue businesses (managed services, SaaS)
            can push 6-7x. See the full breakdown in our{" "}
          ...
          <li>
            ...
            debt (typically 2.5-3.5x EBITDA use), seller
            financing (10-20% of the deal), and equity combine to fund
          ...
          <li>
            <strong>Employees:</strong> 20-75
          </li>
          <li>
            <strong>Competition:</strong> Moderate, self-funded
            searchers, traditional search funds, some family offices, and a
            growing number of PE add-on buyers (75% of PE deals in the
            $1M-$10M range were add-ons in 2024, per GF Data)
          </li>
        </ul>
        <p>
          ...
          salary, and fund reinvestment. The management layer, however
          thin, means you can focus on growth rather than daily
          ...
          $1M-$1.5M in equity, which is a meaningful commitment.
        </p>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Typical purchase price:</strong> $15M-$60M+
          </li>
          <li>
            <strong>Multiples:</strong> 5-8x EBITDA; premium
            businesses (high recurring revenue, above-average growth, strong
            moats) trade at 8-10x. The North American middle-market
          ...
          <li>
            <strong>Employees:</strong> 75-300+
          </li>
          <li>
            <strong>Competition:</strong> Intense, roughly 80% of
        ...
        <p>
          <strong>Key trade-off:</strong> The upside is enormous , 
          ...
          committed capital, and the equity requirement ($3M-$10M+)
        ...
        <p>
          ...
          companies with $1.5M-$5M in EBITDA. The median acquired
        ...
        <ol className={olClass}>
          <li>
            ...
            companies with at least $3M-$5M in EBITDA as platforms. The
            $1.5M-$3M zone sits in a structural gap: too large for
          ...
          <li>
            ...
            equity (25%). Annual debt service of roughly $750K-$900K
            leaves $1.1M-$1.25M for a CEO salary, taxes, and
            reinvestment. That math works. At $500K in EBITDA, the same
            structure collapses.
          </li>
          <li>
            <strong>Enough management infrastructure.</strong> Companies at
            $2M+ in EBITDA typically have 25-50 employees, a controller
            or bookkeeper, and at least one operations or sales manager. That
            thin management layer is critical, it means the new CEO
            can focus on{" "}
        ...
        <ul className={ulClass}>
          <li>
            <strong>$50K-$150K personal equity:</strong> Targets
            businesses in the $500K-$1.5M purchase-price range via SBA
            financing. Expect $200K-$500K EBITDA businesses.
          </li>
          <li>
            <strong>$150K-$500K personal equity:</strong> Opens up
            $1.5M-$5M purchase prices. Combined with SBA debt and
          ...
          <li>
            ...
            raising $400K-$600K in search capital from 10-20
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            Tier 2 (20-75 employees) is ideal. You understand how to
        ...
        <p>
          Smaller deals close faster (60-90 days for Main Street vs.
          6-12 months for middle-market deals with institutional
          financing). They also require less personal guarantee exposure. But
          smaller businesses carry more concentration risk, fewer
        ...
        <ul className={ulClass}>
          <li>
            ...
            2025-2026; the Made in America Manufacturing Finance Act
          ...
          <li>
            ...
            satisfy up to half of the required injection, meaning the
          ...
          <li>
            ...
            with up to ~$1.5M in EBITDA at 3-3.5x use
          </li>
          <li>
            <strong>Limitation:</strong> The $5M cap means a business priced
            above $5.5M-$6M needs a supplemental financing source
        ...
        <ul className={ulClass}>
          <li>
            <strong>Use:</strong> Typically 2.5-3.5x EBITDA for
            senior debt; mezzanine or subordinated debt can add another
            1-1.5x
          </li>
          <li>
            <strong>Equity requirement:</strong> 20-35% of the
          ...
          <li>
            <strong>Seller financing:</strong> Increasingly common , 
            60% of winning letters of intent in 2024 included a seller note
            (Calder Group). Typically 10-20% of the purchase price at
            below-market interest rates with a 2-5 year term
          </li>
          <li>
        ...
        <p>
          ...
          problems. First, after debt service (roughly $300K-$400K per
          year on a $1.5M loan) and a modest owner salary ($100K-$150K),
          there is no cash left for growth, hiring, or unexpected expenses.
          Second, there is no management infrastructure, you are the
        ...
        <p>
          ...
          plan to grow the business to $1M+ in EBITDA within 2-3
        ...
        <p>
          ...
          a smaller platform ($2M-$3M EBITDA) and grow into the
        ...
        <p>
          ...
          are 5%, that is only $500K in cash flow, firmly in Tier 1
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            is 10-25% of the deal, your maximum purchase price is 4x
            to 10x your equity. For example, $200K in equity supports a
            $800K-$2M purchase price.
          </li>
          <li>
          ...
          <li>
            ...
            service, a market-rate salary, taxes, and a 10-15% cash
        ...
        <p>
          ...
          $500K-$1.5M range successfully. The key test: after annual
          debt service and a $120K-$150K salary, does at least 15% of
        ...
        <p>
          ...
          acquisition, you cannot service debt with revenue, only with
          ...
          traditional industries, services, manufacturing,
          distribution, EBITDA is the only metric that matters for
        ...
        <p>
          Below $3M in EBITDA, PE competition is limited, these
        ...
        <p>
          ...
          &ldquo;platform&rdquo; business at $1M-$2M in EBITDA (where
          multiples are 3.5-5x), then acquire smaller tuck-in
          businesses at 2-3.5x that integrate into your existing
          operations. This approach, sometimes called
          buy-and-build, generates &ldquo;multiple arbitrage&rdquo;:
          ...
          could see its exit multiple expand from 4x to 6-7x,
        ...
        <p>
          ...
          search phase ($400K-$600K over 2 years) and then fund the
          acquisition equity ($2M-$10M+). The searcher contributes
          time and expertise, not capital, and receives 20-30% of the
          post-acquisition equity upon closing. This model specifically
          targets businesses in the $1.5M-$5M EBITDA range. If the
