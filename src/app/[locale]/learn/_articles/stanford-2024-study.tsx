    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          considering a search fund, whether as a searcher, investor, or
          advisor, this study is essential reading. Below we break down
        ...
        <ul className={ulClass}>
          <li><strong>35.1% aggregate pre-tax IRR</strong>: across all search funds that have reached a conclusion. For a deeper analysis of how these numbers compare to other asset classes, see our guide to <Link href="/learn/search-fund-returns" className="text-apple-accent hover:underline">search fund returns and performance data</Link>.</li>
        ...
        <p>
          ...
          $2M-$10M in EBITDA. The median acquisition purchase price of
          $14.4M corresponds to an average acquisition multiple of roughly
          4.5x-5.5x EBITDA, inclusive of all fees and transaction costs.
        ...
        <p>
          ...
          peaking at $16.5M, before retreating in 2022-2023 as interest
        ...
        <p>
          ...
          era. Funds raised before 2010 had slightly longer holds (6-7
          years), while more recent vintages show a tighter 4-6 year
        ...
        <ul className={ulClass}>
          <li><strong>37% fail to acquire</strong>: these searchers return unused capital to investors. The loss is limited to the search-phase capital invested (typically $400K-$500K per fund).</li>
          <li><strong>~30% of acquisitions underperform</strong>: among searchers who do acquire, roughly 30% generate returns below 1x invested capital.</li>
          <li><strong>10-15% result in total loss</strong>: a subset of acquisitions result in near-total or total loss of acquisition capital, typically due to severe operational issues, customer concentration risk, or industry downturns.</li>
          <li><strong>CEO replacement</strong>: the study finds that approximately 25-30% of search fund CEOs are eventually replaced by their boards, often within the first two years of operation. Boards that act decisively on CEO transitions tend to produce better outcomes than those that delay.</li>
        </ul>
        ...
        <p>
          The 2016 study reported approximately 30-40 new funds per year.
          By 2018, that figure had risen to 50-60, and the 2020 study
        ...
        <p>
          ...
          and each subsequent edition has confirmed returns in the 33-36%
        ...
        <ul className={ulClass}>
          <li><strong>Competition levels</strong>: with 94 US search funds launched in 2023 alone, the US market is substantially more competitive. European markets, even in aggregate, see fewer than 30 traditional search fund launches per year, meaning better access to quality deal flow.</li>
          <li><strong>Valuation arbitrage</strong>: the Stanford study&rsquo;s median 4.5-5.5x acquisition multiple compares to 3-5x in many European markets, particularly in the DACH region, Southern Europe, and the Nordics. This lower entry valuation provides a natural margin of safety.</li>
          <li><strong>Succession dynamics</strong>: Europe faces an even more acute SME succession crisis than North America. An estimated 2.4 million European SMEs will need to transfer ownership by 2030, many of them family-owned businesses with no internal successor.</li>
          <li><strong>Operational playbooks</strong>, the operational best practices documented in the Stanford study, professionalizing finance, building management teams, implementing growth strategies, translate directly to European acquisitions, where many target companies are even less professionalized than their US counterparts.</li>
        </ul>
        ...
        <p>
          ...
          aggregate return data, 35.1% IRR, 4.5x ROIC, as the
          ...
          of acquisitions are profitable, but 10-15% result in a total
        ...
        <ul className={ulClass}>
          <li><strong>&ldquo;Aren&rsquo;t returns declining as the market gets crowded?&rdquo;</strong>: Point to the stability of aggregate returns across study editions. Despite a tripling in fund launches, returns have held in the 33-36% IRR range because the pool of eligible businesses is enormous (millions of US SMEs) relative to the number of searchers.</li>
          <li><strong>&ldquo;What if the searcher fails to acquire?&rdquo;</strong>, The 37% non-acquisition rate is real, but the downside is capped at the search capital invested ($400K-$500K). This asymmetric risk-return profile, limited downside with significant upside, is the core of the search fund investment thesis.</li>
          <li><strong>&ldquo;How do returns compare to my other alternatives?&rdquo;</strong>: The Stanford data shows search funds outperforming PE (median net IRR of 12-15%), VC (median net IRR of 15-20%), and public equities (8-10% long-run average). The comparison is especially favorable on a risk-adjusted basis when you account for the active management and control position inherent in search fund deals.</li>
        </ul>
        ...
        <p>
          ...
          15-25 funds) to capture the asset class&rsquo;s statistical
        ...
        <p>
          ...
          data submission, which may introduce survivorship bias, funds
        ...
        <p>
          Despite a tripling in annual search fund launches since 2015 (from roughly 30 to 94 in 2023), aggregate returns have remained remarkably stable. The 2016 study reported aggregate IRRs above 30%, and each subsequent edition has confirmed returns in the 33-36% range. This durability reflects the enormous size of the addressable market, there are millions of US SMEs with baby boomer owners approaching retirement, far exceeding the number of active searchers. However, some investors have noted a slight compression in top-quartile returns in more recent vintages, likely reflecting higher entry multiples driven by increased competition for the best deals. The median acquisition multiple has risen from roughly 4x EBITDA in earlier studies to 4.5-5.5x in the 2024 data, suggesting that searchers must increasingly rely on operational value creation rather than entry valuation alone to generate strong returns.
        </p>

        <h3 className={h3Class}>How do search fund returns compare to traditional private equity and venture capital?</h3>
        <p>
          The Stanford data shows search funds outperforming most alternative asset classes on both an IRR and MOIC basis. The 35.1% aggregate pre-tax IRR and 4.5x ROIC compare favorably to PE (median net IRR of 12-15% according to Cambridge Associates data), VC (median net IRR of 15-20%), and public equities (8-10% long-run average). The comparison is especially favorable on a risk-adjusted basis when accounting for the control position, active management, and downside protection inherent in search fund structures. However, the comparison requires caveats: search fund returns are pre-tax and pre-fee, aggregate figures are skewed by top-performing outliers like Asurion, and the asset class has survivorship bias since underperforming funds are less likely to report data. For a deeper analysis, see our guide to{" "}
        ...
        <ul className={ulClass}>
          <li>
            <a href="https://www.gsb.stanford.edu/experience/about/centers-institutes/ces/research/search-funds" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">
              Stanford Graduate School of Business, 2024 Search Fund Study (Center for Entrepreneurial Studies)
            </a>
          </li>
          <li>
            <a href="https://www.iese.edu/entrepreneurship/search-funds/" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">
              IESE Business School, International Search Fund Study (Complementary European Data)
            </a>
          </li>
          <li>
            <a href="https://www.cambridgeassociates.com/private-investment-benchmarks/" target="_blank" rel="noopener noreferrer" className="text-apple-accent hover:underline">
              Cambridge Associates, Private Equity and Venture Capital Benchmark Data
            </a>
          </li>
        </ul>
      </div>
