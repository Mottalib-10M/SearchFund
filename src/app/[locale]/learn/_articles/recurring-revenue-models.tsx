    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li><strong>SaaS subscriptions:</strong> Monthly/annual software subscriptions with 90-95%+ net revenue retention. The gold standard ({" "}
          ...
          <li><strong>Insurance renewals:</strong> 85-95% annual renewal rates ({" "}
            <Link href="/learn/financial-services-acquisition" className="text-apple-accent hover:underline">
              insurance playbook
            </Link>)</li>
          <li><strong>Valuation premium:</strong> 1-3x additional EBITDA multiple vs. non-recurring peers</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Valuation premium:</strong> 0.5-1.5x additional EBITDA multiple</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Valuation discount:</strong> 0.5-1x lower EBITDA multiple due to revenue unpredictability</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Net Revenue Retention (NRR):</strong> Measures expansion minus churn. NRR above 100% means the business grows even without new customers. Best-in-class SaaS: 110-130%</li>
        ...
        <ul className={ulClass}>
          <li><strong>Higher use:</strong> Lenders extend more debt (3-5x EBITDA) for businesses with 70%+ recurring revenue vs. 2-3x for non-recurring</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>At-risk contracts:</strong> Identify any contracts expiring within 6-12 months of closing. These may not renew under new ownership</li>
        </ul>
        ...
        <p>
          ...
          increase the business&rsquo;s exit multiple by 1-2x
        ...
        <p>
          ...
          generate 10-30% more revenue each year through upsells and
        ...
        <p>
          ...
          the business&rsquo;s exit multiple by 1-2x EBITDA over a
