  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          Hotels sit at the intersection of real estate, operations, and brand management, making them one of the most complex acquisition targets in any buyer&rsquo;s pipeline. The U.S. lodging industry includes over 64,000 properties and nearly 5.7 million guestrooms, according to the{" "}
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Limited-service / select-service:</strong> Brands like Hampton Inn, Holiday Inn Express, and Fairfield Inn. No full restaurant, lower labor intensity, and strong brand-driven demand. These properties typically achieve GOP margins of 38-45% and are the segment most compatible with ETA operations.
          </li>
          <li>
          ...
          <li>
            <strong>Independent boutique:</strong> Unflagged properties that compete on uniqueness and location. Potentially higher ADR but no brand reservation system, requiring direct marketing spend and OTA dependency.
          </li>
          <li>
        ...
        <p>
          Branded hotels account for roughly 60% of U.S. rooms, with the top five chains (Marriott, Hilton, IHG, Wyndham, and Choice) controlling most of that share. Independent hotels retain pricing flexibility and avoid franchise fees (typically 8-12% of room revenue), but they lack the demand-generation engine of a global reservation system. Your{" "}
      ...
      <div className={bodyClass}>
        ...
        <p>
          <strong>Price per key</strong> is the industry&rsquo;s universal comparability metric, the total acquisition price divided by the number of rooms. In the current market, select-service hotels in secondary markets trade at $50,000-$120,000 per key, while full-service hotels in major metros can exceed $200,000 per key. According to{" "}
          ...
          , a secondary-market deal at roughly $178,000 per key and an 8.5% cap rate would be compared against local comparable sales in the $170,000-$210,000 per key range to validate the pricing.
        </p>
        <p>
          <strong>Cap rates</strong> for hotel transactions in early 2025 ranged from 5.0-6.2% in coastal gateway cities to 6.8-7.5% in secondary markets. These are calculated on Year 1 NOI after the FF&amp;E reserve, a detail buyers sometimes miss. A property that advertises a 7% cap rate on NOI before the FF&amp;E deduction is overstating returns by 50-80 basis points.
        </p>
        <p>
          ...
          {" "}covers the add-backs and normalizations that apply across industries, though hotels require additional adjustments for management fees, above-market franchise costs, and deferred maintenance.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            ...
            . Upscale properties averaged $100-$140 RevPAR; luxury exceeded $220.
          </li>
          <li>
            <strong>ADR (Average Daily Rate):</strong> Total room revenue divided by rooms sold. The U.S. average ADR hit a record $162.16 in 2025, per AHLA/STR data. ADR is your pricing-power indicator, a concept explored in depth in our{" "}
      ...
      <div className={bodyClass}>
        <p>
          Whether to acquire a branded or independent hotel is one of the most consequential decisions in a hotel deal. Franchise affiliation provides a reservation system, loyalty program, and brand recognition, but the costs are substantial and the contractual obligations rigid.
        </p>
        <p>
          <strong>Franchise fees</strong> typically include a royalty (4-6% of room revenue), a marketing/loyalty contribution (2-4%), and reservation/technology fees (1-3%). Combined, these run 8-12% of gross room revenue. On a $5 million revenue hotel, that&rsquo;s $400,000-$600,000 annually before a single guest walks in.
        </p>
        <p>
          <strong>Property Improvement Plans (PIPs)</strong> are the hidden cost that catches first-time hotel buyers off guard. When a branded hotel changes ownership, the franchisor issues a PIP, a mandatory renovation scope that the new owner must complete within a defined timeline (typically 12-24 months). According to{" "}
          ...
          , costs have escalated sharply: a Hilton Garden Inn full renovation that previously cost $20,000 per key is now underwritten at $35,000-$40,000 per key. For a 120-room property, that&rsquo;s $4.2-$4.8 million in mandatory capital expenditure on top of the purchase price.
        </p>
        <p>
          Soft-goods-only refreshes (bedding, carpet, paint) run $10,000-$15,000 per key, while full case-goods-and-bathroom renovations can hit $25,000-$40,000+ per key depending on the brand tier. PIP costs have risen over 30% compared to pre-COVID levels, per{" "}
      ...
      <div className={bodyClass}>
        <p>
          ...
          {" "},  reviewing tax returns, validating revenue, stress-testing assumptions, but adds layers of complexity unique to hospitality assets.
        </p>
        <ol className={olClass}>
          <li>
            <strong>STR competitive set report:</strong> Order a trailing-twelve-month STR report showing how the target hotel&rsquo;s RevPAR, ADR, and occupancy index against 5-7 local competitors. A RevPAR index below 90 (meaning the hotel captures less than 90% of its fair share) signals either a poorly managed property (upside) or a structurally disadvantaged one (risk).
          </li>
          <li>
            <strong>Property condition assessment (PCA):</strong> Hire a hospitality-specialized engineer to evaluate the roof, HVAC, plumbing, elevators, and building envelope. Deferred maintenance on a 150-room hotel can easily represent $1-3 million in near-term capital needs.
          </li>
          <li>
            <strong>PIP review and negotiation:</strong> As discussed above, obtain the brand&rsquo;s PIP before going firm on price. The PIP should be treated as a purchase-price adjustment, if the brand requires $3 million in renovations, that comes off the offer or gets escrowed.
          </li>
          <li>
            <strong>Environmental Phase I (and possibly Phase II):</strong> Hotels are high-risk for environmental issues due to laundry chemicals, pool systems, underground storage tanks, and historical land use. Phase I assessments typically cost $3,000-$6,000; if issues are flagged, Phase II sampling can add $15,000-$50,000.
          </li>
          <li>
            <strong>FF&amp;E reserve analysis:</strong> The industry standard FF&amp;E reserve is 4-5% of gross revenue, but many operators underfund this line. Examine actual capital spending over the past five years against the reserve balance. Industry research shows that properties spending below 3% of revenue on FF&amp;E are accumulating deferred capital obligations that will eventually come due.
          </li>
          <li>
      ...
      <div className={bodyClass}>
        ...
        <p>
          <strong>The renovation cycle problem:</strong> Branded hotels typically require a soft-goods refresh every 5-7 years and a full renovation every 10-14 years. An acquirer who buys a property at year 8 of its renovation cycle may face a $3-5 million PIP within 24 months of closing. That capital obligation is often funded through a combination of an FF&amp;E reserve (which may be underfunded), a CapEx loan, or additional equity, all of which dilute returns. SBA 7(a) loans, a common ETA financing tool, can fund acquisitions with up to 85-90% use, but lenders typically require 6-12 months of operating reserves on top of the purchase price, per{" "}
        ...
        <p>
          ...
          {" "}face ongoing staffing shortages, with housekeeping being the hardest-hit department (38% of all unfilled hotel positions). Average wages rose 3.7-5.9% year over year in 2025, per{" "}
        ...
        <p>
          ...
          {" "},  beach resorts, ski lodges, college-town properties, amplify both the capital and labor risks. A seasonal hotel may generate 60-70% of its revenue in four months, meaning it must cover year-round fixed costs (mortgage, insurance, property taxes, minimum staffing) with a compressed earning window.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>
            <strong>Select-service or extended-stay in a supply-constrained market:</strong> A 90-130 room Hampton Inn or Residence Inn in a market with high barriers to new construction (zoning restrictions, land scarcity) provides branded demand, manageable operations, and defensible cash flow. These properties trade at 8-11x NOI with cap rates of 7-9%.
          </li>
          <li>
            <strong>Underperforming property with clear operational upside:</strong> A hotel with a RevPAR index below 90 in a strong market may benefit from a revenue management overhaul, OTA optimization, and improved guest experience. Dynamic pricing alone can increase RevPAR 10-20% at a property with unsophisticated rate management.
          </li>
          <li>
            <strong>Recently renovated asset:</strong> Buying a hotel 1-2 years after a full PIP completion means you inherit a fresh product with no near-term capital obligations, giving you a 5-7 year runway to generate returns before the next renovation cycle.
          </li>
          <li>
      ...
      <div className={bodyClass}>
        ...
        <p>
          The cost varies enormously by segment and location. A 70-room economy property in a tertiary market might trade at $30,000-$50,000 per key ($2.1-$3.5 million total), while a 150-room select-service hotel in a strong secondary market could be $80,000-$120,000 per key ($12-$18 million). Full-service and luxury properties in major metros frequently exceed $200,000 per key. Beyond the purchase price, budget an additional 5-15% for PIP costs, closing costs, franchise transfer fees, and working capital reserves.
        </p>

        <h3 className={h3Class}>What is a good cap rate for a hotel acquisition?</h3>
        <p>
          Cap rates for hotel transactions in 2025 ranged from 5.0-6.2% in coastal gateway cities (New York, San Francisco, Miami) to 6.8-7.5% in secondary markets. Higher cap rates compensate for perceived risk, smaller markets, older properties, weaker brands. Be cautious of advertised cap rates calculated on NOI before the FF&amp;E reserve deduction, which can overstate returns by 50-80 basis points. Always recalculate using NOI after a 4-5% FF&amp;E reserve.
        </p>

        <h3 className={h3Class}>Can I use an SBA loan to buy a hotel?</h3>
        <p>
          Yes. The SBA 7(a) program is widely used for hotel acquisitions, offering up to 85-90% use with longer amortization periods than conventional commercial real estate loans (typically 25 years). However, lenders require the borrower to have relevant management experience or a qualified management team in place, and they typically require 6-12 months of operating reserves in addition to the equity contribution. SBA 504 loans can also work for the real estate portion of the transaction, with the hotel operations financed separately.
        </p>

        <h3 className={h3Class}>How important is brand affiliation versus going independent?</h3>
        <p>
          Brand affiliation drives 30-50% of a typical hotel&rsquo;s bookings through the loyalty program and central reservation system. Independent hotels must replace that demand through OTA channels (Expedia, Booking.com, which charge 15-25% commissions), direct marketing, and local sales efforts. In most cases, the net cost of franchise fees (8-12% of room revenue) is comparable to or less than the cost of acquiring the same bookings independently. The exception is unique boutique properties in strong leisure markets where direct demand is organically high.
        </p>
