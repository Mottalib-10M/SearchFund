    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Typical premium:</strong> Strategic buyers pay 1-3x EBITDA turns more than financial buyers for the same business</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Earn-out component:</strong> 10-20% tied to post-closing performance, especially for growth businesses</li>
          <li><strong>Transition period:</strong> Shorter (3-6 months) because the buyer has industry operators who can take over quickly</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Speed:</strong> Strategic buyers with acquisition experience can move fast (60-90 days from LOI to close)</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Typical discount: 1-3x EBITDA turns below strategic buyer pricing</li>
        </ul>

        <h3 className={h3Class}>Typical financial buyer deal structure</h3>
        <ul className={ulClass}>
          <li><strong>Used:</strong> 50-70% debt, 30-50% equity. The buyer puts less cash at risk and uses use to amplify returns</li>
          <li><strong>
          ...
          <li><strong>Equity rollover:</strong> Financial buyers often ask the seller to roll 10-30% of proceeds into equity in the new entity</li>
          ...
          <li><strong>Transition period:</strong> Longer (6-12 months) because the buyer needs operational handover</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Your role:</strong> PE buyers may want you to stay as CEO for 2-3 years. Other financial buyers may bring their own operator</li>
        </ul>
