    ...
    <article>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          operators who executed 3-5 identifiable quick wins within
          ...
          are not optional, they are the foundation of a
        ...
        <ul className={ulClass}>
          <li><strong>Raise prices 3-8%:</strong> Most SME owners haven&rsquo;t raised prices in 2-5 years. A modest increase (below the &ldquo;switching threshold&rdquo;) drops directly to EBITDA</li>
        ...
        <p>
          ...
          is that a 1% price increase yields an average 8-11% improvement in
          operating profit, making pricing the single highest-use
          financial quick win available.
        </p>

        <h3 className={h3Class}>Cost reduction</h3>
        <ul className={ulClass}>
          <li><strong>Insurance audit:</strong> Re-bid all insurance policies. Most SMEs haven&rsquo;t shopped insurance in years. Savings: 10-25%</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Deposit policy:</strong> For project-based businesses, require 25-50% deposits upfront</li>
          <li><strong>Credit card payments:</strong> Accept credit card payments (even with 2-3% processing fees) to accelerate cash collection</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Website refresh:</strong> Many SME websites are outdated. A simple redesign with clear calls-to-action can increase lead conversion 20-50%</li>
          <li><strong>Reactivate dormant customers:</strong> Identify customers who haven&rsquo;t purchased in 6-12 months. A phone call or email campaign can recover 10-20% of them</li>
        ...
        <ul className={ulClass}>
          <li><strong>Don&rsquo;t rebrand:</strong> The business name and brand have equity with customers. Rebranding can wait 12-24 months (if ever)</li>
          ...
          <li><strong>Don&rsquo;t implement an ERP:</strong> Major system changes require stability. Wait 6-12 months</li>
        ...
        <p>
          Focus on 3-5 high-impact wins rather than attempting to change everything at once.
          Choose one from each category, financial (e.g., pricing), operational (e.g., KPI
          dashboard), sales/marketing (e.g., Google Business Profile), and people (e.g., compensation
          fix), to demonstrate broad competence without creating change fatigue.
        </p>

        <h3 className={h3Class}>What if raising prices causes customer churn?</h3>
        <p>
          In practice, modest price increases of 3-8% on a business that has not raised
        ...
        <p>
          ...
          time, communicate the &ldquo;why&rdquo; clearly, let it settle for 1-2 weeks, and
