  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Most search fund acquisitions target businesses with revenues of $5-30M that have never had a formal executive team. The owner managed everything personally, with perhaps a bookkeeper, a sales manager, and operational supervisors. Building a proper management team, a CFO/controller, a VP of operations, a sales leader, is one of the most impactful things you can do as a new CEO, but timing and approach matter enormously.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Typical timeline:</strong> First executive hire usually happens at months 3-6; full team build-out over 12-18 months</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <ul className={ulClass}>
          <li>Often the most impactful first hire, gives you financial visibility and frees your time</li>
        ...
        <ul className={ulClass}>
          ...
          <li>Often the best candidate is already in the business, look at existing supervisors</li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>A dedicated sales leader can unlock significant growth within 6-12 months</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>Performance bonus:</strong> 15-30% of base, tied to company performance metrics (EBITDA, revenue, customer retention)</li>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Wait at least 90 days before your first executive hire, understand the business first</li>
          <li>A controller/CFO is typically the highest-impact first hire, providing financial visibility</li>
          <li>Promote from within when possible, it builds morale and retains institutional knowledge</li>
      ...
      <p className={bodyClass}>
        For businesses with $5-15M in revenue, a full-time controller typically costs $80K-$120K in base salary plus benefits, while a CFO costs $120K-$180K. Fractional CFOs offer an alternative at $3K-$8K per month for 1-2 days per week. According to SHRM&rsquo;s 2024 compensation benchmarking data, total cost (salary, benefits, bonus) for a controller at a small business averages 1.2-1.5x the base salary. Stanford GSB&rsquo;s search fund research found that the controller hire typically pays for itself within 6 months through improved cash management, better financial visibility, and reduced accounting fees. Start with a fractional CFO if cash is tight, then hire full-time as the business grows.
      </p>
