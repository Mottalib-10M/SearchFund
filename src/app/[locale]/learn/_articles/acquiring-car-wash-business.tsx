...
export default function AcquiringCarWashBusinessArticle() {
  return (
    <article>
      <h1 className={h1Class}>Acquiring a Car Wash Business: Industry Playbook</h1>
      <p className="text-sm text-apple-gray-500 mt-3">12 min read</p>

      <div className={bodyClass}>
        <p>
          The car wash industry has undergone a dramatic transformation,
          evolving from a fragmented collection of owner-operated sites
          ...
          value, labor-light operations, and a clear playbook for
          multi-site expansion.
        </p>

        <h2 className={h2Class}>Market overview and growth drivers</h2>
        <ul className={ulClass}>
          ...
          <li>
            <strong>Fragmentation:</strong> The top 50 operators control
            less than 20% of total locations, leaving thousands of
            independent single-site and small-chain operators as
            potential acquisition targets.
          </li>
        </ul>

        <h2 className={h2Class}>Types of car wash operations</h2>
        ...
        <h3 className={h3Class}>Flex-serve</h3>
        <p>
        ...
        <h3 className={h3Class}>Self-serve</h3>
        <p>
        ...
        <h2 className={h2Class}>Why car washes are attractive for ETA</h2>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            <strong>Real estate component:</strong> Many car washes own
            their underlying real estate, providing asset-backed downside
            protection, collateral for financing, and potential
        ...
        <h3 className={h3Class}>Location analysis</h3>
        <p>
          Location is the single most important determinant of car wash
          performance. A mediocre operator at a great location will
          outperform an excellent operator at a poor one.
        </p>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            <strong>Visibility and access:</strong> Clear road visibility,
            prominent signage, and easy ingress/egress. Difficult left
            turns or limited stacking space for queuing vehicles suppress
          ...
          <li>
            <strong>Competition mapping:</strong> Identify every car wash
            within a 5-mile radius, noting format, age, condition, and
            pricing. Express tunnel over-saturation in some markets can
            compress volumes and force price competition.
          </li>
        </ul>

        <h3 className={h3Class}>Equipment condition</h3>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            <strong>POS and LPR technology:</strong> Modern point-of-sale
            with license plate recognition is essential for membership
            management. Outdated technology requires post-acquisition
            upgrades but also represents an efficiency opportunity.
          </li>
        </ul>

        <h3 className={h3Class}>Membership base analysis</h3>
        ...
        <p>
          ...
          meaningful natural gas costs in colder climates.
        </p>

        <h3 className={h3Class}>Environmental compliance</h3>
        <ul className={ulClass}>
          <li>
            <strong>Wastewater permits:</strong> Review discharge permits,
            compliance history, and any pending violations.
          </li>
          <li>
            <strong>Phase I ESA:</strong> Essential for any property
            acquisition. Car wash sites may have contamination from
            chemical spills, underground storage tanks (common at
            former gas stations), or improper waste disposal.
          </li>
          <li>
            <strong>Air quality:</strong> Some jurisdictions regulate
            chemical misting and VOC emissions from cleaning products.
          </li>
        </ul>
        ...
        <p>
          The post-acquisition playbook for car washes offers multiple
          levers for revenue growth and margin expansion. Our{" "}
          <Link href="/learn/revenue-growth-playbook" className="text-apple-accent hover:underline">revenue growth playbook</Link>{" "}
          provides a broader framework; the strategies below are specific
          to the car wash sector.
        </p>

        <h3 className={h3Class}>Membership growth and optimization</h3>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            ...
            first month or a free tier upgrade to reduce sign-up
            friction. Once customers experience the convenience,
        ...
        <h3 className={h3Class}>Express conversion</h3>
        <p>
          Converting a full-service or flex-serve site to express
          exterior is one of the most powerful value creation levers.
          The conversion involves removing interior cleaning operations,
        ...
        <h3 className={h3Class}>Ancillary revenue and fleet programs</h3>
        <ul className={ulClass}>
          <li>
          ...
          <li>
            <strong>Vending and retail:</strong> Air fresheners, towels,
            cleaning products, and powered vacuum stations generate
            incremental revenue with minimal labor.
          </li>
          <li>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Weather dependency:</strong> Memberships dampen
            weather risk, but daily volume remains weather-sensitive.
            Geographic diversification across metro areas mitigates
            this exposure.
          </li>
          <li>
          ...
          <li>
            ...
            drought-prone regions could constrain operations. Advanced
            water reclaim systems achieving 80%+ reclamation rates and
            strong relationships with local water authorities help
            mitigate this risk.
          </li>
        </ul>
        ...
        <p>
          Car washes have earned their place as one of the most attractive
          sectors for entrepreneurship through acquisition. The membership
          model transforms a once weather-dependent, transactional
          business into a recurring-revenue engine with predictable cash
          flows and strong retention. Express tunnels offer labor-light
          operations that are increasingly automated, real estate provides
          asset-backed downside protection, and fragmentation creates
          ...
          Searchers who combine operational excellence with the right{" "}
          <Link href="/learn/acquisition-financing" className="text-apple-accent hover:underline">financing structure</Link>{" "}
          can build multi-site car wash platforms that command premium
