    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          opportunities, alongside unique regulatory and cultural
          complexities.
        </p>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Massive succession wave:</strong> Over 70% of Indian family businesses are first-generation, and many founders are now in their 60s-70s with no clear succession plan. The next decade will see an unprecedented transfer of business ownership</li>
          <li><strong>Young population:</strong> Median age of 28 (vs. 38 in the US, 47 in Japan). India produces 1.5 million engineers and 300,000+ MBA graduates annually, a deep talent pool for post-acquisition growth</li>
          ...
          <li><strong>Attractive multiples:</strong> 3-6x EBITDA for most SMEs, with significant variation by sector and geography. Less competitive than US and European markets</li>
        </ul>
        ...
        <ul className={ulClass}>
          <li><strong>Automatic route:</strong> Most sectors allow 100% FDI without government approval: including IT services, manufacturing, healthcare, education (private), and food processing</li>
          <li><strong>Government route:</strong> Some sectors require prior approval from the relevant ministry: including defense (&gt;74%), telecom, media, mining, and multi-brand retail</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Commercial banks:</strong> SBI, HDFC Bank, ICICI Bank, Axis Bank, and Kotak Mahindra Bank offer term loans for business acquisition, typically at 10-14% interest. Require substantial collateral (often 1.5-2x loan value in property or fixed assets)</li>
          <li><strong>NBFC lending:</strong> Non-Banking Financial Companies like Bajaj Finance, Tata Capital, and Piramal Finance provide more flexible acquisition financing than banks, often at 12-18% rates. Faster approvals but higher cost of capital</li>
          <li><strong>Seller financing:</strong> Less common in India than in Western markets but growing, especially in professional services and technology businesses. Typically 10-25% of deal value with 1-3 year payout periods</li>
          <li><strong>PE/VC ecosystem:</strong> India has a mature private equity market ($70B+ AUM). Firms like Everstone, Multiples, ChrysCapital, and India Value Fund are active in mid-market transactions. Family offices, Premji Invest, Azim Premji Foundation, and others, increasingly participate in smaller deals</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Education &amp; EdTech:</strong> K-12 private schools, coaching institutes (IIT/medical entrance), vocational training, and EdTech companies. India has 400,000+ private schools and the largest EdTech market outside the US</li>
        ...
        <ul className={ulClass}>
          ...
          <li><strong>Infrastructure gaps:</strong> Power reliability, logistics costs (14% of GDP vs. 8% in the US), internet connectivity in Tier 2-3 cities, and cold chain infrastructure remain challenges depending on the sector and geography</li>
          ...
          <li><strong>Informal economy:</strong> Despite rapid formalization, many SMEs still operate with some degree of informality, cash transactions, under-reported revenue, or informal employment arrangements. Thorough financial{" "}
            <Link href="/learn/due-diligence-checklist" className="text-apple-accent hover:underline">
              due diligence
            </Link>{" "}
            is non-negotiable</li>
          <li><strong>Lengthy legal processes:</strong> Contract enforcement in Indian courts averages 3-5 years. Arbitration (under the Arbitration and Conciliation Act, 1996) is increasingly preferred for dispute resolution in M&amp;A transactions</li>
        </ul>
        ...
        <p>
          ...
          with regulatory processes, but the opportunity is enormous.
        </p>
