  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Licenses and permits are often critical to a business&apos;s ability to operate legally. In many industries, the license IS the business &mdash; without it, operations must cease. According to the American Bar Association&apos;s 2024 M&amp;A practice guide, license transfer issues are among the top five causes of post-closing operational disruption in small business acquisitions. Understanding which licenses transfer automatically, which require re-application, and which are non-transferable is essential for avoiding operational disruption during and after your acquisition.</p>
      </div>
      ...
      <div className={bodyClass}>
        <p>
          License transfer timelines vary significantly by jurisdiction and industry. Liquor licenses can take 3&ndash;6 months to transfer in some states, while Medicare provider number changes may require 60&ndash;90 days. The SBA&apos;s 2024 guidelines recommend that acquirers begin the license transfer process as early as the LOI stage, and that purchase agreements include specific conditions around license continuity. In some cases, interim operating arrangements &mdash; such as a{" "}
          <Link href="/learn/management-transition" className="text-apple-accent hover:underline">management transition</Link> agreement where the seller continues to operate under their licenses during the transfer period &mdash; can prevent any gap in operations.
        </p>
      </div>
      ...
      <div className={bodyClass}>
        ...
        <p>
          ...
          processing times of 3&ndash;6 months. Medicare and Medicaid
          provider numbers require a formal change-of-ownership
          application that can take 60&ndash;90 days.
        </p>
        ...
        <p>
          ...
          assets &mdash; the buyer must apply for new licenses, which
