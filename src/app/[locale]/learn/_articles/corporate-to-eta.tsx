...
export default function CorporateToETAArticle() {
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h3 className={h3Class}>You've Hit the Learning Ceiling</h3>
      ...
      <h3 className={h3Class}>You Have Relevant Operational Experience</h3>
      ...
      <h3 className={h3Class}>Your Financial Foundation Is Solid</h3>
      ...
      <h3 className={h3Class}>You're Willing to Relocate</h3>
      ...
      <ul className={ulClass}>
        <li>Housing (mortgage/rent, insurance, property taxes, maintenance)</li>
        <li>Healthcare (COBRA or private insurance, which will be more expensive than corporate coverage)</li>
        <li>Family expenses (childcare, education, activities)</li>
        <li>Transportation, food, utilities</li>
        <li>Search-related travel and expenses not covered by investors</li>
        <li>A 20% buffer for unexpected costs</li>
      </ul>
      ...
      <h3 className={h3Class}>Optimize Your Exit</h3>
      ...
      <ul className={ulClass}>
        <li>Vest any upcoming equity grants or bonuses if the timeline is reasonable</li>
        <li>Understand your equity cliff dates and exercise windows</li>
        <li>Consider year-end timing for healthcare deductibles and FSA/HSA balances</li>
        <li>Ensure you'll qualify for unemployment benefits in your state if your search extends</li>
        <li>Max out retirement contributions before leaving (especially if there's a match)</li>
      </ul>

      <h3 className={h3Class}>Plan for Healthcare</h3>
      ...
      <h3 className={h3Class}>Consider a Bridge Strategy</h3>
      ...
      <ul className={ulClass}>
        <li>Negotiating part-time or consulting arrangements with their employer</li>
        <li>Taking on interim executive or consulting projects during the search</li>
        <li>Pursuing self-funded search while maintaining income through advisory work</li>
      </ul>
      ...
      <h3 className={h3Class}>Post-MBA (28-32 years old)</h3>

      <p className={bodyClass}>
        <strong>Advantages:</strong> High energy, fewer family obligations, strong professional network from business school, comfortable with financial modeling and analysis, long time horizon for wealth creation.
      </p>

      <p className={bodyClass}>
        <strong>Challenges:</strong> Limited operational experience, may lack credibility with sellers and management teams, smaller personal savings, less developed industry expertise.
      </p>

      <p className={bodyClass}>
        <strong>Verdict:</strong> This is the most common entry point for traditional search funds. Best if you've had 2-3 years of post-MBA operational experience rather than going straight from school.
      </p>

      <h3 className={h3Class}>Mid-Career Corporate (35-42 years old)</h3>

      <p className={bodyClass}>
        <strong>Advantages:</strong> Substantial operational experience, established industry credibility, strong professional network, financial stability, proven leadership track record.
      </p>

      <p className={bodyClass}>
        <strong>Challenges:</strong> Higher opportunity cost of leaving corporate, family obligations may limit flexibility, accustomed to higher compensation and corporate resources.
      </p>

      <p className={bodyClass}>
        <strong>Verdict:</strong> Ideal for many searchers. You've built valuable skills and credibility but still have 20+ years to build a business and create significant wealth.
      </p>

      <h3 className={h3Class}>Late Career (45+ years old)</h3>

      <p className={bodyClass}>
        <strong>Advantages:</strong> Deep industry expertise, extensive network, significant financial resources for self-funded search, gravitas with sellers and investors.
      </p>

      <p className={bodyClass}>
        <strong>Challenges:</strong> Shorter time horizon for wealth creation, may be perceived as expensive or over-qualified, harder to adapt to small business realities, traditional investors may have age bias.
      </p>

      <p className={bodyClass}>
        <strong>Verdict:</strong> Better suited for self-funded search or industry consolidation plays. Can be very successful with the right approach and realistic expectations.
      </p>

      <h3 className={h3Class}>Worst Times to Transition</h3>

      <ul className={ulClass}>
        <li><strong>During major life disruptions:</strong> New baby, divorce, family illness, or other significant personal challenges</li>
        <li><strong>On the cusp of major corporate vesting:</strong> Six months before a $200K equity grant vests is not the time to quit</li>
        <li><strong>With inadequate savings:</strong> Less than 12 months of runway creates dangerous pressure</li>
        <li><strong>As an escape from problems:</strong> Running from a bad corporate situation rather than toward ETA opportunity</li>
        <li><strong>Without partner buy-in:</strong> Surprising your spouse with "I quit my job to buy a company" ends poorly</li>
      </ul>
      ...
      <h3 className={h3Class}>Financial Acumen</h3>
      ...
      <h3 className={h3Class}>Operational Excellence</h3>
      ...
      <h3 className={h3Class}>Deal Sourcing and Origination</h3>
      ...
      <h3 className={h3Class}>Decision-Making with Imperfect Information</h3>
      ...
      <h3 className={h3Class}>Resilience and Self-Motivation</h3>
      ...
      <h2 className={h2Class}>Building Your ETA Network While Employed</h2>
      ...
      <h3 className={h3Class}>Connect with Successful Searchers</h3>
      ...
      <h3 className={h3Class}>Attend Search Fund Conferences</h3>
      ...
      <h3 className={h3Class}>Engage with Search Fund Investors</h3>
      ...
      <h3 className={h3Class}>Join Relevant Professional Communities</h3>
      ...
      <h3 className={h3Class}>Develop Industry Expertise</h3>
      ...
      <h3 className={h3Class}>Identify Potential Advisors</h3>
      ...
      <h2 className={h2Class}>The Transition Playbook</h2>

      <p className={bodyClass}>
        A successful corporate-to-ETA transition typically follows a 6-12 month timeline. Here's a month-by-month playbook:
      </p>

      <h3 className={h3Class}>Months 6-12 Before Departure</h3>

      <ul className={ulClass}>
        <li>Begin seriously researching ETA and search funds</li>
        <li>Attend at least one search fund conference</li>
        <li>Conduct informational interviews with 10+ searchers at various stages</li>
        <li>Assess your financial readiness and begin aggressive saving</li>
        <li>Have preliminary conversations with your partner about the possibility</li>
        <li>Identify skill gaps and begin addressing them (courses, reading, side projects)</li>
      </ul>

      <h3 className={h3Class}>Months 3-6 Before Departure</h3>

      <ul className={ulClass}>
        <li>Make the formal decision with your partner and set a target departure date</li>
        <li>Develop your search thesis and target industry focus</li>
        <li>Begin building your investor target list and making soft introductions</li>
        <li>Optimize your corporate exit timeline around vesting schedules and bonuses</li>
        <li>Start drafting your search fund materials (bio, investment memo, financial model)</li>
        <li>Ensure you have 12-18 months of living expenses saved</li>
        <li>Research healthcare options and estimate costs</li>
      </ul>

      <h3 className={h3Class}>Month Before Departure</h3>

      <ul className={ulClass}>
        <li>Give notice at your corporate job (typically 2-4 weeks, but may be longer for senior roles)</li>
        <li>Finalize healthcare transition plan</li>
      ...
      <ul className={ulClass}>
        <li>Take 1-2 weeks off to reset (seriously, do this)</li>
        <li>Launch investor fundraising process</li>
        <li>Set up your search operating system (daily routines, tracking systems, goals)</li>
        <li>Begin initial market research and deal sourcing preparation</li>
        <li>Conduct 20+ informational interviews with industry experts</li>
      </ul>

      <h3 className={h3Class}>Months 2-3: Post-Departure</h3>

      <ul className={ulClass}>
        <li>Complete search fund fundraising (traditional model) or commit to self-funded approach</li>
        <li>Launch deal sourcing campaigns</li>
        <li>Establish weekly routines and productivity systems</li>
        <li>Begin building your deal pipeline</li>
        <li>Form or join a searcher peer group for support and accountability</li>
      </ul>

      <h2 className={h2Class}>Managing Family and Partner Expectations</h2>
      ...
      <h3 className={h3Class}>Have the Conversation Early</h3>
      ...
      <h3 className={h3Class}>Be Transparent About Risks and Timelines</h3>
      ...
      <ul className={ulClass}>
        <li>The search typically takes 18-24 months (but could extend)</li>
        <li>You'll likely earn less than in corporate, at least initially</li>
        <li>You may need to relocate for the right opportunity</li>
        <li>The first year operating the business will be intense and demanding</li>
        <li>Success is not guaranteed, though the track record is strong</li>
      </ul>
      ...
      <h3 className={h3Class}>Celebrate Small Wins</h3>
      ...
      <h2 className={h2Class}>Common Mistakes in the Transition</h2>

      <p className={bodyClass}>
        Learning from others' mistakes can help you avoid common pitfalls:
      </p>

      <h3 className={h3Class}>Leaving Too Early</h3>
      ...
      <h3 className={h3Class}>Leaving Too Late</h3>
      ...
      <h3 className={h3Class}>Burning Bridges</h3>
      ...
      <h3 className={h3Class}>Underestimating the Psychological Shift</h3>
      ...
      <h3 className={h3Class}>Lifestyle Inflation Before Departure</h3>
      ...
      <h3 className={h3Class}>Inadequate Partner Communication</h3>
      ...
      <h3 className={h3Class}>Ignoring the Opportunity Cost</h3>
      ...
      <h3 className={h3Class}>Underestimating Healthcare Costs</h3>
      ...
      <ul className={ulClass}>
        ...
        <li>
          <a
            ...
            className="text-apple-accent hover:underline"
          >
            IESE Business School - International Search Funds
          </a>
        </li>
        <li>
          <Link href="/learn/pre-search-preparation" className="text-apple-accent hover:underline">
            Pre-Search Preparation: Building Your Foundation
          </Link>
        </li>
        <li>
