...
export default function ETASoutheastAsiaArticle() {
  return (
    <article>
      <h1 className={h1Class}>ETA in Southeast Asia: Indonesia, Vietnam, Thailand &amp; the Philippines</h1>
      <p className="text-sm text-apple-gray-500 mt-3">13 min read</p>

      <div className={bodyClass}>
        <p>
          Southeast Asia is rapidly emerging as one of the most compelling
          frontiers for <Link href="/learn/what-is-eta" className="text-apple-accent hover:underline">Entrepreneurship Through Acquisition</Link>.
          With a combined population exceeding 700&nbsp;million, a fast-growing
        ...
        <p>
          For search fund entrepreneurs, this translates into a dual thesis:
          acquire an established, cash-flowing business <em>and</em> ride
          macroeconomic growth. The challenge, of course, is that the very
          dynamism that makes the region attractive also introduces volatility,
          regulatory fragmentation, and governance risks that require careful
          management.
        </p>
        ...
        <p>
          Indonesia is Southeast Asia&rsquo;s largest economy and home to an
        ...
        <p>
          Indonesia&rsquo;s demographic profile is extraordinary: over
        ...
        <p>
          ...
          China, attracting foreign direct investment from Samsung, Intel,
          and hundreds of smaller multinational manufacturers. Service-sector
          SMEs in areas such as logistics, IT services, healthcare clinics,
          and vocational education are increasingly attractive for ETA.
        </p>
        <p>
          A key dynamic in Vietnam is the ongoing transition from
          state-owned enterprises to private ownership. The government&rsquo;s
          equitization (c&ocirc;&#x0300; ph&acirc;&#x0300;n ho&aacute;) program
          has created a growing cohort of first-generation private business
          owners, many of whom built their companies in the 1990s and 2000s
          and are now approaching retirement without clear successors.
        </p>

        <h3 className={h3Class}>Thailand</h3>
        <p>
          Thailand&rsquo;s economy is the second largest in ASEAN, with a
          well-developed industrial base and a strong services sector. The
          country has approximately 3.2&nbsp;million SMEs, which contribute
          around 35% of GDP. Thai SMEs are particularly strong in food
          processing, tourism and hospitality, automotive parts manufacturing,
          and healthcare. Thailand&rsquo;s Board of Investment (BOI) offers
          attractive incentives for both domestic and foreign investors,
          including tax holidays and relaxed foreign ownership restrictions
        ...
        <p>
          ...
          acquisition targets over the coming decade.
        </p>

        <h3 className={h3Class}>The Philippines</h3>
        <p>
          The Philippines has a young, English-speaking population of over
          115&nbsp;million and an economy increasingly driven by services,
          particularly business process outsourcing (BPO), which employs
          over 1.3&nbsp;million people. The country has roughly one&nbsp;million
          registered SMEs, concentrated in retail, food services, manufacturing,
          and professional services. The widespread use of English is a
          significant advantage for foreign searchers, as it lowers the
          language barrier that can be formidable in Indonesia, Vietnam,
          and Thailand.
        </p>
        <p>
          Filipino family businesses are often tightly controlled by founding
          families, and the cultural emphasis on family loyalty means that
          succession is a deeply personal decision. However, a growing number
          of second-generation owners educated abroad are open to
          professional management and external ownership transitions,
          particularly when structured in a way that honors the founder&rsquo;s
          legacy.
        </p>

        <h2 className={h2Class}>Family business succession: the regional catalyst</h2>
        <p>
          Across all four countries, the single largest driver of potential
          ETA deal flow is the generational succession gap. Southeast Asia
          experienced its entrepreneurial boom in the 1970s through 1990s,
          when rapid economic development created a wave of first-generation
          business builders. These founders are now in their 60s and 70s.
          Regional surveys consistently find that fewer than one in three
          family businesses have a formal succession plan, and many
          second-generation family members have pursued careers in finance,
          technology, or multinational corporations rather than taking over
          the family enterprise.
        </p>
        <p>
          This dynamic creates both opportunity and complexity. Unlike in
          <Link href="/learn/eta-europe" className="text-apple-accent hover:underline">European markets</Link> where
          the succession crisis is well-documented and intermediaries actively
          facilitate transfers, Southeast Asian succession transitions often
          happen informally. Founders may not have considered selling to an
          outsider, and the concept of a &ldquo;search fund&rdquo; is unfamiliar.
          Successful searchers in the region must be prepared to educate
          sellers on the model and invest significant time in
          relationship-building before any transaction can take shape.
        </p>

        <h2 className={h2Class}>Deal flow sources</h2>
        <p>
          Deal sourcing in Southeast Asia requires a multi-channel approach
          that blends the proprietary outreach common in Western ETA with
          relationship-driven methods suited to the local context.
        </p>
        <ol className={olClass}>
          <li><strong>Business brokers and M&amp;A advisors:</strong> The M&amp;A advisory market for SMEs is growing but remains thin compared to North America or Europe. In each country, a handful of boutique advisory firms specialize in lower-middle-market transactions. In Indonesia, firms like Ciptadana and Sinar Mas Financial Services cover the space; in Thailand, KPMG and Deloitte have dedicated SME transaction teams.</li>
          <li><strong>Chambers of commerce and industry associations:</strong> Organizations such as KADIN (Indonesia), the Thai Chamber of Commerce, PCCI (Philippines), and VCCI (Vietnam) maintain extensive member directories and can facilitate introductions to business owners considering succession.</li>
          <li><strong>Accounting and legal networks:</strong> Local accounting firms often serve as trusted advisors to SME owners and are among the first to learn when a client is considering a transition. Building relationships with mid-tier accounting practices can yield high-quality, off-market deal flow.</li>
          <li><strong>University and business school alumni networks:</strong> Graduates of regional MBA programs at institutions like the Asian Institute of Management (AIM) in Manila, Chulalongkorn University in Bangkok, and Universitas Indonesia in Jakarta form tight professional communities that can provide warm introductions.</li>
          <li><strong>Online platforms:</strong> While less developed than Western equivalents, platforms such as Flippa, MicroAcquire, and local classifieds occasionally surface small business listings in the region. More importantly, LinkedIn has become a valuable tool for identifying and approaching business owners directly.</li>
        </ol>

        <h2 className={h2Class}>Legal structures for acquisition</h2>
        <p>
          For background on how search funds are typically structured
          elsewhere, see our guide to <Link href="/learn/cross-border-acquisitions-europe" className="text-apple-accent hover:underline">cross-border acquisitions</Link>.
          Each Southeast Asian country has distinct corporate law, foreign
          ownership restrictions, and regulatory requirements that shape
          how acquisitions are structured.
        </p>

        <h3 className={h3Class}>Indonesia: PT and PT PMA</h3>
        <p>
          Domestic companies in Indonesia are structured as a Perseroan
          Terbatas (PT), while foreign-owned entities require a PT PMA
          (Penanaman Modal Asing) structure. Indonesia maintains a
          &ldquo;Negative Investment List&rdquo; (recently replaced by the
        ...
        <h3 className={h3Class}>Vietnam: LLC and JSC</h3>
        <p>
          Vietnam&rsquo;s two primary corporate forms are the Limited
          Liability Company (LLC) and the Joint Stock Company (JSC). Foreign
          investors may hold up to 100% equity in most sectors, though
          certain industries (banking, telecommunications, media) have caps.
          The Law on Investment requires foreign acquisitions to be registered
          with the Department of Planning and Investment (DPI), and
          transactions involving conditional business sectors require
          additional approvals. Vietnam&rsquo;s improving but still opaque
          regulatory environment means that experienced local legal counsel
          is essential.
        </p>

        <h3 className={h3Class}>Thailand: company limited</h3>
        <p>
          Thailand&rsquo;s Foreign Business Act generally restricts foreign
          majority ownership in service sectors, requiring Thai nationals to
          hold at least 51% of shares in most non-promoted businesses. However,
        ...
        <h3 className={h3Class}>Philippines: domestic and foreign corporations</h3>
        <p>
          The Philippines&rsquo; Revised Corporation Code (2019) modernized
          corporate governance requirements. The landmark Retail Trade
          Liberalization Act (2022) lowered foreign equity restrictions in
          retail, and the Public Service Act amendments opened
          telecommunications and transportation sectors to full foreign
          ownership. Despite these reforms, certain sectors remain subject
          to the Foreign Investment Negative List, which limits foreign
          ownership to 40% in areas such as mass media, small-scale mining,
          and certain professional services.
        </p>

        <h2 className={h2Class}>Financing options</h2>
        <p>
          Financing acquisitions in Southeast Asia presents unique challenges
          compared to the structures described in our <Link href="/learn/acquisition-financing" className="text-apple-accent hover:underline">acquisition financing</Link> guide.
          Leveraged buyout debt markets for SMEs are nascent at best, and
        ...
        <h2 className={h2Class}>Valuation and deal terms</h2>
        <p>
          Entry multiples in Southeast Asia are generally attractive compared
          to Western markets, though they vary significantly by country and
          sector. Indonesian and Filipino SMEs in traditional sectors
          typically trade at 3x to 5x EBITDA, while Vietnamese businesses
          in faster-growing sectors (technology services, healthcare) may
          command 5x to 8x. Thai businesses fall somewhere in between,
          with well-run manufacturing and services companies trading at
          4x to 6x EBITDA.
        </p>
        <p>
          Several factors depress multiples relative to developed markets:
          weaker corporate governance and financial reporting standards,
          key-person risk concentrated in the founder, currency and
        ...
        <h2 className={h2Class}>The INSEAD Singapore connection</h2>
        <p>
        ...
        <p>
          ...
          years, providing capital and guidance specifically for ASEAN-focused
          searches.
        </p>
        <p>
          Beyond INSEAD, the National University of Singapore (NUS) Business
          School and Singapore Management University (SMU) have begun
          incorporating ETA content into their entrepreneurship curricula,
          further expanding the pipeline of potential searchers in the region.
        </p>

        <h2 className={h2Class}>Challenges and risk factors</h2>
        <p>
          While the opportunity is significant, searchers must approach
          Southeast Asia with clear-eyed awareness of the region&rsquo;s
          challenges.
        </p>

        <h3 className={h3Class}>Regulatory fragmentation</h3>
        <p>
          Unlike the European Union, ASEAN does not have a unified regulatory
          framework. Each country has its own corporate law, tax code, labor
          regulations, and foreign investment restrictions. A search fund
          structure that works in Thailand may be entirely impractical in
          Indonesia. Searchers must be prepared to engage separate legal
          and tax advisors in each target country and factor the cost of
          this complexity into their search budgets.
        </p>

        <h3 className={h3Class}>Governance and financial reporting</h3>
        <p>
          ...
          additional time and resources for forensic-level diligence.
        </p>

        <h3 className={h3Class}>Currency and macroeconomic risk</h3>
        <p>
          ASEAN currencies can be volatile. The Indonesian rupiah, Philippine
          peso, Vietnamese dong, and Thai baht have all experienced
          significant fluctuations against the US&nbsp;dollar in recent
          decades. For searchers raising capital in US&nbsp;dollars or euros
          and acquiring businesses with revenues in local currency,
          currency risk is a material consideration. Natural hedging
          (matching the currency of revenues and debt) and conservative
          capital structures are prudent risk management tools.
        </p>

        <h3 className={h3Class}>Political and legal risk</h3>
        <p>
          Political stability varies across the region. Thailand has
          experienced periodic political disruptions; the Philippines&rsquo;
          regulatory environment can shift with each presidential
          administration; Vietnam&rsquo;s single-party system provides
        ...
        <p>
          ...
          and Vietnam. Searchers should plan for significant investment
          in team development and consider whether key hires need to be
          in place before closing.
        </p>

        <h2 className={h2Class}>Emerging ETA communities</h2>
        <p>
          Although the search fund model is still new in Southeast Asia,
          several communities and organizations are actively building the
          ecosystem.
        </p>
        <ul className={ulClass}>
          <li><strong>INSEAD ETA &amp; Search Funds Hub (Singapore):</strong> The anchor institution for ETA in Asia, providing research, events, and an alumni network that spans the region.</li>
          <li><strong>Search Fund Accelerator (Singapore):</strong> A growing number of Singapore-based accelerators and investor groups are specifically targeting ASEAN search fund opportunities, providing mentorship, capital, and operational support.</li>
          <li><strong>ETA Indonesia:</strong> An informal but active community of Indonesian entrepreneurs and investors exploring the search fund model, often connected through INSEAD, NUS, or the Asian Institute of Management.</li>
          <li><strong>ETA Philippines:</strong> Manila&rsquo;s vibrant entrepreneurial scene and the country&rsquo;s English-language advantage have attracted several early searchers, and the Asian Institute of Management is beginning to incorporate ETA into its curriculum.</li>
          <li><strong>Regional conferences:</strong> The INSEAD ETA Conference (held annually in Fontainebleau with increasing Asia-Pacific representation), the Asia Private Equity Forum in Hong Kong, and emerging ETA-specific events in Singapore are bringing together searchers, investors, and advisors from across the region.</li>
          <li><strong>Online communities:</strong> LinkedIn groups, WhatsApp networks, and Telegram channels focused on ASEAN ETA are growing rapidly, providing a low-friction way for aspiring searchers to connect and share insights.</li>
        </ul>

        <h2 className={h2Class}>Practical advice for Southeast Asian searchers</h2>
        <ol className={olClass}>
          <li><strong>Base yourself in Singapore or your target country:</strong> Proximity matters enormously in relationship-driven markets. Singapore offers the best infrastructure and connectivity for a multi-country search, while basing in-country (Jakarta, Ho Chi Minh City, Bangkok, or Manila) is ideal for a single-market focus.</li>
          <li><strong>Invest in language and cultural fluency:</strong> Even in the Philippines, where English is widely spoken, understanding local business culture and norms will differentiate you from other potential acquirers. In Indonesia, Vietnam, and Thailand, local language proficiency is a near-requirement for building trust with SME owners.</li>
          <li><strong>Build a local advisory board:</strong> Engage experienced local business leaders, lawyers, and accountants as informal or formal advisors. Their networks, cultural knowledge, and regulatory expertise will be invaluable during both the search and post-acquisition phases.</li>
        ...
        <p>
          For searchers considering the region, the path forward requires a
