...
export default function EnvironmentalDueDiligenceArticle() {
  return (
    <article className="mx-auto max-w-3xl">
      ...
      <h3 className={h3Class}>How much does a Phase I Environmental Site Assessment cost and how long does it take?</h3>

      <p className={bodyClass}>
        A Phase I ESA conducted in accordance with ASTM E1527-21 standards typically costs $2,000-$6,000 for a standard commercial or industrial property, according to the National Association of Environmental Professionals. Costs can increase to $8,000-$15,000 for large, complex sites or properties with extensive historical industrial use requiring more detailed records research. The typical timeline from engagement to final report is 3-5 weeks, though expedited assessments can be completed in 2 weeks for an additional fee. If the Phase I identifies Recognized Environmental Conditions (RECs) that warrant further investigation, a Phase II ESA involving soil and groundwater sampling adds $10,000-$100,000+ and 4-8 additional weeks. Acquirers should budget for Phase I assessments early in their due diligence timeline to avoid closing delays.
      </p>

      <h3 className={h3Class}>Can I be held liable for environmental contamination caused by previous owners?</h3>

      <p className={bodyClass}>
        Yes, under CERCLA (the Thorough Environmental Response, Compensation, and Liability Act), current owners and operators face strict, joint and several liability for hazardous substance contamination, regardless of whether they caused it. However, CERCLA provides critical liability defenses for buyers who conduct &ldquo;all appropriate inquiry&rdquo; before acquisition. Completing a Phase I ESA that meets ASTM E1527-21 standards satisfies this requirement and qualifies you for the &ldquo;innocent landowner defense&rdquo; or &ldquo;bona fide prospective purchaser&rdquo; (BFPP) protection. The BFPP defense can even apply when you knowingly acquire contaminated property, provided you satisfy specific conditions including cooperation with regulators and compliance with institutional controls. Without a Phase I ESA, you have virtually no defense against inherited environmental liability.
      </p>

      <h3 className={h3Class}>Which industries carry the highest environmental due diligence risk?</h3>

      <p className={bodyClass}>
        Manufacturing, automotive services, dry cleaning, metal plating, printing, chemical processing, and petroleum storage facilities carry the highest environmental risk profiles, according to EPA enforcement data and ASTM guidance. Historical dry cleaning operations involving chlorinated solvents (perchloroethylene) and metal plating facilities using heavy metals and cyanide are among the most expensive to remediate, cleanup costs frequently exceed $500,000 and can extend over multiple years. PFAS (&ldquo;forever chemicals&rdquo;) contamination is an emerging risk area with rapidly evolving regulation that can affect a broader range of industries. For asset-light businesses (professional services, software, consulting), environmental due diligence is less critical but should still include a Phase I if the company occupies or owns real estate, as prior tenants may have created contamination.
      </p>
