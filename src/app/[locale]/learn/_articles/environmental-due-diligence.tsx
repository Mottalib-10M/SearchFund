...
export default function EnvironmentalDueDiligenceArticle() {
  return (
    <article className="mx-auto max-w-3xl">
      ...
      <p className={bodyClass}>
        A Phase I ESA conducted in accordance with ASTM E1527-21 standards typically costs $2,000&ndash;$6,000 for a standard commercial or industrial property, according to the National Association of Environmental Professionals. Costs can increase to $8,000&ndash;$15,000 for large, complex sites or properties with extensive historical industrial use requiring more detailed records research. The typical timeline from engagement to final report is 3&ndash;5 weeks, though expedited assessments can be completed in 2 weeks for an additional fee. If the Phase I identifies Recognized Environmental Conditions (RECs) that warrant further investigation, a Phase II ESA involving soil and groundwater sampling adds $10,000&ndash;$100,000+ and 4&ndash;8 additional weeks. Acquirers should budget for Phase I assessments early in their due diligence timeline to avoid closing delays.
      </p>
      ...
      <p className={bodyClass}>
        Manufacturing, automotive services, dry cleaning, metal plating, printing, chemical processing, and petroleum storage facilities carry the highest environmental risk profiles, according to EPA enforcement data and ASTM guidance. Historical dry cleaning operations involving chlorinated solvents (perchloroethylene) and metal plating facilities using heavy metals and cyanide are among the most expensive to remediate&mdash;cleanup costs frequently exceed $500,000 and can extend over multiple years. PFAS (&ldquo;forever chemicals&rdquo;) contamination is an emerging risk area with rapidly evolving regulation that can affect a broader range of industries. For asset-light businesses (professional services, software, consulting), environmental due diligence is less critical but should still include a Phase I if the company occupies or owns real estate, as prior tenants may have created contamination.
      </p>
