    ...
    <article>
      ...
      <div className={bodyClass}>
        <p>
          ...
          half of all acquisitions&mdash;and tech-enabled services produced some of
        ...
        <p>
          ...
          not&mdash;and industry mismatch was a recurring factor in
        ...
        <p>
          Score each factor on a 1&ndash;5 scale (1 = worst, 5 = best). A maximum
          score is 30. Industries scoring 22 or above are strong candidates;
          15&ndash;21 require a specific thesis to justify; below 15, walk away.
        </p>
        ...
        <p>
          ...
          every state, with the top five players&mdash;Johnson Controls, Carrier,
          Trane Technologies, Comfort Systems USA, and EMCOR Group&mdash;holding
        ...
        <p>
          ...
          routinely pay 1&ndash;2x higher{" "}
        ...
        <p>
          ...
          more competition. Heavy regulation&mdash;HIPAA in healthcare, state
          dental board licensing, SEC compliance in financial services&mdash;creates
        ...
        <p>
          ...
          disrupted&mdash;a B2B SaaS product serving a niche may have deep moats,
        ...
        <p>
          ...
          Residential pest control companies in the $5&ndash;10M EBITDA range trade
          at 8.3x. Dental practices range widely: add-on acquisitions at
          5&ndash;8x EBITDA, while premium multi-location platforms command
          9&ndash;12x per Large Practice Sales&rsquo; 2024 analysis. Property
          management firms are cheaper at 3.8&ndash;4.2x EBITDA on average,
          according to Peak Business Valuation. Small SaaS businesses ($1&ndash;5M
          ARR) trade at 3&ndash;5x revenue for low-growth and 7&ndash;10x revenue
          for high-growth, per Breakwater M&amp;A&rsquo;s 2026 report.
        </p>
        <p>
          <strong>Score 5:</strong> Entry multiples of 3&ndash;5x EBITDA with clear
          paths to exit at 7&ndash;10x (property management, niche services).{" "}
        ...
        <p>
          ...
          companies command the highest multiples at 6.3&ndash;10.8x EBITDA per
        ...
        <p>
          ...
          contract bases trade at 8.3x EBITDA in the $5&ndash;10M range, while
          smaller firms ($500K&ndash;1M EBITDA) can be acquired at 5.7x&mdash;a
          ...
          88&ndash;90% commercial, per industry benchmarks. State licensing
        ...
        <p>
          Dental is attractive on paper&mdash;recurring patient visits, aging
          ...
          significant for a search fund operator. Only about 16&ndash;22% of U.S.
          ...
          the dentist does. Premium multi-location platforms can command 9&ndash;12x
          EBITDA, but add-ons are more reasonably priced at 5&ndash;8x. Unless you
        ...
        <p>
          ...
          subscription models) and excellent margins (often 20&ndash;40% EBITDA for
          mature products). The challenge is twofold: entry valuations are steep
          (low-growth SaaS at $1&ndash;5M ARR trades at 3&ndash;5x revenue, which
          translates to 15&ndash;25x EBITDA for a 20%-margin business), and
        ...
        <p>
          ...
          3.8&ndash;4.2x EBITDA on average, per Peak Business Valuation, while
          ...
          with thousands of small operators managing 100&ndash;500 doors.
          Technology enhances but does not replace the service&mdash;property
          ...
          margin: property management companies often operate on 15&ndash;25%
          ...
          and selling to a regional consolidator at 5&ndash;7x. For a deeper dive,
          see our{" "}
        ...
        <ol className={olClass}>
          ...
          <li>
            ...
            effectively caps your entry multiple at 4&ndash;6x EBITDA for most
          ...
          <li>
            <strong>Your exit timeline.</strong> If you plan a 5&ndash;7 year hold
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            produced some of the highest IRRs, though with wider variance&mdash;the
            upside is large, but so is the downside.
          </li>
          <li>
            <strong>The 2017&ndash;2020 cohort</strong> has exceeded 50% IRR after
          ...
          <li>
            ...
            targets&mdash;exactly the size range where fragmented service
        ...
        <ol className={olClass}>
          <li>
            <strong>List 8&ndash;12 candidate industries</strong> based on your
          ...
          <li>
            ...
            on the industry itself: interview 5&ndash;10 operators, attend an
            industry trade show, talk to brokers who specialize in the space.
          </li>
          <li>
            <strong>Commit to 1&ndash;2 industries</strong> for your active search.
            Developing true industry expertise&mdash;knowing the metrics, the
            players, and the lingo&mdash;is what generates{" "}
        ...
        <p>
          ...
          2&ndash;3 industries to one over the first 6 months of their search,
        ...
        <p>
          ...
          valuations&mdash;but they have also created a predictable exit market for
          smaller operators who build to $2&ndash;5M EBITDA. The key is to buy at
          ...
          acquire at 5&ndash;6x and sell to a PE platform at 8&ndash;10x capture
        ...
        <p>
          ...
          often trade at 3&ndash;5x EBITDA versus 5&ndash;8x in the U.S. for
