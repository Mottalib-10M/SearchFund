  ...
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>Acquired businesses are often goldmines of process improvement opportunity. The previous owner may have tolerated inefficiencies for years, redundant steps, quality issues, bottlenecks, and waste that accumulated over decades of &quot;we&apos;ve always done it this way.&quot; Applying lean and Six Sigma principles to these businesses can deliver dramatic efficiency gains without requiring major capital investment.</p>
        <p>According to a McKinsey study on operational excellence in acquired companies, systematic process improvement typically yields 10-25% cost reductions in the first 12-18 months, with the majority of gains coming from eliminating waste and reducing variation rather than from capital expenditure. For <Link href="/learn/quick-wins-post-acquisition" className="text-apple-accent hover:underline">new owners seeking quick wins</Link>, process improvement is one of the fastest paths to EBITDA expansion.</p>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          ...
          <li><strong>5S workplace organization:</strong> Sort, Set in order, Shine, Standardize, Sustain, applicable to offices, warehouses, and shops alike</li>
          <li><strong>Kanban boards:</strong> Visual work management to track tasks and identify bottlenecks</li>
          <li><strong>Kaizen events:</strong> Focused 3-5 day improvement workshops targeting specific processes</li>
        </ul>
      </div>
      ...
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li><strong>DMAIC framework:</strong> Define, Measure, Analyze, Improve, Control, a structured approach to problem-solving</li>
      ...
      <div className={bodyClass}>
        <ol className={olClass}>
          ...
          <li><strong>Standardize templates:</strong> Quotes, proposals, reports, emails, create templates for everything recurring</li>
          <li><strong>Batch similar tasks:</strong> Process all invoices on Tuesday instead of one at a time throughout the week</li>
        </ol>
        <p>When implementing these quick wins, involve frontline employees in identifying the changes. The Lean Enterprise Institute emphasizes that sustainable improvement comes from the people who do the work daily, not from top-down mandates. Run a brief <Link href="/learn/building-trust-inherited-teams" className="text-apple-accent hover:underline">team workshop</Link> to crowdsource the biggest pain points, you will get better ideas and stronger buy-in simultaneously.</p>
      </div>

      <h2 className={h2Class}>Key Takeaways</h2>
      <div className={bodyClass}>
        <ul className={ulClass}>
          <li>Acquired businesses are rich with process improvement opportunity, start with value stream mapping</li>
          <li>Focus on the 8 wastes (TIMWOODS) to identify inefficiencies hiding in plain sight</li>
          <li>You don&apos;t need certification, apply lean and Six Sigma principles pragmatically</li>
