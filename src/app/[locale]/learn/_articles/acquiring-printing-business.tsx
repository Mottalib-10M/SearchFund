...
export default function AcquiringPrintingBusinessArticle() {
  return (
    <article>
      ...
      <div className={bodyClass}>
        <p>
          The US printing and signage industry generates over $90 billion in
          combined annual revenue, yet it remains one of the most misunderstood
          sectors in{" "}
          <Link href="/learn/what-is-eta" className="text-apple-accent hover:underline">
            entrepreneurship through acquisition
          </Link>. Headlines about the &ldquo;death of print&rdquo; have
          depressed valuations and scared away generalist buyers, creating a
        ...
        <h2 className={h2Class}>Types of printing and signage businesses</h2>

        <h3 className={h3Class}>Commercial print</h3>
        <p>
          Traditional offset and digital commercial printers produce
        ...
        <h3 className={h3Class}>Packaging and labels</h3>
        <p>
          Packaging is the secular growth engine of the print industry.
          Short runs, personalized packaging, and direct-to-consumer brands
        ...
        <h3 className={h3Class}>Managed print services (MPS)</h3>
        <p>
        ...
        <h2 className={h2Class}>Why printing is attractive for ETA</h2>

        <h3 className={h3Class}>B2B stickiness</h3>
        <p>
          Printing relationships are deeply embedded in client operations.
          A marketing team relies on its print partner for file management,
          brand-color consistency, material inventory, and just-in-time
          delivery. Switching costs are real: re-proofing files,
        ...
        <h3 className={h3Class}>Diversification into growth segments</h3>
        <p>
          The best acquisition candidates have diversified beyond commodity
          commercial print into signage, packaging, promotional products, or
          MPS. A commercial printer generating 40% of revenue from signage
          and packaging is a fundamentally different risk profile than one
          dependent entirely on offset printing of marketing collateral.
        </p>

        <h2 className={h2Class}>Due diligence: what to examine</h2>
        <p>
          Printing businesses have unique diligence considerations beyond
          the standard{" "}
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Finishing equipment:</strong> Cutters, folders, binders,
            laminators, and die-cutters are often overlooked but represent
            significant replacement cost if neglected.
          </li>
        </ul>

        <h3 className={h3Class}>Customer concentration and revenue quality</h3>
        <p>
          Analyze revenue at the customer, product-type, and job-size level.
          No single customer should exceed 15% of revenue. Request a
          customer-level revenue breakout for the past three years and look
          for trends: growing customers, declining customers, and recently
          lost accounts. A business that has lost several large customers in
          the past 18 months may be in structural decline the financials
          don&rsquo;t yet reflect.
        </p>

        <h3 className={h3Class}>Revenue per machine hour</h3>
        <p>
          ...
          details strategies to improve this metric.
        </p>

        <h3 className={h3Class}>Environmental compliance</h3>
        <p>
          Printing operations involve solvents, inks, and wash chemicals
          subject to environmental regulation:
        </p>
        <ol className={olClass}>
          <li>
            <strong>VOC emissions:</strong> Solvent-based inks emit volatile
            organic compounds regulated under the Clean Air Act. Verify air
            permits and emission limits.
          </li>
          <li>
            <strong>Hazardous waste:</strong> Waste inks and solvents may be
            classified as hazardous under RCRA. Confirm valid EPA generator
            ID and compliant storage.
          </li>
          <li>
            <strong>Wastewater discharge:</strong> Plate processing and press
            washing generate wastewater that may require treatment. Review
            discharge permits.
          </li>
          <li>
            <strong>Chemical storage:</strong> Flammable materials require
            rated cabinets and fire code compliance.
          </li>
        </ol>
        <p>
          Modern operations using UV-curable and water-based ink systems
          carry less environmental risk and lower compliance costs.
        </p>
        ...
        <p>
          ...
          provides a general framework; here are the tactics specific to
        ...
        <h3 className={h3Class}>Multi-location consolidation</h3>
        <p>
        ...
        <ul className={ulClass}>
          ...
          <li>
            ...
            PrintVis provide end-to-end visibility from estimating through
            invoicing. Most small printers still run on spreadsheets.
          </li>
          <li>
          ...
          <li>
            ...
            equipment into inline workflows eliminates manual handling,
            reduces labor, and shortens turnaround.
          </li>
        </ul>
        ...
        <ul className={ulClass}>
          ...
          <li>
            <strong>Equipment obsolescence:</strong> Printing technology
            evolves rapidly. Budget realistic replacement capex and favor
            digital equipment with known upgrade paths.
          </li>
          <li>
            <strong>Key-person risk:</strong> Senior salespeople often
            control critical client relationships. Structure retention
            agreements and build institutional CRM systems during the{" "}
            <Link href="/learn/management-transition" className="text-apple-accent hover:underline">
              management transition
            </Link>{" "}
            period.
          ...
          <li>
            <strong>Labor market tightness:</strong> Experienced press
            operators are in short supply. Invest in training, competitive
            compensation, and automation to reduce dependence on specialized
            labor.
          </li>
        </ul>
