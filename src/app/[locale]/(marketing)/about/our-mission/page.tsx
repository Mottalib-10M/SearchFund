...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Our Mission | SearchFundMarket",
    description:
      "SearchFundMarket is the leading ETA knowledge platform in Europe. Learn how we help searchers, investors, and sellers navigate Entrepreneurship Through Acquisition.",
    openGraph: {
      title: "Our Mission | SearchFundMarket",
      description:
        "SearchFundMarket is the leading ETA knowledge platform in Europe. Learn how we help searchers, investors, and sellers navigate Entrepreneurship Through Acquisition.",
    ...
    alternates: {
      canonical: `${BASE}/${locale}/about/our-mission`,
      languages: {
        en: `${BASE}/en/about/our-mission`,
        "x-default": `${BASE}/en/about/our-mission`,
      },
    },
  };
}
