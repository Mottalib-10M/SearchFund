...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    ogDescription: "Build a leveraged buyout model for your next acquisition. Simulate debt layers, equity splits, seller notes, and cash flow coverage ratios — all in real time.",
  },
  {
